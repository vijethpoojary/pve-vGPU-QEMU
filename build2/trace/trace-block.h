...
extern TraceEvent _TRACE_LURING_CQE_HANDLER_EVENT;
extern TraceEvent _TRACE_LURING_CO_SUBMIT_EVENT;
extern TraceEvent _TRACE_LURING_RESUBMIT_SHORT_IO_EVENT;
...
extern TraceEvent _TRACE_CURL_HEADER_CB_EVENT;
...
extern uint16_t _TRACE_LURING_CQE_HANDLER_DSTATE;
extern uint16_t _TRACE_LURING_CO_SUBMIT_DSTATE;
extern uint16_t _TRACE_LURING_RESUBMIT_SHORT_IO_DSTATE;
...
extern uint16_t _TRACE_CURL_HEADER_CB_DSTATE;
...
#define TRACE_LURING_CQE_HANDLER_ENABLED 1
#define TRACE_LURING_CO_SUBMIT_ENABLED 1
#define TRACE_LURING_RESUBMIT_SHORT_IO_ENABLED 1
...
#define TRACE_CURL_HEADER_CB_ENABLED 1
...
{
    if (trace_event_get_state(TRACE_BLK_ROOT_ATTACH)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 10 "../block/trace-events"
            qemu_log("blk_root_attach " "child %p blk %p bs %p" "\n", child, blk, bs);
#line 563 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_BLK_ROOT_DETACH)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 11 "../block/trace-events"
            qemu_log("blk_root_detach " "child %p blk %p bs %p" "\n", child, blk, bs);
#line 578 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_BDRV_CO_COPY_RANGE_FROM)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_BDRV_CO_COPY_RANGE_TO)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_BLOCK_COPY_PROCESS)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 46 "../block/trace-events"
            qemu_log("block_copy_process " "bcs %p start %"PRId64 "\n", bcs, start);
#line 923 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_BLOCK_COPY_WRITE_ZEROES_FAIL)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_QMP_BLOCK_JOB_FINALIZE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 57 "../block/trace-events"
            qemu_log("qmp_block_job_finalize " "job %p" "\n", job);
#line 1058 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_QMP_BLOCK_JOB_DISMISS)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 58 "../block/trace-events"
            qemu_log("qmp_block_job_dismiss " "job %p" "\n", job);
#line 1073 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_FILE_PAIO_SUBMIT)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
#define TRACE_LURING_CQE_HANDLER_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_LURING_CQE_HANDLER) || \
    false)

static inline void trace_luring_cqe_handler(void *req, int ret)
{
    if (trace_event_get_state(TRACE_LURING_CQE_HANDLER)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 65 "../block/trace-events"
            qemu_log("luring_cqe_handler " "req %p ret %d" "\n", req, ret);
#line 1118 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_LURING_CO_SUBMIT)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 66 "../block/trace-events"
            qemu_log("luring_co_submit " "bs %p req %p fd %d offset %" PRId64 " nbytes %zd type %d" "\n", bs, req, fd, offset, nbytes, type);
#line 1133 "trace/trace-block.h"
        }
    }
}

#define TRACE_LURING_RESUBMIT_SHORT_IO_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_LURING_RESUBMIT_SHORT_IO) || \
    false)

static inline void trace_luring_resubmit_short_io(void *req, int ndone)
{
    if (trace_event_get_state(TRACE_LURING_RESUBMIT_SHORT_IO)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 67 "../block/trace-events"
            qemu_log("luring_resubmit_short_io " "req %p ndone %d" "\n", req, ndone);
#line 1148 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_QCOW2_ADD_TASK)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
static inline void trace_qcow2_writev_data(void *co, uint64_t offset)
{
    if (trace_event_get_state(TRACE_QCOW2_WRITEV_DATA)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 75 "../block/trace-events"
            qemu_log("qcow2_writev_data " "co %p offset 0x%" PRIx64 "\n", co, offset);
#line 1238 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_QCOW2_SKIP_COW)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
static inline void trace_qcow2_cluster_link_l2(void *co, int nb_clusters)
{
    if (trace_event_get_state(TRACE_QCOW2_CLUSTER_LINK_L2)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 86 "../block/trace-events"
            qemu_log("qcow2_cluster_link_l2 " "co %p nb_clusters %d" "\n", co, nb_clusters);
#line 1373 "trace/trace-block.h"
        }
    }
}
...
static inline void trace_qed_read_table(void *s, uint64_t offset, void *table)
{
    if (trace_event_get_state(TRACE_QED_READ_TABLE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 111 "../block/trace-events"
            qemu_log("qed_read_table " "s %p offset %"PRIu64" table %p" "\n", s, offset, table);
#line 1613 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_NVME_CONTROLLER_CAPABILITY_RAW)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 130 "../block/trace-events"
            qemu_log("nvme_controller_capability_raw " "0x%08"PRIx64 "\n", value);
#line 1838 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_NVME_CONTROLLER_CAPABILITY)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 131 "../block/trace-events"
            qemu_log("nvme_controller_capability " "%s: %"PRIu64 "\n", desc, value);
#line 1853 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_NVME_POLL_QUEUE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 141 "../block/trace-events"
            qemu_log("nvme_poll_queue " "s %p q #%u" "\n", s, q_index);
#line 2003 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_NVME_WRITE_ZEROES)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_NVME_DSM)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_NVME_DSM_DONE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_NVME_CREATE_QUEUE_PAIR)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_NVME_FREE_QUEUE_PAIR)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 152 "../block/trace-events"
            qemu_log("nvme_free_queue_pair " "index %u q %p cq %p sq %p" "\n", q_index, q, cq, sq);
#line 2168 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_ISCSI_XCOPY)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_NBD_EXTENDED_HEADERS_COMPLIANCE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_NBD_READ_REPLY_ENTRY_FAIL)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 164 "../block/trace-events"
            qemu_log("nbd_read_reply_entry_fail " "ret = %d, err: %s" "\n", ret, err);
#line 2288 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_NBD_CLIENT_HANDSHAKE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 166 "../block/trace-events"
            qemu_log("nbd_client_handshake " "export '%s'" "\n", export_name);
#line 2318 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_NBD_CLIENT_HANDSHAKE_SUCCESS)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 167 "../block/trace-events"
            qemu_log("nbd_client_handshake_success " "export '%s'" "\n", export_name);
#line 2333 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_NBD_RECONNECT_ATTEMPT)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 168 "../block/trace-events"
            qemu_log("nbd_reconnect_attempt " "in_flight %u" "\n", in_flight);
#line 2348 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_NBD_RECONNECT_ATTEMPT_RESULT)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 169 "../block/trace-events"
            qemu_log("nbd_reconnect_attempt_result " "ret %d in_flight %u" "\n", ret, in_flight);
#line 2363 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_SSH_RESTART_COROUTINE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_SSH_FLUSH)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 173 "../block/trace-events"
            qemu_log("ssh_flush " "fsync" "\n");
#line 2393 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_SSH_CHECK_HOST_KEY_KNOWNHOSTS)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 174 "../block/trace-events"
            qemu_log("ssh_check_host_key_knownhosts " "host key OK" "\n");
#line 2408 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_SSH_CO_YIELD_BACK)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 177 "../block/trace-events"
            qemu_log("ssh_co_yield_back " "s->sock=%d - back" "\n", sock);
#line 2453 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_SSH_GETLENGTH)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 178 "../block/trace-events"
            qemu_log("ssh_getlength " "length=%" PRIi64 "\n", length);
#line 2468 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_SSH_CO_CREATE_OPTS)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 179 "../block/trace-events"
            qemu_log("ssh_co_create_opts " "total_size=%" PRIu64 "\n", size);
#line 2483 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_SSH_READ)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_SSH_WRITE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 183 "../block/trace-events"
            qemu_log("ssh_write " "offset=%" PRIi64 " size=%zu" "\n", offset, size);
#line 2543 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_SSH_WRITE_BUF)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_SSH_WRITE_RETURN)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_SSH_AUTH_METHODS)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 187 "../block/trace-events"
            qemu_log("ssh_auth_methods " "auth methods=0x%x" "\n", methods);
#line 2603 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_SSH_SERVER_STATUS)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 188 "../block/trace-events"
            qemu_log("ssh_server_status " "server status=%d" "\n", status);
#line 2618 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_CURL_SOCK_CB)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 192 "../block/trace-events"
            qemu_log("curl_sock_cb " "sock action %d on fd %d" "\n", action, fd);
#line 2648 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_CURL_READ_CB)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 193 "../block/trace-events"
            qemu_log("curl_read_cb " "just reading %zu bytes" "\n", realsize);
#line 2663 "trace/trace-block.h"
        }
    }
}

#define TRACE_CURL_HEADER_CB_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_CURL_HEADER_CB) || \
    false)

static inline void trace_curl_header_cb(const char *key, const char *val)
{
    if (trace_event_get_state(TRACE_CURL_HEADER_CB)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 194 "../block/trace-events"
            qemu_log("curl_header_cb " "looking at %s: %s" "\n", key, val);
...
{
    if (trace_event_get_state(TRACE_CURL_OPEN)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_CURL_OPEN_SIZE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 196 "../block/trace-events"
            qemu_log("curl_open_size " "size = %" PRIu64 "\n", size);
#line 2708 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_CURL_CLOSE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 198 "../block/trace-events"
            qemu_log("curl_close " "close" "\n");
#line 2738 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_FILE_COPY_FILE_RANGE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_FILE_FINDEJECTABLEOPTICALMEDIA)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 202 "../block/trace-events"
            qemu_log("file_FindEjectableOpticalMedia " "Matching using %s" "\n", media);
#line 2768 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_FILE_SETUP_CDROM)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 203 "../block/trace-events"
            qemu_log("file_setup_cdrom " "Using %s as optical disc" "\n", partition);
#line 2783 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_FILE_FLUSH_FDATASYNC_FAILED)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 205 "../block/trace-events"
            qemu_log("file_flush_fdatasync_failed " "errno %d" "\n", err);
#line 2813 "trace/trace-block.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_ZBD_ZONE_MGMT)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_SFTP_ERROR)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
