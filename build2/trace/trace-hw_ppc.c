...
uint16_t _TRACE_PNV_ADU_XSCOM_READ_DSTATE;
uint16_t _TRACE_PNV_ADU_XSCOM_WRITE_DSTATE;
uint16_t _TRACE_PNV_CHIPTOD_XSCOM_READ_DSTATE;
uint16_t _TRACE_PNV_CHIPTOD_XSCOM_WRITE_DSTATE;
uint16_t _TRACE_PNV_SBE_XSCOM_CTRL_READ_DSTATE;
uint16_t _TRACE_PNV_SBE_XSCOM_CTRL_WRITE_DSTATE;
uint16_t _TRACE_PNV_SBE_XSCOM_MBOX_READ_DSTATE;
uint16_t _TRACE_PNV_SBE_XSCOM_MBOX_WRITE_DSTATE;
uint16_t _TRACE_PNV_SBE_REG_SET_HOST_DOORBELL_DSTATE;
uint16_t _TRACE_PNV_SBE_CMD_TIMER_START_DSTATE;
uint16_t _TRACE_PNV_SBE_CMD_TIMER_STOP_DSTATE;
uint16_t _TRACE_PNV_SBE_CMD_TIMER_EXPIRED_DSTATE;
uint16_t _TRACE_PNV_SBE_MSG_RECV_DSTATE;
...
uint16_t _TRACE_PPC4XX_SDRAM_INIT_DSTATE;
...
TraceEvent _TRACE_PNV_ADU_XSCOM_READ_EVENT = {
    .id = 0,
    .name = "pnv_adu_xscom_read",
    .sstate = TRACE_PNV_ADU_XSCOM_READ_ENABLED,
    .dstate = &_TRACE_PNV_ADU_XSCOM_READ_DSTATE
};
TraceEvent _TRACE_PNV_ADU_XSCOM_WRITE_EVENT = {
    .id = 0,
    .name = "pnv_adu_xscom_write",
    .sstate = TRACE_PNV_ADU_XSCOM_WRITE_ENABLED,
    .dstate = &_TRACE_PNV_ADU_XSCOM_WRITE_DSTATE
};
TraceEvent _TRACE_PNV_CHIPTOD_XSCOM_READ_EVENT = {
    .id = 0,
    .name = "pnv_chiptod_xscom_read",
    .sstate = TRACE_PNV_CHIPTOD_XSCOM_READ_ENABLED,
    .dstate = &_TRACE_PNV_CHIPTOD_XSCOM_READ_DSTATE
};
TraceEvent _TRACE_PNV_CHIPTOD_XSCOM_WRITE_EVENT = {
    .id = 0,
    .name = "pnv_chiptod_xscom_write",
    .sstate = TRACE_PNV_CHIPTOD_XSCOM_WRITE_ENABLED,
    .dstate = &_TRACE_PNV_CHIPTOD_XSCOM_WRITE_DSTATE
};
TraceEvent _TRACE_PNV_SBE_XSCOM_CTRL_READ_EVENT = {
    .id = 0,
    .name = "pnv_sbe_xscom_ctrl_read",
    .sstate = TRACE_PNV_SBE_XSCOM_CTRL_READ_ENABLED,
    .dstate = &_TRACE_PNV_SBE_XSCOM_CTRL_READ_DSTATE
};
TraceEvent _TRACE_PNV_SBE_XSCOM_CTRL_WRITE_EVENT = {
    .id = 0,
    .name = "pnv_sbe_xscom_ctrl_write",
    .sstate = TRACE_PNV_SBE_XSCOM_CTRL_WRITE_ENABLED,
    .dstate = &_TRACE_PNV_SBE_XSCOM_CTRL_WRITE_DSTATE
};
TraceEvent _TRACE_PNV_SBE_XSCOM_MBOX_READ_EVENT = {
    .id = 0,
    .name = "pnv_sbe_xscom_mbox_read",
    .sstate = TRACE_PNV_SBE_XSCOM_MBOX_READ_ENABLED,
    .dstate = &_TRACE_PNV_SBE_XSCOM_MBOX_READ_DSTATE
};
TraceEvent _TRACE_PNV_SBE_XSCOM_MBOX_WRITE_EVENT = {
    .id = 0,
    .name = "pnv_sbe_xscom_mbox_write",
    .sstate = TRACE_PNV_SBE_XSCOM_MBOX_WRITE_ENABLED,
    .dstate = &_TRACE_PNV_SBE_XSCOM_MBOX_WRITE_DSTATE
};
TraceEvent _TRACE_PNV_SBE_REG_SET_HOST_DOORBELL_EVENT = {
    .id = 0,
    .name = "pnv_sbe_reg_set_host_doorbell",
    .sstate = TRACE_PNV_SBE_REG_SET_HOST_DOORBELL_ENABLED,
    .dstate = &_TRACE_PNV_SBE_REG_SET_HOST_DOORBELL_DSTATE
};
TraceEvent _TRACE_PNV_SBE_CMD_TIMER_START_EVENT = {
    .id = 0,
    .name = "pnv_sbe_cmd_timer_start",
    .sstate = TRACE_PNV_SBE_CMD_TIMER_START_ENABLED,
    .dstate = &_TRACE_PNV_SBE_CMD_TIMER_START_DSTATE
};
TraceEvent _TRACE_PNV_SBE_CMD_TIMER_STOP_EVENT = {
    .id = 0,
    .name = "pnv_sbe_cmd_timer_stop",
    .sstate = TRACE_PNV_SBE_CMD_TIMER_STOP_ENABLED,
    .dstate = &_TRACE_PNV_SBE_CMD_TIMER_STOP_DSTATE
};
TraceEvent _TRACE_PNV_SBE_CMD_TIMER_EXPIRED_EVENT = {
    .id = 0,
    .name = "pnv_sbe_cmd_timer_expired",
    .sstate = TRACE_PNV_SBE_CMD_TIMER_EXPIRED_ENABLED,
    .dstate = &_TRACE_PNV_SBE_CMD_TIMER_EXPIRED_DSTATE
};
TraceEvent _TRACE_PNV_SBE_MSG_RECV_EVENT = {
    .id = 0,
    .name = "pnv_sbe_msg_recv",
    .sstate = TRACE_PNV_SBE_MSG_RECV_ENABLED,
    .dstate = &_TRACE_PNV_SBE_MSG_RECV_DSTATE
};
...
TraceEvent _TRACE_PPC4XX_SDRAM_INIT_EVENT = {
    .id = 0,
    .name = "ppc4xx_sdram_init",
    .sstate = TRACE_PPC4XX_SDRAM_INIT_ENABLED,
    .dstate = &_TRACE_PPC4XX_SDRAM_INIT_DSTATE
};
TraceEvent *hw_ppc_trace_events[] = {
    ...
    &_TRACE_PNV_ADU_XSCOM_READ_EVENT,
    &_TRACE_PNV_ADU_XSCOM_WRITE_EVENT,
    &_TRACE_PNV_CHIPTOD_XSCOM_READ_EVENT,
    &_TRACE_PNV_CHIPTOD_XSCOM_WRITE_EVENT,
    &_TRACE_PNV_SBE_XSCOM_CTRL_READ_EVENT,
    &_TRACE_PNV_SBE_XSCOM_CTRL_WRITE_EVENT,
    &_TRACE_PNV_SBE_XSCOM_MBOX_READ_EVENT,
    &_TRACE_PNV_SBE_XSCOM_MBOX_WRITE_EVENT,
    &_TRACE_PNV_SBE_REG_SET_HOST_DOORBELL_EVENT,
    &_TRACE_PNV_SBE_CMD_TIMER_START_EVENT,
    &_TRACE_PNV_SBE_CMD_TIMER_STOP_EVENT,
    &_TRACE_PNV_SBE_CMD_TIMER_EXPIRED_EVENT,
    &_TRACE_PNV_SBE_MSG_RECV_EVENT,
    ...
    &_TRACE_PPC4XX_SDRAM_INIT_EVENT,
  NULL,
};
