...
uint16_t _TRACE_KVM_RESET_VMFD_DSTATE;
uint16_t _TRACE_KVM_REBIND_VCPUS_DSTATE;
...
TraceEvent _TRACE_KVM_RESET_VMFD_EVENT = {
    .id = 0,
    .name = "kvm_reset_vmfd",
    .sstate = TRACE_KVM_RESET_VMFD_ENABLED,
    .dstate = &_TRACE_KVM_RESET_VMFD_DSTATE
};
TraceEvent _TRACE_KVM_REBIND_VCPUS_EVENT = {
    .id = 0,
    .name = "kvm_rebind_vcpus",
    .sstate = TRACE_KVM_REBIND_VCPUS_ENABLED,
    .dstate = &_TRACE_KVM_REBIND_VCPUS_DSTATE
};
...
TraceEvent *accel_kvm_trace_events[] = {
    ...
    &_TRACE_KVM_RESET_VMFD_EVENT,
    &_TRACE_KVM_REBIND_VCPUS_EVENT,
