...
uint16_t _TRACE_SAVEVM_SEND_SWITCHOVER_START_DSTATE;
...
uint16_t _TRACE_QEMU_FILE_PUT_FD_DSTATE;
uint16_t _TRACE_QEMU_FILE_GET_FD_DSTATE;
...
uint16_t _TRACE_RAM_SAVE_COMPLETE_DSTATE;
...
uint16_t _TRACE_MIGRATION_CLEANUP_DSTATE;
uint16_t _TRACE_MIGRATE_ERROR_DSTATE;
uint16_t _TRACE_MIGRATION_CANCEL_DSTATE;
...
uint16_t _TRACE_SOURCE_RETURN_PATH_THREAD_POSTCOPY_PACKAGE_LOADED_DSTATE;
...
uint16_t _TRACE_MIGRATION_PRECOPY_COMPLETE_DSTATE;
uint16_t _TRACE_MIGRATION_CALL_NOTIFIERS_DSTATE;
...
uint16_t _TRACE_RDMA_CONNECT_INCOMING_DSTATE;
uint16_t _TRACE_RDMA_CONNECT_INCOMING_AFTER_DEST_INIT_DSTATE;
uint16_t _TRACE_RDMA_CONNECT_INCOMING_AFTER_RDMA_LISTEN_DSTATE;
uint16_t _TRACE_RDMA_CONNECT_OUTGOING_AFTER_RDMA_CONNECT_DSTATE;
uint16_t _TRACE_RDMA_CONNECT_OUTGOING_AFTER_RDMA_SOURCE_INIT_DSTATE;
...
uint16_t _TRACE_POSTCOPY_BLOCKTIME_TID_CPU_MAP_DSTATE;
uint16_t _TRACE_POSTCOPY_BLOCKTIME_BEGIN_DSTATE;
uint16_t _TRACE_POSTCOPY_BLOCKTIME_END_DSTATE;
uint16_t _TRACE_POSTCOPY_BLOCKTIME_END_ONE_DSTATE;
...
uint16_t _TRACE_CPR_SAVE_FD_DSTATE;
uint16_t _TRACE_CPR_DELETE_FD_DSTATE;
uint16_t _TRACE_CPR_FIND_FD_DSTATE;
uint16_t _TRACE_CPR_STATE_SAVE_DSTATE;
uint16_t _TRACE_CPR_STATE_LOAD_DSTATE;
uint16_t _TRACE_CPR_TRANSFER_INPUT_DSTATE;
uint16_t _TRACE_CPR_TRANSFER_OUTPUT_DSTATE;
uint16_t _TRACE_CPR_EXEC_DSTATE;
...
uint16_t _TRACE_MIGRATION_BLOCK_ACTIVATION_DSTATE;
...
TraceEvent _TRACE_SAVEVM_SEND_SWITCHOVER_START_EVENT = {
    .id = 0,
    .name = "savevm_send_switchover_start",
    .sstate = TRACE_SAVEVM_SEND_SWITCHOVER_START_ENABLED,
    .dstate = &_TRACE_SAVEVM_SEND_SWITCHOVER_START_DSTATE
};
...
TraceEvent _TRACE_QEMU_FILE_PUT_FD_EVENT = {
    .id = 0,
    .name = "qemu_file_put_fd",
    .sstate = TRACE_QEMU_FILE_PUT_FD_ENABLED,
    .dstate = &_TRACE_QEMU_FILE_PUT_FD_DSTATE
};
TraceEvent _TRACE_QEMU_FILE_GET_FD_EVENT = {
    .id = 0,
    .name = "qemu_file_get_fd",
    .sstate = TRACE_QEMU_FILE_GET_FD_ENABLED,
    .dstate = &_TRACE_QEMU_FILE_GET_FD_DSTATE
};
...
TraceEvent _TRACE_RAM_SAVE_COMPLETE_EVENT = {
    .id = 0,
    .name = "ram_save_complete",
    .sstate = TRACE_RAM_SAVE_COMPLETE_ENABLED,
    .dstate = &_TRACE_RAM_SAVE_COMPLETE_DSTATE
};
...
TraceEvent _TRACE_MIGRATION_CLEANUP_EVENT = {
    .id = 0,
    .name = "migration_cleanup",
    .sstate = TRACE_MIGRATION_CLEANUP_ENABLED,
    .dstate = &_TRACE_MIGRATION_CLEANUP_DSTATE
};
...
TraceEvent _TRACE_MIGRATION_CANCEL_EVENT = {
    .id = 0,
    .name = "migration_cancel",
    .sstate = TRACE_MIGRATION_CANCEL_ENABLED,
    .dstate = &_TRACE_MIGRATION_CANCEL_DSTATE
};
...
TraceEvent _TRACE_SOURCE_RETURN_PATH_THREAD_POSTCOPY_PACKAGE_LOADED_EVENT = {
    .id = 0,
    .name = "source_return_path_thread_postcopy_package_loaded",
    .sstate = TRACE_SOURCE_RETURN_PATH_THREAD_POSTCOPY_PACKAGE_LOADED_ENABLED,
    .dstate = &_TRACE_SOURCE_RETURN_PATH_THREAD_POSTCOPY_PACKAGE_LOADED_DSTATE
};
...
TraceEvent _TRACE_MIGRATION_PRECOPY_COMPLETE_EVENT = {
    .id = 0,
    .name = "migration_precopy_complete",
    .sstate = TRACE_MIGRATION_PRECOPY_COMPLETE_ENABLED,
    .dstate = &_TRACE_MIGRATION_PRECOPY_COMPLETE_DSTATE
};
TraceEvent _TRACE_MIGRATION_CALL_NOTIFIERS_EVENT = {
    .id = 0,
    .name = "migration_call_notifiers",
    .sstate = TRACE_MIGRATION_CALL_NOTIFIERS_ENABLED,
    .dstate = &_TRACE_MIGRATION_CALL_NOTIFIERS_DSTATE
};
...
TraceEvent _TRACE_RDMA_CONNECT_INCOMING_EVENT = {
    .id = 0,
    .name = "rdma_connect_incoming",
    .sstate = TRACE_RDMA_CONNECT_INCOMING_ENABLED,
    .dstate = &_TRACE_RDMA_CONNECT_INCOMING_DSTATE
};
TraceEvent _TRACE_RDMA_CONNECT_INCOMING_AFTER_DEST_INIT_EVENT = {
    .id = 0,
    .name = "rdma_connect_incoming_after_dest_init",
    .sstate = TRACE_RDMA_CONNECT_INCOMING_AFTER_DEST_INIT_ENABLED,
    .dstate = &_TRACE_RDMA_CONNECT_INCOMING_AFTER_DEST_INIT_DSTATE
};
TraceEvent _TRACE_RDMA_CONNECT_INCOMING_AFTER_RDMA_LISTEN_EVENT = {
    .id = 0,
    .name = "rdma_connect_incoming_after_rdma_listen",
    .sstate = TRACE_RDMA_CONNECT_INCOMING_AFTER_RDMA_LISTEN_ENABLED,
    .dstate = &_TRACE_RDMA_CONNECT_INCOMING_AFTER_RDMA_LISTEN_DSTATE
};
TraceEvent _TRACE_RDMA_CONNECT_OUTGOING_AFTER_RDMA_CONNECT_EVENT = {
    .id = 0,
    .name = "rdma_connect_outgoing_after_rdma_connect",
    .sstate = TRACE_RDMA_CONNECT_OUTGOING_AFTER_RDMA_CONNECT_ENABLED,
    .dstate = &_TRACE_RDMA_CONNECT_OUTGOING_AFTER_RDMA_CONNECT_DSTATE
};
TraceEvent _TRACE_RDMA_CONNECT_OUTGOING_AFTER_RDMA_SOURCE_INIT_EVENT = {
    .id = 0,
    .name = "rdma_connect_outgoing_after_rdma_source_init",
    .sstate = TRACE_RDMA_CONNECT_OUTGOING_AFTER_RDMA_SOURCE_INIT_ENABLED,
    .dstate = &_TRACE_RDMA_CONNECT_OUTGOING_AFTER_RDMA_SOURCE_INIT_DSTATE
};
...
TraceEvent _TRACE_POSTCOPY_BLOCKTIME_TID_CPU_MAP_EVENT = {
    .id = 0,
    .name = "postcopy_blocktime_tid_cpu_map",
    .sstate = TRACE_POSTCOPY_BLOCKTIME_TID_CPU_MAP_ENABLED,
    .dstate = &_TRACE_POSTCOPY_BLOCKTIME_TID_CPU_MAP_DSTATE
};
TraceEvent _TRACE_POSTCOPY_BLOCKTIME_BEGIN_EVENT = {
    .id = 0,
    .name = "postcopy_blocktime_begin",
    .sstate = TRACE_POSTCOPY_BLOCKTIME_BEGIN_ENABLED,
    .dstate = &_TRACE_POSTCOPY_BLOCKTIME_BEGIN_DSTATE
};
TraceEvent _TRACE_POSTCOPY_BLOCKTIME_END_EVENT = {
    .id = 0,
    .name = "postcopy_blocktime_end",
    .sstate = TRACE_POSTCOPY_BLOCKTIME_END_ENABLED,
    .dstate = &_TRACE_POSTCOPY_BLOCKTIME_END_DSTATE
};
TraceEvent _TRACE_POSTCOPY_BLOCKTIME_END_ONE_EVENT = {
    .id = 0,
    .name = "postcopy_blocktime_end_one",
    .sstate = TRACE_POSTCOPY_BLOCKTIME_END_ONE_ENABLED,
    .dstate = &_TRACE_POSTCOPY_BLOCKTIME_END_ONE_DSTATE
};
...
TraceEvent _TRACE_CPR_SAVE_FD_EVENT = {
    .id = 0,
    .name = "cpr_save_fd",
    .sstate = TRACE_CPR_SAVE_FD_ENABLED,
    .dstate = &_TRACE_CPR_SAVE_FD_DSTATE
};
TraceEvent _TRACE_CPR_DELETE_FD_EVENT = {
    .id = 0,
    .name = "cpr_delete_fd",
    .sstate = TRACE_CPR_DELETE_FD_ENABLED,
    .dstate = &_TRACE_CPR_DELETE_FD_DSTATE
};
TraceEvent _TRACE_CPR_FIND_FD_EVENT = {
    .id = 0,
    .name = "cpr_find_fd",
    .sstate = TRACE_CPR_FIND_FD_ENABLED,
    .dstate = &_TRACE_CPR_FIND_FD_DSTATE
};
TraceEvent _TRACE_CPR_STATE_SAVE_EVENT = {
    .id = 0,
    .name = "cpr_state_save",
    .sstate = TRACE_CPR_STATE_SAVE_ENABLED,
    .dstate = &_TRACE_CPR_STATE_SAVE_DSTATE
};
TraceEvent _TRACE_CPR_STATE_LOAD_EVENT = {
    .id = 0,
    .name = "cpr_state_load",
    .sstate = TRACE_CPR_STATE_LOAD_ENABLED,
    .dstate = &_TRACE_CPR_STATE_LOAD_DSTATE
};
TraceEvent _TRACE_CPR_TRANSFER_INPUT_EVENT = {
    .id = 0,
    .name = "cpr_transfer_input",
    .sstate = TRACE_CPR_TRANSFER_INPUT_ENABLED,
    .dstate = &_TRACE_CPR_TRANSFER_INPUT_DSTATE
};
TraceEvent _TRACE_CPR_TRANSFER_OUTPUT_EVENT = {
    .id = 0,
    .name = "cpr_transfer_output",
    .sstate = TRACE_CPR_TRANSFER_OUTPUT_ENABLED,
    .dstate = &_TRACE_CPR_TRANSFER_OUTPUT_DSTATE
};
TraceEvent _TRACE_CPR_EXEC_EVENT = {
    .id = 0,
    .name = "cpr_exec",
    .sstate = TRACE_CPR_EXEC_ENABLED,
    .dstate = &_TRACE_CPR_EXEC_DSTATE
};
...
TraceEvent _TRACE_MIGRATION_BLOCK_ACTIVATION_EVENT = {
    .id = 0,
    .name = "migration_block_activation",
    .sstate = TRACE_MIGRATION_BLOCK_ACTIVATION_ENABLED,
    .dstate = &_TRACE_MIGRATION_BLOCK_ACTIVATION_DSTATE
};
TraceEvent *migration_trace_events[] = {
    ...
    &_TRACE_SAVEVM_SEND_SWITCHOVER_START_EVENT,
    ...
    &_TRACE_QEMU_FILE_PUT_FD_EVENT,
    &_TRACE_QEMU_FILE_GET_FD_EVENT,
    ...
    &_TRACE_RAM_SAVE_COMPLETE_EVENT,
    ...
    &_TRACE_MIGRATION_CLEANUP_EVENT,
    &_TRACE_MIGRATE_ERROR_EVENT,
    &_TRACE_MIGRATION_CANCEL_EVENT,
    ...
    &_TRACE_SOURCE_RETURN_PATH_THREAD_POSTCOPY_PACKAGE_LOADED_EVENT,
    ...
    &_TRACE_MIGRATION_PRECOPY_COMPLETE_EVENT,
    &_TRACE_MIGRATION_CALL_NOTIFIERS_EVENT,
    ...
    &_TRACE_RDMA_CONNECT_INCOMING_EVENT,
    &_TRACE_RDMA_CONNECT_INCOMING_AFTER_DEST_INIT_EVENT,
    &_TRACE_RDMA_CONNECT_INCOMING_AFTER_RDMA_LISTEN_EVENT,
    &_TRACE_RDMA_CONNECT_OUTGOING_AFTER_RDMA_CONNECT_EVENT,
    &_TRACE_RDMA_CONNECT_OUTGOING_AFTER_RDMA_SOURCE_INIT_EVENT,
    ...
    &_TRACE_POSTCOPY_BLOCKTIME_TID_CPU_MAP_EVENT,
    &_TRACE_POSTCOPY_BLOCKTIME_BEGIN_EVENT,
    &_TRACE_POSTCOPY_BLOCKTIME_END_EVENT,
    &_TRACE_POSTCOPY_BLOCKTIME_END_ONE_EVENT,
    ...
    &_TRACE_CPR_SAVE_FD_EVENT,
    &_TRACE_CPR_DELETE_FD_EVENT,
    &_TRACE_CPR_FIND_FD_EVENT,
    &_TRACE_CPR_STATE_SAVE_EVENT,
    &_TRACE_CPR_STATE_LOAD_EVENT,
    &_TRACE_CPR_TRANSFER_INPUT_EVENT,
    &_TRACE_CPR_TRANSFER_OUTPUT_EVENT,
    &_TRACE_CPR_EXEC_EVENT,
    ...
    &_TRACE_MIGRATION_BLOCK_ACTIVATION_EVENT,
  NULL,
};
