...
uint16_t _TRACE_ASPEED_OTP_PROG_DSTATE;
uint16_t _TRACE_ASPEED_OTP_PROG_CONFLICT_DSTATE;
uint16_t _TRACE_ASPEED_OTP_PROG_BIT_DSTATE;
...
TraceEvent _TRACE_ASPEED_OTP_PROG_EVENT = {
    .id = 0,
    .name = "aspeed_otp_prog",
    .sstate = TRACE_ASPEED_OTP_PROG_ENABLED,
    .dstate = &_TRACE_ASPEED_OTP_PROG_DSTATE
};
TraceEvent _TRACE_ASPEED_OTP_PROG_CONFLICT_EVENT = {
    .id = 0,
    .name = "aspeed_otp_prog_conflict",
    .sstate = TRACE_ASPEED_OTP_PROG_CONFLICT_ENABLED,
    .dstate = &_TRACE_ASPEED_OTP_PROG_CONFLICT_DSTATE
};
TraceEvent _TRACE_ASPEED_OTP_PROG_BIT_EVENT = {
    .id = 0,
    .name = "aspeed_otp_prog_bit",
    .sstate = TRACE_ASPEED_OTP_PROG_BIT_ENABLED,
    .dstate = &_TRACE_ASPEED_OTP_PROG_BIT_DSTATE
};
...
TraceEvent *hw_nvram_trace_events[] = {
    &_TRACE_ASPEED_OTP_PROG_EVENT,
    &_TRACE_ASPEED_OTP_PROG_CONFLICT_EVENT,
    &_TRACE_ASPEED_OTP_PROG_BIT_EVENT,
