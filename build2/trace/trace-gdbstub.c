...
uint16_t _TRACE_GDBXML_INIT_CPU_DSTATE;
uint16_t _TRACE_GDBXML_REGISTER_COPROCESSOR_GAP_DSTATE;
uint16_t _TRACE_GDBXML_REGISTER_FEATURE_DSTATE;
uint16_t _TRACE_GDBXML_FEATURE_BUILDER_HEADER_DSTATE;
uint16_t _TRACE_GDBXML_FEATURE_BUILDER_CONTENT_DSTATE;
uint16_t _TRACE_GDBXML_GET_REGISTER_LIST_DSTATE;
...
TraceEvent _TRACE_GDBXML_INIT_CPU_EVENT = {
    .id = 0,
    .name = "gdbxml_init_cpu",
    .sstate = TRACE_GDBXML_INIT_CPU_ENABLED,
    .dstate = &_TRACE_GDBXML_INIT_CPU_DSTATE
};
TraceEvent _TRACE_GDBXML_REGISTER_COPROCESSOR_GAP_EVENT = {
    .id = 0,
    .name = "gdbxml_register_coprocessor_gap",
    .sstate = TRACE_GDBXML_REGISTER_COPROCESSOR_GAP_ENABLED,
    .dstate = &_TRACE_GDBXML_REGISTER_COPROCESSOR_GAP_DSTATE
};
TraceEvent _TRACE_GDBXML_REGISTER_FEATURE_EVENT = {
    .id = 0,
    .name = "gdbxml_register_feature",
    .sstate = TRACE_GDBXML_REGISTER_FEATURE_ENABLED,
    .dstate = &_TRACE_GDBXML_REGISTER_FEATURE_DSTATE
};
TraceEvent _TRACE_GDBXML_FEATURE_BUILDER_HEADER_EVENT = {
    .id = 0,
    .name = "gdbxml_feature_builder_header",
    .sstate = TRACE_GDBXML_FEATURE_BUILDER_HEADER_ENABLED,
    .dstate = &_TRACE_GDBXML_FEATURE_BUILDER_HEADER_DSTATE
};
TraceEvent _TRACE_GDBXML_FEATURE_BUILDER_CONTENT_EVENT = {
    .id = 0,
    .name = "gdbxml_feature_builder_content",
    .sstate = TRACE_GDBXML_FEATURE_BUILDER_CONTENT_ENABLED,
    .dstate = &_TRACE_GDBXML_FEATURE_BUILDER_CONTENT_DSTATE
};
TraceEvent _TRACE_GDBXML_GET_REGISTER_LIST_EVENT = {
    .id = 0,
    .name = "gdbxml_get_register_list",
    .sstate = TRACE_GDBXML_GET_REGISTER_LIST_ENABLED,
    .dstate = &_TRACE_GDBXML_GET_REGISTER_LIST_DSTATE
};
...
TraceEvent *gdbstub_trace_events[] = {
    ...
    &_TRACE_GDBXML_INIT_CPU_EVENT,
    &_TRACE_GDBXML_REGISTER_COPROCESSOR_GAP_EVENT,
    &_TRACE_GDBXML_REGISTER_FEATURE_EVENT,
    &_TRACE_GDBXML_FEATURE_BUILDER_HEADER_EVENT,
    &_TRACE_GDBXML_FEATURE_BUILDER_CONTENT_EVENT,
    &_TRACE_GDBXML_GET_REGISTER_LIST_EVENT,
