...
uint16_t _TRACE_MACIO_GPIO_READ_DSTATE;
...
TraceEvent _TRACE_MACIO_GPIO_READ_EVENT = {
    .id = 0,
    .name = "macio_gpio_read",
    .sstate = TRACE_MACIO_GPIO_READ_ENABLED,
    .dstate = &_TRACE_MACIO_GPIO_READ_DSTATE
};
