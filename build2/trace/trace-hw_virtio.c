...
uint16_t _TRACE_VIRTIO_IOMMU_DEVICE_RESET_EXIT_DSTATE;
...
TraceEvent _TRACE_VIRTIO_IOMMU_DEVICE_RESET_EXIT_EVENT = {
    .id = 0,
    .name = "virtio_iommu_device_reset_exit",
    .sstate = TRACE_VIRTIO_IOMMU_DEVICE_RESET_EXIT_ENABLED,
    .dstate = &_TRACE_VIRTIO_IOMMU_DEVICE_RESET_EXIT_DSTATE
};
...
TraceEvent *hw_virtio_trace_events[] = {
    ...
    &_TRACE_VIRTIO_IOMMU_DEVICE_RESET_EXIT_EVENT,
