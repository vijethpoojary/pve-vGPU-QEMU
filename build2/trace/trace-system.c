...
uint16_t _TRACE_SUBPAGE_REGISTER_DSTATE;
uint16_t _TRACE_SUBPAGE_INIT_DSTATE;
uint16_t _TRACE_SUBPAGE_ACCEPTS_DSTATE;
uint16_t _TRACE_SUBPAGE_READ_DSTATE;
uint16_t _TRACE_SUBPAGE_WRITE_DSTATE;
...
uint16_t _TRACE_RAM_BLOCK_ATTRIBUTES_STATE_CHANGE_DSTATE;
...
TraceEvent _TRACE_SUBPAGE_REGISTER_EVENT = {
    .id = 0,
    .name = "subpage_register",
    .sstate = TRACE_SUBPAGE_REGISTER_ENABLED,
    .dstate = &_TRACE_SUBPAGE_REGISTER_DSTATE
};
TraceEvent _TRACE_SUBPAGE_INIT_EVENT = {
    .id = 0,
    .name = "subpage_init",
    .sstate = TRACE_SUBPAGE_INIT_ENABLED,
    .dstate = &_TRACE_SUBPAGE_INIT_DSTATE
};
TraceEvent _TRACE_SUBPAGE_ACCEPTS_EVENT = {
    .id = 0,
    .name = "subpage_accepts",
    .sstate = TRACE_SUBPAGE_ACCEPTS_ENABLED,
    .dstate = &_TRACE_SUBPAGE_ACCEPTS_DSTATE
};
TraceEvent _TRACE_SUBPAGE_READ_EVENT = {
    .id = 0,
    .name = "subpage_read",
    .sstate = TRACE_SUBPAGE_READ_ENABLED,
    .dstate = &_TRACE_SUBPAGE_READ_DSTATE
};
TraceEvent _TRACE_SUBPAGE_WRITE_EVENT = {
    .id = 0,
    .name = "subpage_write",
    .sstate = TRACE_SUBPAGE_WRITE_ENABLED,
    .dstate = &_TRACE_SUBPAGE_WRITE_DSTATE
};
...
TraceEvent _TRACE_RAM_BLOCK_ATTRIBUTES_STATE_CHANGE_EVENT = {
    .id = 0,
    .name = "ram_block_attributes_state_change",
    .sstate = TRACE_RAM_BLOCK_ATTRIBUTES_STATE_CHANGE_ENABLED,
    .dstate = &_TRACE_RAM_BLOCK_ATTRIBUTES_STATE_CHANGE_DSTATE
};
TraceEvent *system_trace_events[] = {
    ...
    &_TRACE_SUBPAGE_REGISTER_EVENT,
    &_TRACE_SUBPAGE_INIT_EVENT,
    &_TRACE_SUBPAGE_ACCEPTS_EVENT,
    &_TRACE_SUBPAGE_READ_EVENT,
    &_TRACE_SUBPAGE_WRITE_EVENT,
    ...
    &_TRACE_RAM_BLOCK_ATTRIBUTES_STATE_CHANGE_EVENT,
  NULL,
};
