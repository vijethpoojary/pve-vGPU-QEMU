...
uint16_t _TRACE_RISCV_EXCEPTION_DSTATE;
...
TraceEvent _TRACE_RISCV_EXCEPTION_EVENT = {
    .id = 0,
    .name = "riscv_exception",
    .sstate = TRACE_RISCV_EXCEPTION_ENABLED,
    .dstate = &_TRACE_RISCV_EXCEPTION_DSTATE
};
