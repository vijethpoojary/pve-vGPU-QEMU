...
uint16_t _TRACE_QMP_ENTER_QUERY_SAVEVM_DSTATE;
uint16_t _TRACE_QMP_EXIT_QUERY_SAVEVM_DSTATE;
...
TraceEvent _TRACE_QMP_ENTER_QUERY_SAVEVM_EVENT = {
    .id = 0,
    .name = "qmp_enter_query_savevm",
    .sstate = TRACE_QMP_ENTER_QUERY_SAVEVM_ENABLED,
    .dstate = &_TRACE_QMP_ENTER_QUERY_SAVEVM_DSTATE
};
TraceEvent _TRACE_QMP_EXIT_QUERY_SAVEVM_EVENT = {
    .id = 0,
    .name = "qmp_exit_query_savevm",
    .sstate = TRACE_QMP_EXIT_QUERY_SAVEVM_ENABLED,
    .dstate = &_TRACE_QMP_EXIT_QUERY_SAVEVM_DSTATE
};
...
TraceEvent *qapi_commands_migration_trace_events_trace_events[] = {
    &_TRACE_QMP_ENTER_QUERY_SAVEVM_EVENT,
    &_TRACE_QMP_EXIT_QUERY_SAVEVM_EVENT,
