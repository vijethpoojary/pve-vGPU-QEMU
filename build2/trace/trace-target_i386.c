...
uint16_t _TRACE_SEV_HANDLE_RESET_DSTATE;
...
TraceEvent _TRACE_SEV_HANDLE_RESET_EVENT = {
    .id = 0,
    .name = "sev_handle_reset",
    .sstate = TRACE_SEV_HANDLE_RESET_ENABLED,
    .dstate = &_TRACE_SEV_HANDLE_RESET_DSTATE
};
