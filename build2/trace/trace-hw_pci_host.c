...
uint16_t _TRACE_ASPEED_PCIE_RC_INTX_SET_IRQ_DSTATE;
uint16_t _TRACE_ASPEED_PCIE_RC_MSI_NOTIFY_DSTATE;
uint16_t _TRACE_ASPEED_PCIE_RC_MSI_SET_IRQ_DSTATE;
uint16_t _TRACE_ASPEED_PCIE_RC_MSI_CLEAR_IRQ_DSTATE;
uint16_t _TRACE_ASPEED_PCIE_CFG_READ_DSTATE;
uint16_t _TRACE_ASPEED_PCIE_CFG_WRITE_DSTATE;
uint16_t _TRACE_ASPEED_PCIE_CFG_RW_DSTATE;
uint16_t _TRACE_ASPEED_PCIE_PHY_READ_DSTATE;
uint16_t _TRACE_ASPEED_PCIE_PHY_WRITE_DSTATE;
...
TraceEvent _TRACE_ASPEED_PCIE_RC_INTX_SET_IRQ_EVENT = {
    .id = 0,
    .name = "aspeed_pcie_rc_intx_set_irq",
    .sstate = TRACE_ASPEED_PCIE_RC_INTX_SET_IRQ_ENABLED,
    .dstate = &_TRACE_ASPEED_PCIE_RC_INTX_SET_IRQ_DSTATE
};
TraceEvent _TRACE_ASPEED_PCIE_RC_MSI_NOTIFY_EVENT = {
    .id = 0,
    .name = "aspeed_pcie_rc_msi_notify",
    .sstate = TRACE_ASPEED_PCIE_RC_MSI_NOTIFY_ENABLED,
    .dstate = &_TRACE_ASPEED_PCIE_RC_MSI_NOTIFY_DSTATE
};
TraceEvent _TRACE_ASPEED_PCIE_RC_MSI_SET_IRQ_EVENT = {
    .id = 0,
    .name = "aspeed_pcie_rc_msi_set_irq",
    .sstate = TRACE_ASPEED_PCIE_RC_MSI_SET_IRQ_ENABLED,
    .dstate = &_TRACE_ASPEED_PCIE_RC_MSI_SET_IRQ_DSTATE
};
TraceEvent _TRACE_ASPEED_PCIE_RC_MSI_CLEAR_IRQ_EVENT = {
    .id = 0,
    .name = "aspeed_pcie_rc_msi_clear_irq",
    .sstate = TRACE_ASPEED_PCIE_RC_MSI_CLEAR_IRQ_ENABLED,
    .dstate = &_TRACE_ASPEED_PCIE_RC_MSI_CLEAR_IRQ_DSTATE
};
TraceEvent _TRACE_ASPEED_PCIE_CFG_READ_EVENT = {
    .id = 0,
    .name = "aspeed_pcie_cfg_read",
    .sstate = TRACE_ASPEED_PCIE_CFG_READ_ENABLED,
    .dstate = &_TRACE_ASPEED_PCIE_CFG_READ_DSTATE
};
TraceEvent _TRACE_ASPEED_PCIE_CFG_WRITE_EVENT = {
    .id = 0,
    .name = "aspeed_pcie_cfg_write",
    .sstate = TRACE_ASPEED_PCIE_CFG_WRITE_ENABLED,
    .dstate = &_TRACE_ASPEED_PCIE_CFG_WRITE_DSTATE
};
TraceEvent _TRACE_ASPEED_PCIE_CFG_RW_EVENT = {
    .id = 0,
    .name = "aspeed_pcie_cfg_rw",
    .sstate = TRACE_ASPEED_PCIE_CFG_RW_ENABLED,
    .dstate = &_TRACE_ASPEED_PCIE_CFG_RW_DSTATE
};
TraceEvent _TRACE_ASPEED_PCIE_PHY_READ_EVENT = {
    .id = 0,
    .name = "aspeed_pcie_phy_read",
    .sstate = TRACE_ASPEED_PCIE_PHY_READ_ENABLED,
    .dstate = &_TRACE_ASPEED_PCIE_PHY_READ_DSTATE
};
TraceEvent _TRACE_ASPEED_PCIE_PHY_WRITE_EVENT = {
    .id = 0,
    .name = "aspeed_pcie_phy_write",
    .sstate = TRACE_ASPEED_PCIE_PHY_WRITE_ENABLED,
    .dstate = &_TRACE_ASPEED_PCIE_PHY_WRITE_DSTATE
};
...
TraceEvent *hw_pci_host_trace_events[] = {
    &_TRACE_ASPEED_PCIE_RC_INTX_SET_IRQ_EVENT,
    &_TRACE_ASPEED_PCIE_RC_MSI_NOTIFY_EVENT,
    &_TRACE_ASPEED_PCIE_RC_MSI_SET_IRQ_EVENT,
    &_TRACE_ASPEED_PCIE_RC_MSI_CLEAR_IRQ_EVENT,
    &_TRACE_ASPEED_PCIE_CFG_READ_EVENT,
    &_TRACE_ASPEED_PCIE_CFG_WRITE_EVENT,
    &_TRACE_ASPEED_PCIE_CFG_RW_EVENT,
    &_TRACE_ASPEED_PCIE_PHY_READ_EVENT,
    &_TRACE_ASPEED_PCIE_PHY_WRITE_EVENT,
