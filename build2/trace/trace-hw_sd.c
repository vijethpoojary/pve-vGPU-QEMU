...
uint16_t _TRACE_SDCARD_RPMB_READ_BLOCK_DSTATE;
uint16_t _TRACE_SDCARD_RPMB_WRITE_BLOCK_DSTATE;
...
TraceEvent _TRACE_SDCARD_RPMB_READ_BLOCK_EVENT = {
    .id = 0,
    .name = "sdcard_rpmb_read_block",
    .sstate = TRACE_SDCARD_RPMB_READ_BLOCK_ENABLED,
    .dstate = &_TRACE_SDCARD_RPMB_READ_BLOCK_DSTATE
};
TraceEvent _TRACE_SDCARD_RPMB_WRITE_BLOCK_EVENT = {
    .id = 0,
    .name = "sdcard_rpmb_write_block",
    .sstate = TRACE_SDCARD_RPMB_WRITE_BLOCK_ENABLED,
    .dstate = &_TRACE_SDCARD_RPMB_WRITE_BLOCK_DSTATE
};
...
TraceEvent *hw_sd_trace_events[] = {
    ...
    &_TRACE_SDCARD_RPMB_READ_BLOCK_EVENT,
    &_TRACE_SDCARD_RPMB_WRITE_BLOCK_EVENT,
