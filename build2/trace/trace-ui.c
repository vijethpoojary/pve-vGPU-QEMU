...
uint16_t _TRACE_VNC_MSG_CLIENT_CUT_TEXT_DSTATE;
uint16_t _TRACE_VNC_MSG_CLIENT_CUT_TEXT_EXT_DSTATE;
uint16_t _TRACE_VNC_MSG_CLIENT_EXT_KEY_EVENT_DSTATE;
uint16_t _TRACE_VNC_MSG_CLIENT_FRAMEBUFFER_UPDATE_REQUEST_DSTATE;
uint16_t _TRACE_VNC_MSG_CLIENT_KEY_EVENT_DSTATE;
uint16_t _TRACE_VNC_MSG_CLIENT_POINTER_EVENT_DSTATE;
uint16_t _TRACE_VNC_MSG_CLIENT_SET_DESKTOP_SIZE_DSTATE;
uint16_t _TRACE_VNC_MSG_CLIENT_SET_ENCODINGS_DSTATE;
uint16_t _TRACE_VNC_MSG_CLIENT_SET_PIXEL_FORMAT_DSTATE;
uint16_t _TRACE_VNC_MSG_CLIENT_SET_PIXEL_FORMAT_RGB_DSTATE;
uint16_t _TRACE_VNC_MSG_CLIENT_XVP_DSTATE;
...
uint16_t _TRACE_VNC_CLIENT_PIXEL_FORMAT_DSTATE;
uint16_t _TRACE_VNC_CLIENT_PIXEL_FORMAT_RED_DSTATE;
uint16_t _TRACE_VNC_CLIENT_PIXEL_FORMAT_GREEN_DSTATE;
uint16_t _TRACE_VNC_CLIENT_PIXEL_FORMAT_BLUE_DSTATE;
...
TraceEvent _TRACE_VNC_MSG_CLIENT_CUT_TEXT_EVENT = {
    .id = 0,
    .name = "vnc_msg_client_cut_text",
    .sstate = TRACE_VNC_MSG_CLIENT_CUT_TEXT_ENABLED,
    .dstate = &_TRACE_VNC_MSG_CLIENT_CUT_TEXT_DSTATE
};
TraceEvent _TRACE_VNC_MSG_CLIENT_CUT_TEXT_EXT_EVENT = {
    .id = 0,
    .name = "vnc_msg_client_cut_text_ext",
    .sstate = TRACE_VNC_MSG_CLIENT_CUT_TEXT_EXT_ENABLED,
    .dstate = &_TRACE_VNC_MSG_CLIENT_CUT_TEXT_EXT_DSTATE
};
TraceEvent _TRACE_VNC_MSG_CLIENT_EXT_KEY_EVENT_EVENT = {
    .id = 0,
    .name = "vnc_msg_client_ext_key_event",
    .sstate = TRACE_VNC_MSG_CLIENT_EXT_KEY_EVENT_ENABLED,
    .dstate = &_TRACE_VNC_MSG_CLIENT_EXT_KEY_EVENT_DSTATE
};
TraceEvent _TRACE_VNC_MSG_CLIENT_FRAMEBUFFER_UPDATE_REQUEST_EVENT = {
    .id = 0,
    .name = "vnc_msg_client_framebuffer_update_request",
    .sstate = TRACE_VNC_MSG_CLIENT_FRAMEBUFFER_UPDATE_REQUEST_ENABLED,
    .dstate = &_TRACE_VNC_MSG_CLIENT_FRAMEBUFFER_UPDATE_REQUEST_DSTATE
};
TraceEvent _TRACE_VNC_MSG_CLIENT_KEY_EVENT_EVENT = {
    .id = 0,
    .name = "vnc_msg_client_key_event",
    .sstate = TRACE_VNC_MSG_CLIENT_KEY_EVENT_ENABLED,
    .dstate = &_TRACE_VNC_MSG_CLIENT_KEY_EVENT_DSTATE
};
TraceEvent _TRACE_VNC_MSG_CLIENT_POINTER_EVENT_EVENT = {
    .id = 0,
    .name = "vnc_msg_client_pointer_event",
    .sstate = TRACE_VNC_MSG_CLIENT_POINTER_EVENT_ENABLED,
    .dstate = &_TRACE_VNC_MSG_CLIENT_POINTER_EVENT_DSTATE
};
...
TraceEvent _TRACE_VNC_MSG_CLIENT_SET_ENCODINGS_EVENT = {
    .id = 0,
    .name = "vnc_msg_client_set_encodings",
    .sstate = TRACE_VNC_MSG_CLIENT_SET_ENCODINGS_ENABLED,
    .dstate = &_TRACE_VNC_MSG_CLIENT_SET_ENCODINGS_DSTATE
};
TraceEvent _TRACE_VNC_MSG_CLIENT_SET_PIXEL_FORMAT_EVENT = {
    .id = 0,
    .name = "vnc_msg_client_set_pixel_format",
    .sstate = TRACE_VNC_MSG_CLIENT_SET_PIXEL_FORMAT_ENABLED,
    .dstate = &_TRACE_VNC_MSG_CLIENT_SET_PIXEL_FORMAT_DSTATE
};
TraceEvent _TRACE_VNC_MSG_CLIENT_SET_PIXEL_FORMAT_RGB_EVENT = {
    .id = 0,
    .name = "vnc_msg_client_set_pixel_format_rgb",
    .sstate = TRACE_VNC_MSG_CLIENT_SET_PIXEL_FORMAT_RGB_ENABLED,
    .dstate = &_TRACE_VNC_MSG_CLIENT_SET_PIXEL_FORMAT_RGB_DSTATE
};
TraceEvent _TRACE_VNC_MSG_CLIENT_XVP_EVENT = {
    .id = 0,
    .name = "vnc_msg_client_xvp",
    .sstate = TRACE_VNC_MSG_CLIENT_XVP_ENABLED,
    .dstate = &_TRACE_VNC_MSG_CLIENT_XVP_DSTATE
};
...
TraceEvent _TRACE_VNC_CLIENT_PIXEL_FORMAT_EVENT = {
    .id = 0,
    .name = "vnc_client_pixel_format",
    .sstate = TRACE_VNC_CLIENT_PIXEL_FORMAT_ENABLED,
    .dstate = &_TRACE_VNC_CLIENT_PIXEL_FORMAT_DSTATE
};
TraceEvent _TRACE_VNC_CLIENT_PIXEL_FORMAT_RED_EVENT = {
    .id = 0,
    .name = "vnc_client_pixel_format_red",
    .sstate = TRACE_VNC_CLIENT_PIXEL_FORMAT_RED_ENABLED,
    .dstate = &_TRACE_VNC_CLIENT_PIXEL_FORMAT_RED_DSTATE
};
TraceEvent _TRACE_VNC_CLIENT_PIXEL_FORMAT_GREEN_EVENT = {
    .id = 0,
    .name = "vnc_client_pixel_format_green",
    .sstate = TRACE_VNC_CLIENT_PIXEL_FORMAT_GREEN_ENABLED,
    .dstate = &_TRACE_VNC_CLIENT_PIXEL_FORMAT_GREEN_DSTATE
};
TraceEvent _TRACE_VNC_CLIENT_PIXEL_FORMAT_BLUE_EVENT = {
    .id = 0,
    .name = "vnc_client_pixel_format_blue",
    .sstate = TRACE_VNC_CLIENT_PIXEL_FORMAT_BLUE_ENABLED,
    .dstate = &_TRACE_VNC_CLIENT_PIXEL_FORMAT_BLUE_DSTATE
};
...
TraceEvent *ui_trace_events[] = {
    ...
    &_TRACE_VNC_MSG_CLIENT_CUT_TEXT_EVENT,
    &_TRACE_VNC_MSG_CLIENT_CUT_TEXT_EXT_EVENT,
    &_TRACE_VNC_MSG_CLIENT_EXT_KEY_EVENT_EVENT,
    &_TRACE_VNC_MSG_CLIENT_FRAMEBUFFER_UPDATE_REQUEST_EVENT,
    &_TRACE_VNC_MSG_CLIENT_KEY_EVENT_EVENT,
    &_TRACE_VNC_MSG_CLIENT_POINTER_EVENT_EVENT,
    &_TRACE_VNC_MSG_CLIENT_SET_DESKTOP_SIZE_EVENT,
    &_TRACE_VNC_MSG_CLIENT_SET_ENCODINGS_EVENT,
    &_TRACE_VNC_MSG_CLIENT_SET_PIXEL_FORMAT_EVENT,
    &_TRACE_VNC_MSG_CLIENT_SET_PIXEL_FORMAT_RGB_EVENT,
    &_TRACE_VNC_MSG_CLIENT_XVP_EVENT,
    ...
    &_TRACE_VNC_CLIENT_PIXEL_FORMAT_EVENT,
    &_TRACE_VNC_CLIENT_PIXEL_FORMAT_RED_EVENT,
    &_TRACE_VNC_CLIENT_PIXEL_FORMAT_GREEN_EVENT,
    &_TRACE_VNC_CLIENT_PIXEL_FORMAT_BLUE_EVENT,
