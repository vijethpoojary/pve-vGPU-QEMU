...
uint16_t _TRACE_THREAD_POOL_SUBMIT_AIO_DSTATE;
uint16_t _TRACE_THREAD_POOL_COMPLETE_AIO_DSTATE;
uint16_t _TRACE_THREAD_POOL_CANCEL_AIO_DSTATE;
...
uint16_t _TRACE_FDMON_IO_URING_ADD_SQE_DSTATE;
uint16_t _TRACE_FDMON_IO_URING_CQE_HANDLER_DSTATE;
...
TraceEvent _TRACE_THREAD_POOL_SUBMIT_AIO_EVENT = {
    .id = 0,
    .name = "thread_pool_submit_aio",
    .sstate = TRACE_THREAD_POOL_SUBMIT_AIO_ENABLED,
    .dstate = &_TRACE_THREAD_POOL_SUBMIT_AIO_DSTATE
};
TraceEvent _TRACE_THREAD_POOL_COMPLETE_AIO_EVENT = {
    .id = 0,
    .name = "thread_pool_complete_aio",
    .sstate = TRACE_THREAD_POOL_COMPLETE_AIO_ENABLED,
    .dstate = &_TRACE_THREAD_POOL_COMPLETE_AIO_DSTATE
};
TraceEvent _TRACE_THREAD_POOL_CANCEL_AIO_EVENT = {
    .id = 0,
    .name = "thread_pool_cancel_aio",
    .sstate = TRACE_THREAD_POOL_CANCEL_AIO_ENABLED,
    .dstate = &_TRACE_THREAD_POOL_CANCEL_AIO_DSTATE
};
...
TraceEvent _TRACE_FDMON_IO_URING_ADD_SQE_EVENT = {
    .id = 0,
    .name = "fdmon_io_uring_add_sqe",
    .sstate = TRACE_FDMON_IO_URING_ADD_SQE_ENABLED,
    .dstate = &_TRACE_FDMON_IO_URING_ADD_SQE_DSTATE
};
TraceEvent _TRACE_FDMON_IO_URING_CQE_HANDLER_EVENT = {
    .id = 0,
    .name = "fdmon_io_uring_cqe_handler",
    .sstate = TRACE_FDMON_IO_URING_CQE_HANDLER_ENABLED,
    .dstate = &_TRACE_FDMON_IO_URING_CQE_HANDLER_DSTATE
};
...
TraceEvent *util_trace_events[] = {
    ...
    &_TRACE_THREAD_POOL_SUBMIT_AIO_EVENT,
    &_TRACE_THREAD_POOL_COMPLETE_AIO_EVENT,
    &_TRACE_THREAD_POOL_CANCEL_AIO_EVENT,
    &_TRACE_BUFFER_RESIZE_EVENT,
    &_TRACE_BUFFER_MOVE_EMPTY_EVENT,
    &_TRACE_BUFFER_MOVE_EVENT,
    &_TRACE_BUFFER_FREE_EVENT,
    &_TRACE_FDMON_IO_URING_ADD_SQE_EVENT,
    &_TRACE_FDMON_IO_URING_CQE_HANDLER_EVENT,
