...
uint16_t _TRACE_LURING_CQE_HANDLER_DSTATE;
uint16_t _TRACE_LURING_CO_SUBMIT_DSTATE;
uint16_t _TRACE_LURING_RESUBMIT_SHORT_IO_DSTATE;
...
uint16_t _TRACE_CURL_HEADER_CB_DSTATE;
...
TraceEvent _TRACE_LURING_CQE_HANDLER_EVENT = {
    .id = 0,
    .name = "luring_cqe_handler",
    .sstate = TRACE_LURING_CQE_HANDLER_ENABLED,
    .dstate = &_TRACE_LURING_CQE_HANDLER_DSTATE
};
...
TraceEvent _TRACE_LURING_RESUBMIT_SHORT_IO_EVENT = {
    .id = 0,
    .name = "luring_resubmit_short_io",
    .sstate = TRACE_LURING_RESUBMIT_SHORT_IO_ENABLED,
    .dstate = &_TRACE_LURING_RESUBMIT_SHORT_IO_DSTATE
};
...
TraceEvent _TRACE_CURL_HEADER_CB_EVENT = {
    .id = 0,
    .name = "curl_header_cb",
    .sstate = TRACE_CURL_HEADER_CB_ENABLED,
    .dstate = &_TRACE_CURL_HEADER_CB_DSTATE
};
...
TraceEvent *block_trace_events[] = {
    ...
    &_TRACE_LURING_CQE_HANDLER_EVENT,
    &_TRACE_LURING_CO_SUBMIT_EVENT,
    &_TRACE_LURING_RESUBMIT_SHORT_IO_EVENT,
