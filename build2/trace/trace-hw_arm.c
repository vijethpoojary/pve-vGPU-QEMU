...
uint16_t _TRACE_OMAP1_PWL_CLOCKING_SCHEME_DSTATE;
uint16_t _TRACE_OMAP1_PWL_BACKLIGHT_DSTATE;
uint16_t _TRACE_OMAP1_PWT_BUZZ_DSTATE;
uint16_t _TRACE_OMAP1_PWT_SILENCE_DSTATE;
uint16_t _TRACE_OMAP1_LPG_LED_DSTATE;
...
uint16_t _TRACE_SMMU_CONFIGS_INV_SID_RANGE_DSTATE;
uint16_t _TRACE_SMMU_CONFIG_CACHE_INV_DSTATE;
...
uint16_t _TRACE_SMMUV3_PROPAGATE_EVENT_DSTATE;
...
uint16_t _TRACE_SMMU_RESET_EXIT_DSTATE;
uint16_t _TRACE_SMMUV3_ACCEL_SET_IOMMU_DEVICE_DSTATE;
uint16_t _TRACE_SMMUV3_ACCEL_UNSET_IOMMU_DEVICE_DSTATE;
uint16_t _TRACE_SMMUV3_ACCEL_TRANSLATE_STE_DSTATE;
uint16_t _TRACE_SMMUV3_ACCEL_INSTALL_STE_DSTATE;
...
TraceEvent _TRACE_OMAP1_PWL_CLOCKING_SCHEME_EVENT = {
    .id = 0,
    .name = "omap1_pwl_clocking_scheme",
    .sstate = TRACE_OMAP1_PWL_CLOCKING_SCHEME_ENABLED,
    .dstate = &_TRACE_OMAP1_PWL_CLOCKING_SCHEME_DSTATE
};
TraceEvent _TRACE_OMAP1_PWL_BACKLIGHT_EVENT = {
    .id = 0,
    .name = "omap1_pwl_backlight",
    .sstate = TRACE_OMAP1_PWL_BACKLIGHT_ENABLED,
    .dstate = &_TRACE_OMAP1_PWL_BACKLIGHT_DSTATE
};
TraceEvent _TRACE_OMAP1_PWT_BUZZ_EVENT = {
    .id = 0,
    .name = "omap1_pwt_buzz",
    .sstate = TRACE_OMAP1_PWT_BUZZ_ENABLED,
    .dstate = &_TRACE_OMAP1_PWT_BUZZ_DSTATE
};
TraceEvent _TRACE_OMAP1_PWT_SILENCE_EVENT = {
    .id = 0,
    .name = "omap1_pwt_silence",
    .sstate = TRACE_OMAP1_PWT_SILENCE_ENABLED,
    .dstate = &_TRACE_OMAP1_PWT_SILENCE_DSTATE
};
TraceEvent _TRACE_OMAP1_LPG_LED_EVENT = {
    .id = 0,
    .name = "omap1_lpg_led",
    .sstate = TRACE_OMAP1_LPG_LED_ENABLED,
    .dstate = &_TRACE_OMAP1_LPG_LED_DSTATE
};
...
TraceEvent _TRACE_SMMU_CONFIGS_INV_SID_RANGE_EVENT = {
    .id = 0,
    .name = "smmu_configs_inv_sid_range",
    .sstate = TRACE_SMMU_CONFIGS_INV_SID_RANGE_ENABLED,
    .dstate = &_TRACE_SMMU_CONFIGS_INV_SID_RANGE_DSTATE
};
TraceEvent _TRACE_SMMU_CONFIG_CACHE_INV_EVENT = {
    .id = 0,
    .name = "smmu_config_cache_inv",
    .sstate = TRACE_SMMU_CONFIG_CACHE_INV_ENABLED,
    .dstate = &_TRACE_SMMU_CONFIG_CACHE_INV_DSTATE
};
...
TraceEvent _TRACE_SMMUV3_PROPAGATE_EVENT_EVENT = {
    .id = 0,
    .name = "smmuv3_propagate_event",
    .sstate = TRACE_SMMUV3_PROPAGATE_EVENT_ENABLED,
    .dstate = &_TRACE_SMMUV3_PROPAGATE_EVENT_DSTATE
};
...
TraceEvent _TRACE_SMMU_RESET_EXIT_EVENT = {
    .id = 0,
    .name = "smmu_reset_exit",
    .sstate = TRACE_SMMU_RESET_EXIT_ENABLED,
    .dstate = &_TRACE_SMMU_RESET_EXIT_DSTATE
};
TraceEvent _TRACE_SMMUV3_ACCEL_SET_IOMMU_DEVICE_EVENT = {
    .id = 0,
    .name = "smmuv3_accel_set_iommu_device",
    .sstate = TRACE_SMMUV3_ACCEL_SET_IOMMU_DEVICE_ENABLED,
    .dstate = &_TRACE_SMMUV3_ACCEL_SET_IOMMU_DEVICE_DSTATE
};
TraceEvent _TRACE_SMMUV3_ACCEL_UNSET_IOMMU_DEVICE_EVENT = {
    .id = 0,
    .name = "smmuv3_accel_unset_iommu_device",
    .sstate = TRACE_SMMUV3_ACCEL_UNSET_IOMMU_DEVICE_ENABLED,
    .dstate = &_TRACE_SMMUV3_ACCEL_UNSET_IOMMU_DEVICE_DSTATE
};
TraceEvent _TRACE_SMMUV3_ACCEL_TRANSLATE_STE_EVENT = {
    .id = 0,
    .name = "smmuv3_accel_translate_ste",
    .sstate = TRACE_SMMUV3_ACCEL_TRANSLATE_STE_ENABLED,
    .dstate = &_TRACE_SMMUV3_ACCEL_TRANSLATE_STE_DSTATE
};
TraceEvent _TRACE_SMMUV3_ACCEL_INSTALL_STE_EVENT = {
    .id = 0,
    .name = "smmuv3_accel_install_ste",
    .sstate = TRACE_SMMUV3_ACCEL_INSTALL_STE_ENABLED,
    .dstate = &_TRACE_SMMUV3_ACCEL_INSTALL_STE_DSTATE
};
...
TraceEvent *hw_arm_trace_events[] = {
    &_TRACE_OMAP1_PWL_CLOCKING_SCHEME_EVENT,
    &_TRACE_OMAP1_PWL_BACKLIGHT_EVENT,
    &_TRACE_OMAP1_PWT_BUZZ_EVENT,
    &_TRACE_OMAP1_PWT_SILENCE_EVENT,
    &_TRACE_OMAP1_LPG_LED_EVENT,
    ...
    &_TRACE_SMMU_CONFIGS_INV_SID_RANGE_EVENT,
    &_TRACE_SMMU_CONFIG_CACHE_INV_EVENT,
    ...
    &_TRACE_SMMUV3_PROPAGATE_EVENT_EVENT,
    ...
    &_TRACE_SMMU_RESET_EXIT_EVENT,
    &_TRACE_SMMUV3_ACCEL_SET_IOMMU_DEVICE_EVENT,
    &_TRACE_SMMUV3_ACCEL_UNSET_IOMMU_DEVICE_EVENT,
    &_TRACE_SMMUV3_ACCEL_TRANSLATE_STE_EVENT,
    &_TRACE_SMMUV3_ACCEL_INSTALL_STE_EVENT,
