...
uint16_t _TRACE_KVM_ARCH_ON_VMFD_CHANGE_DSTATE;
...
uint16_t _TRACE_TDX_HANDLE_RESET_DSTATE;
...
TraceEvent _TRACE_KVM_ARCH_ON_VMFD_CHANGE_EVENT = {
    .id = 0,
    .name = "kvm_arch_on_vmfd_change",
    .sstate = TRACE_KVM_ARCH_ON_VMFD_CHANGE_ENABLED,
    .dstate = &_TRACE_KVM_ARCH_ON_VMFD_CHANGE_DSTATE
};
...
TraceEvent _TRACE_TDX_HANDLE_RESET_EVENT = {
    .id = 0,
    .name = "tdx_handle_reset",
    .sstate = TRACE_TDX_HANDLE_RESET_ENABLED,
    .dstate = &_TRACE_TDX_HANDLE_RESET_DSTATE
};
TraceEvent *target_i386_kvm_trace_events[] = {
    ...
    &_TRACE_KVM_ARCH_ON_VMFD_CHANGE_EVENT,
