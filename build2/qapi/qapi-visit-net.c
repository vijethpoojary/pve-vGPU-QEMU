...
#if defined(CONFIG_PASST)
bool visit_type_NetDevPasstOptions_members(Visitor *v, NetDevPasstOptions *obj, Error **errp)
{
    bool has_path = !!obj->path;
    bool has_address = !!obj->address;
    bool has_netmask = !!obj->netmask;
    bool has_mac = !!obj->mac;
    bool has_gateway = !!obj->gateway;
    bool has_interface = !!obj->interface;
    bool has_outbound = !!obj->outbound;
    bool has_outbound_if4 = !!obj->outbound_if4;
    bool has_outbound_if6 = !!obj->outbound_if6;
    bool has_dns = !!obj->dns;
    bool has_fqdn = !!obj->fqdn;
    bool has_map_host_loopback = !!obj->map_host_loopback;
    bool has_map_guest_addr = !!obj->map_guest_addr;
    bool has_dns_forward = !!obj->dns_forward;
    bool has_dns_host = !!obj->dns_host;

    if (visit_optional(v, "path", &has_path)) {
        if (!visit_type_str(v, "path", &obj->path, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "quiet", &obj->has_quiet)) {
        if (!visit_type_bool(v, "quiet", &obj->quiet, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "vhost-user", &obj->has_vhost_user)) {
        if (!visit_type_bool(v, "vhost-user", &obj->vhost_user, errp)) {
            return false;
        }
    }
    ...
    if (visit_optional(v, "address", &has_address)) {
        if (!visit_type_str(v, "address", &obj->address, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "netmask", &has_netmask)) {
        if (!visit_type_str(v, "netmask", &obj->netmask, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "mac", &has_mac)) {
        if (!visit_type_str(v, "mac", &obj->mac, errp)) {
            return false;
        }
    }
    ...
    if (visit_optional(v, "interface", &has_interface)) {
        if (!visit_type_str(v, "interface", &obj->interface, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "outbound", &has_outbound)) {
        if (!visit_type_str(v, "outbound", &obj->outbound, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "outbound-if4", &has_outbound_if4)) {
        if (!visit_type_str(v, "outbound-if4", &obj->outbound_if4, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "outbound-if6", &has_outbound_if6)) {
        if (!visit_type_str(v, "outbound-if6", &obj->outbound_if6, errp)) {
            return false;
        }
    }
    ...
    if (visit_optional(v, "search", &obj->has_search)) {
        if (!visit_type_StringList(v, "search", &obj->search, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "fqdn", &has_fqdn)) {
        if (!visit_type_str(v, "fqdn", &obj->fqdn, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "dhcp-dns", &obj->has_dhcp_dns)) {
        if (!visit_type_bool(v, "dhcp-dns", &obj->dhcp_dns, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "dhcp-search", &obj->has_dhcp_search)) {
        if (!visit_type_bool(v, "dhcp-search", &obj->dhcp_search, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "map-host-loopback", &has_map_host_loopback)) {
        if (!visit_type_str(v, "map-host-loopback", &obj->map_host_loopback, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "map-guest-addr", &has_map_guest_addr)) {
        if (!visit_type_str(v, "map-guest-addr", &obj->map_guest_addr, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "dns-forward", &has_dns_forward)) {
        if (!visit_type_str(v, "dns-forward", &obj->dns_forward, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "dns-host", &has_dns_host)) {
        if (!visit_type_str(v, "dns-host", &obj->dns_host, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "tcp", &obj->has_tcp)) {
        if (!visit_type_bool(v, "tcp", &obj->tcp, errp)) {
            return false;
        }
    }
    ...
    if (visit_optional(v, "icmp", &obj->has_icmp)) {
        if (!visit_type_bool(v, "icmp", &obj->icmp, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "dhcp", &obj->has_dhcp)) {
        if (!visit_type_bool(v, "dhcp", &obj->dhcp, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "ndp", &obj->has_ndp)) {
        if (!visit_type_bool(v, "ndp", &obj->ndp, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "dhcpv6", &obj->has_dhcpv6)) {
        if (!visit_type_bool(v, "dhcpv6", &obj->dhcpv6, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "ra", &obj->has_ra)) {
        if (!visit_type_bool(v, "ra", &obj->ra, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "freebind", &obj->has_freebind)) {
        if (!visit_type_bool(v, "freebind", &obj->freebind, errp)) {
            return false;
        }
    }
    ...
    if (visit_optional(v, "tcp-ports", &obj->has_tcp_ports)) {
        if (!visit_type_StringList(v, "tcp-ports", &obj->tcp_ports, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "udp-ports", &obj->has_udp_ports)) {
        if (!visit_type_StringList(v, "udp-ports", &obj->udp_ports, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "param", &obj->has_param)) {
        if (!visit_type_StringList(v, "param", &obj->param, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_NetDevPasstOptions(Visitor *v, const char *name,
                 NetDevPasstOptions **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(NetDevPasstOptions), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_NetDevPasstOptions_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_NetDevPasstOptions(*obj);
        *obj = NULL;
    }
    return ok;
}
#endif /* defined(CONFIG_PASST) */
...
bool visit_type_NetdevAFXDPOptions_members(Visitor *v, NetdevAFXDPOptions *obj, Error **errp)
{
    ...
    bool has_map_path = !!obj->map_path;
    ...
    if (visit_optional(v, "map-path", &has_map_path)) {
        if (!visit_type_str(v, "map-path", &obj->map_path, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "map-start-index", &obj->has_map_start_index)) {
        if (!visit_type_int32(v, "map-start-index", &obj->map_start_index, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_NetdevVhostVDPAOptions_members(Visitor *v, NetdevVhostVDPAOptions *obj, Error **errp)
{
    ...
    if (visit_optional(v, "x-svq", &obj->has_x_svq)) {
        if (visit_policy_reject(v, "x-svq", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-svq", 1u << QAPI_FEATURE_UNSTABLE)) {
...
bool visit_type_NetdevStreamOptions_members(Visitor *v, NetdevStreamOptions *obj, Error **errp)
{
    ...
    if (visit_optional(v, "reconnect-ms", &obj->has_reconnect_ms)) {
        if (!visit_type_int(v, "reconnect-ms", &obj->reconnect_ms, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_Netdev_members(Visitor *v, Netdev *obj, Error **errp)
{
    ...
    case NET_CLIENT_DRIVER_PASST:
        return visit_type_NetDevPasstOptions_members(v, &obj->u.passt, errp);
#endif /* defined(CONFIG_PASST) */
...
bool visit_type_q_obj_NETDEV_VHOST_USER_CONNECTED_arg_members(Visitor *v, q_obj_NETDEV_VHOST_USER_CONNECTED_arg *obj, Error **errp)
{
    if (!visit_type_str(v, "netdev-id", &obj->netdev_id, errp)) {
        return false;
    }
    if (!visit_type_str(v, "chardev-id", &obj->chardev_id, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_NETDEV_VHOST_USER_DISCONNECTED_arg_members(Visitor *v, q_obj_NETDEV_VHOST_USER_DISCONNECTED_arg *obj, Error **errp)
{
    if (!visit_type_str(v, "netdev-id", &obj->netdev_id, errp)) {
        return false;
    }
