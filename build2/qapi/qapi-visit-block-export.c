...
bool visit_type_NbdServerOptionsBase_members(Visitor *v, NbdServerOptionsBase *obj, Error **errp)
{
    bool has_tls_creds = !!obj->tls_creds;
    bool has_tls_authz = !!obj->tls_authz;

    if (visit_optional(v, "handshake-max-seconds", &obj->has_handshake_max_seconds)) {
        if (!visit_type_uint32(v, "handshake-max-seconds", &obj->handshake_max_seconds, errp)) {
            return false;
        }
    }
...
bool visit_type_NbdServerOptionsBase(Visitor *v, const char *name,
                 NbdServerOptionsBase **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(NbdServerOptionsBase), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_NbdServerOptionsBase_members(v, *obj, errp)) {
        goto out_obj;
    }
...
out_obj:
    ...
    if (!ok && visit_is_input(v)) {
        qapi_free_NbdServerOptionsBase(*obj);
        *obj = NULL;
    }
    return ok;
}
...
{
    if (!visit_type_NbdServerOptionsBase_members(v, (NbdServerOptionsBase *)obj, errp)) {
        return false;
    }
...
bool visit_type_NbdServerOptionsLegacy_members(Visitor *v, NbdServerOptionsLegacy *obj, Error **errp)
{
    if (!visit_type_NbdServerOptionsBase_members(v, (NbdServerOptionsBase *)obj, errp)) {
        return false;
    }
...
bool visit_type_NbdServerOptionsLegacy(Visitor *v, const char *name,
                 NbdServerOptionsLegacy **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(NbdServerOptionsLegacy), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_NbdServerOptionsLegacy_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_NbdServerOptionsLegacy(*obj);
        *obj = NULL;
    }
    return ok;
}
...
bool visit_type_BlockExportOptionsNbdBase_members(Visitor *v, BlockExportOptionsNbdBase *obj, Error **errp)
{
    ...
    bool has_description = !!obj->description;
    ...
    if (visit_optional(v, "description", &has_description)) {
...
{
    bool has_iothread = !!obj->iothread;
    ...
    if (visit_optional(v, "iothread", &has_iothread)) {
        if (!visit_type_BlockExportIothreads(v, "iothread", &obj->iothread, errp)) {
            return false;
        }
    }
    ...
    if (visit_optional(v, "allow-inactive", &obj->has_allow_inactive)) {
        if (!visit_type_bool(v, "allow-inactive", &obj->allow_inactive, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_BlockExportIothreads(Visitor *v, const char *name,
                 BlockExportIothreads **obj, Error **errp)
{
    bool ok = false;
    ...
    switch ((*obj)->type) {
    case QTYPE_QSTRING:
        ok = visit_type_str(v, name, &(*obj)->u.single, errp);
        break;
    case QTYPE_QLIST:
        ok = visit_type_strList(v, name, &(*obj)->u.multi, errp);
        break;
    case QTYPE_NONE:
        abort();
    default:
        ...
        error_setg(errp,
                   "Invalid parameter type for '%s', expected: BlockExportIothreads",
                   name ? name : "null");
        /* Avoid passing invalid *obj to qapi_free_BlockExportIothreads() */
        g_free(*obj);
        *obj = NULL;
    }
out_obj:
    ...
    if (!ok && visit_is_input(v)) {
        qapi_free_BlockExportIothreads(*obj);
        *obj = NULL;
    }
    return ok;
}
