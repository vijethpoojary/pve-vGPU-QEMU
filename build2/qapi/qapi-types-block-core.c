...
void qapi_free_BlockLimitsInfo(BlockLimitsInfo *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_BlockLimitsInfo(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_BlockdevChild(BlockdevChild *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_BlockdevChild(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_BlockdevChildList(BlockdevChildList *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_BlockdevChildList(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_BackupStatus(BackupStatus *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_BackupStatus(v, NULL, &obj, NULL);
    visit_free(v);
}

const QEnumLookup BackupFormat_lookup = {
    .array = (const char *const[]) {
        [BACKUP_FORMAT_VMA] = "vma",
        [BACKUP_FORMAT_PBS] = "pbs",
    },
    .size = BACKUP_FORMAT__MAX
};
...
void qapi_free_ProxmoxSupportStatus(ProxmoxSupportStatus *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_ProxmoxSupportStatus(v, NULL, &obj, NULL);
    visit_free(v);
}

const QEnumLookup PBSBitmapAction_lookup = {
    .array = (const char *const[]) {
        [PBS_BITMAP_ACTION_NOT_USED] = "not-used",
        [PBS_BITMAP_ACTION_NOT_USED_REMOVED] = "not-used-removed",
        [PBS_BITMAP_ACTION_NEW] = "new",
        [PBS_BITMAP_ACTION_USED] = "used",
        [PBS_BITMAP_ACTION_INVALID] = "invalid",
        [PBS_BITMAP_ACTION_MISSING_RECREATED] = "missing-recreated",
    },
    .size = PBS_BITMAP_ACTION__MAX
};
...
void qapi_free_PBSBitmapInfo(PBSBitmapInfo *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_PBSBitmapInfo(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_PBSBitmapInfoList(PBSBitmapInfoList *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_PBSBitmapInfoList(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_BackupAccessInfo(BackupAccessInfo *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_BackupAccessInfo(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_BackupAccessSourceDevice(BackupAccessSourceDevice *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_BackupAccessSourceDevice(v, NULL, &obj, NULL);
    visit_free(v);
}

const QEnumLookup BackupAccessSetupBitmapMode_lookup = {
    .array = (const char *const[]) {
        [BACKUP_ACCESS_SETUP_BITMAP_MODE_NONE] = "none",
        [BACKUP_ACCESS_SETUP_BITMAP_MODE_NEW] = "new",
        [BACKUP_ACCESS_SETUP_BITMAP_MODE_USE] = "use",
    },
    .size = BACKUP_ACCESS_SETUP_BITMAP_MODE__MAX
};
...
void qapi_free_BackupAccessSourceDeviceList(BackupAccessSourceDeviceList *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_BackupAccessSourceDeviceList(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_BackupAccessInfoList(BackupAccessInfoList *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_BackupAccessInfoList(v, NULL, &obj, NULL);
    visit_free(v);
}
...
const QEnumLookup XDbgBlockGraphNodeType_lookup = {
    .array = (const char *const[]) {
        [XDBG_BLOCK_GRAPH_NODE_TYPE_BLOCK_BACKEND] = "block-backend",
        [XDBG_BLOCK_GRAPH_NODE_TYPE_BLOCK_JOB] = "block-job",
        [XDBG_BLOCK_GRAPH_NODE_TYPE_BLOCK_DRIVER] = "block-driver",
    },
    .size = XDBG_BLOCK_GRAPH_NODE_TYPE__MAX
};
...
const QEnumLookup BlockdevDriver_lookup = {
    .array = (const char *const[]) {
        [BLOCKDEV_DRIVER_ALLOC_TRACK] = "alloc-track",
        ...
        [BLOCKDEV_DRIVER_ZEROINIT] = "zeroinit",
    },
    .features = (const uint64_t[BLOCKDEV_DRIVER__MAX]) {
        [BLOCKDEV_DRIVER_GLUSTER] = 1u << QAPI_FEATURE_DEPRECATED,
    },
...
void qapi_free_BlockdevOptionsAllocTrack(BlockdevOptionsAllocTrack *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_BlockdevOptionsAllocTrack(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_BlockdevOptionsPbs(BlockdevOptionsPbs *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_BlockdevOptionsPbs(v, NULL, &obj, NULL);
    visit_free(v);
}
