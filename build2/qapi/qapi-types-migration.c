...
const QEnumLookup MigrationStatus_lookup = {
    .array = (const char *const[]) {
        ...
        [MIGRATION_STATUS_POSTCOPY_DEVICE] = "postcopy-device",
        ...
        [MIGRATION_STATUS_FAILING] = "failing",
...
void qapi_free_SaveVMInfo(SaveVMInfo *obj)
{
    Visitor *v;
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_SaveVMInfo(v, NULL, &obj, NULL);
    visit_free(v);
}
...
const QEnumLookup MigrationCapability_lookup = {
    ...
    .features = (const uint64_t[MIGRATION_CAPABILITY__MAX]) {
        [MIGRATION_CAPABILITY_X_COLO] = 1u << QAPI_FEATURE_UNSTABLE,
        [MIGRATION_CAPABILITY_X_IGNORE_SHARED] = 1u << QAPI_FEATURE_UNSTABLE,
    },
...
const QEnumLookup MultiFDCompression_lookup = {
    .array = (const char *const[]) {
        ...
        [MULTIFD_COMPRESSION_QATZIP] = "qatzip",
#endif /* defined(CONFIG_QATZIP) */
...
const QEnumLookup MigMode_lookup = {
    .array = (const char *const[]) {
        ...
        [MIG_MODE_CPR_TRANSFER] = "cpr-transfer",
        [MIG_MODE_CPR_EXEC] = "cpr-exec",
    },
    .size = MIG_MODE__MAX
};
...
const QEnumLookup MigrationParameter_lookup = {
    .array = (const char *const[]) {
        ...
        [MIGRATION_PARAMETER_MULTIFD_QATZIP_LEVEL] = "multifd-qatzip-level",
        ...
        [MIGRATION_PARAMETER_CPR_EXEC_COMMAND] = "cpr-exec-command",
    },
    .features = (const uint64_t[MIGRATION_PARAMETER__MAX]) {
        [MIGRATION_PARAMETER_X_CHECKPOINT_DELAY] = 1u << QAPI_FEATURE_UNSTABLE,
        [MIGRATION_PARAMETER_X_VCPU_DIRTY_LIMIT_PERIOD] = 1u << QAPI_FEATURE_UNSTABLE,
    },
...
const QEnumLookup MigrationChannelType_lookup = {
    .array = (const char *const[]) {
        ...
        [MIGRATION_CHANNEL_TYPE_CPR] = "cpr",
    },
