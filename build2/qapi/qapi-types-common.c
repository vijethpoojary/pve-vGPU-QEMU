...
const QEnumLookup OffAutoPCIBAR_lookup = {
    .array = (const char *const[]) {
        [OFF_AUTO_PCIBAR_OFF] = "off",
        [OFF_AUTO_PCIBAR_AUTO] = "auto",
        [OFF_AUTO_PCIBAR_BAR0] = "bar0",
        [OFF_AUTO_PCIBAR_BAR1] = "bar1",
        [OFF_AUTO_PCIBAR_BAR2] = "bar2",
        [OFF_AUTO_PCIBAR_BAR3] = "bar3",
        [OFF_AUTO_PCIBAR_BAR4] = "bar4",
        [OFF_AUTO_PCIBAR_BAR5] = "bar5",
    },
    .size = OFF_AUTO_PCIBAR__MAX
};
...
const QEnumLookup EndianMode_lookup = {
    .array = (const char *const[]) {
        [ENDIAN_MODE_UNSPECIFIED] = "unspecified",
        [ENDIAN_MODE_LITTLE] = "little",
        [ENDIAN_MODE_BIG] = "big",
    },
    .size = ENDIAN_MODE__MAX
};
