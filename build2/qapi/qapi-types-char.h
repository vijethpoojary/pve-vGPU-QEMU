...
typedef struct ChardevHub ChardevHub;
...
typedef struct ChardevPty ChardevPty;
...
typedef struct ChardevHubWrapper ChardevHubWrapper;
...
typedef struct ChardevPtyWrapper ChardevPtyWrapper;
...
static inline ChardevCommon *qapi_ChardevHub_base(const ChardevHub *obj)
{
    return (ChardevCommon *)obj;
}

void qapi_free_ChardevHub(ChardevHub *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(ChardevHub, qapi_free_ChardevHub)
...
static inline ChardevCommon *qapi_ChardevPty_base(const ChardevPty *obj)
{
    return (ChardevCommon *)obj;
}

void qapi_free_ChardevPty(ChardevPty *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(ChardevPty, qapi_free_ChardevPty)
...
void qapi_free_ChardevHubWrapper(ChardevHubWrapper *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(ChardevHubWrapper, qapi_free_ChardevHubWrapper)
...
void qapi_free_ChardevPtyWrapper(ChardevPtyWrapper *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(ChardevPtyWrapper, qapi_free_ChardevPtyWrapper)
