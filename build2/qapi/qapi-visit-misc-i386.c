...
{
    int value = *obj;
    bool ok = visit_type_enum(v, name, &value, &SevGuestType_lookup, errp);
    *obj = value;
    return ok;
}
                 ...
                 SevGuestInfo **obj, Error **errp)
{
    ...
    if (!visit_start_struct(v, name, (void **)obj, sizeof(SevGuestInfo), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_SevGuestInfo_members(v, *obj, errp)) {
        goto out_obj;
    }
                 ...
                 SevSnpGuestInfo **obj, Error **errp)
{
    ...
    if (!visit_start_struct(v, name, (void **)obj, sizeof(SevSnpGuestInfo), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_SevSnpGuestInfo_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
...
bool visit_type_q_obj_SevInfo_base_members(Visitor *v, q_obj_SevInfo_base *obj, Error **errp)
{
    ...
    if (!visit_type_SevGuestType(v, "sev-type", &obj->sev_type, errp)) {
        return false;
    }
    return true;
}
...
bool visit_type_SevInfo_members(Visitor *v, SevInfo *obj, Error **errp)
{
    ...
    switch (obj->sev_type) {
    case SEV_GUEST_TYPE_SEV:
        return visit_type_SevGuestInfo_members(v, &obj->u.sev, errp);
    case SEV_GUEST_TYPE_SEV_SNP:
        return visit_type_SevSnpGuestInfo_members(v, &obj->u.sev_snp, errp);
    default:
        abort();
    }
    return true;
...
char qapi_dummy_qapi_visit_misc_i386_c;
