...
typedef struct NbdServerOptionsBase NbdServerOptionsBase;

typedef struct NbdServerOptions NbdServerOptions;

typedef struct NbdServerOptionsLegacy NbdServerOptionsLegacy;
...
typedef struct BlockExportIothreads BlockExportIothreads;
...
struct NbdServerOptionsBase {
    bool has_handshake_max_seconds;
...
void qapi_free_NbdServerOptionsBase(NbdServerOptionsBase *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(NbdServerOptionsBase, qapi_free_NbdServerOptionsBase)

struct NbdServerOptions {
    /* Members inherited from NbdServerOptionsBase: */
    bool has_handshake_max_seconds;
    uint32_t handshake_max_seconds;
    char *tls_creds;
    char *tls_authz;
...
static inline NbdServerOptionsBase *qapi_NbdServerOptions_base(const NbdServerOptions *obj)
{
    return (NbdServerOptionsBase *)obj;
}
...
static inline NbdServerOptionsBase *qapi_NbdServerOptionsLegacy_base(const NbdServerOptionsLegacy *obj)
{
    return (NbdServerOptionsBase *)obj;
}

void qapi_free_NbdServerOptionsLegacy(NbdServerOptionsLegacy *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(NbdServerOptionsLegacy, qapi_free_NbdServerOptionsLegacy)
...
struct q_obj_BlockExportOptions_base {
    ...
    bool fixed_iothread;
    BlockExportIothreads *iothread;
    char *node_name;
    bool has_writable;
    bool writable;
    bool has_writethrough;
    bool writethrough;
    bool has_allow_inactive;
    bool allow_inactive;
};
...
void qapi_free_BlockExportIothreads(BlockExportIothreads *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(BlockExportIothreads, qapi_free_BlockExportIothreads)
