...
const QEnumLookup GuestPanicInformationType_lookup = {
    .array = (const char *const[]) {
        ...
        [GUEST_PANIC_INFORMATION_TYPE_TDX] = "tdx",
        [GUEST_PANIC_INFORMATION_TYPE_SEV] = "sev",
    },
...
void qapi_free_GuestPanicInformationTdx(GuestPanicInformationTdx *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_GuestPanicInformationTdx(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_GuestPanicInformationSev(GuestPanicInformationSev *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_GuestPanicInformationSev(v, NULL, &obj, NULL);
    visit_free(v);
}
