...
typedef struct CXLCommonEventBase CXLCommonEventBase;

typedef struct CXLGeneralMediaEvent CXLGeneralMediaEvent;

typedef struct CXLDRAMEvent CXLDRAMEvent;

typedef struct CXLMemModuleEvent CXLMemModuleEvent;
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CXLCommonEventBase, qapi_free_CXLCommonEventBase)

struct CXLGeneralMediaEvent {
    /* Members inherited from CXLCommonEventBase: */
    char *path;
    CxlEventLog log;
    uint32_t flags;
    bool has_maint_op_class;
...
static inline CXLCommonEventBase *qapi_CXLGeneralMediaEvent_base(const CXLGeneralMediaEvent *obj)
{
    return (CXLCommonEventBase *)obj;
}

void qapi_free_CXLGeneralMediaEvent(CXLGeneralMediaEvent *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CXLGeneralMediaEvent, qapi_free_CXLGeneralMediaEvent)
...
static inline CXLCommonEventBase *qapi_CXLDRAMEvent_base(const CXLDRAMEvent *obj)
{
    return (CXLCommonEventBase *)obj;
}

void qapi_free_CXLDRAMEvent(CXLDRAMEvent *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CXLDRAMEvent, qapi_free_CXLDRAMEvent)
...
static inline CXLCommonEventBase *qapi_CXLMemModuleEvent_base(const CXLMemModuleEvent *obj)
{
    return (CXLCommonEventBase *)obj;
}

void qapi_free_CXLMemModuleEvent(CXLMemModuleEvent *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CXLMemModuleEvent, qapi_free_CXLMemModuleEvent)
