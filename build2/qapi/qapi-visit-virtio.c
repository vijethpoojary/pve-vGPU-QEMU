...
{
    bool has_vhost_dev = !!obj->vhost_dev;
    ...
    if (visit_optional(v, "vhost-dev", &has_vhost_dev)) {
...
bool visit_type_VirtioDeviceFeatures_members(Visitor *v, VirtioDeviceFeatures *obj, Error **errp)
{
    ...
    if (visit_optional(v, "unknown-dev-features2", &obj->has_unknown_dev_features2)) {
        if (!visit_type_uint64(v, "unknown-dev-features2", &obj->unknown_dev_features2, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_IOThreadVirtQueueMapping_members(Visitor *v, IOThreadVirtQueueMapping *obj, Error **errp)
{
    if (!visit_type_str(v, "iothread", &obj->iothread, errp)) {
        return false;
    }
    if (visit_optional(v, "vqs", &obj->has_vqs)) {
        if (!visit_type_uint16List(v, "vqs", &obj->vqs, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_IOThreadVirtQueueMapping(Visitor *v, const char *name,
                 IOThreadVirtQueueMapping **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(IOThreadVirtQueueMapping), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_IOThreadVirtQueueMapping_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_IOThreadVirtQueueMapping(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_VirtIOGPUOutput_members(Visitor *v, VirtIOGPUOutput *obj, Error **errp)
{
    if (!visit_type_str(v, "name", &obj->name, errp)) {
        return false;
    }
    if (visit_optional(v, "xres", &obj->has_xres)) {
        if (!visit_type_uint16(v, "xres", &obj->xres, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "yres", &obj->has_yres)) {
        if (!visit_type_uint16(v, "yres", &obj->yres, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_VirtIOGPUOutput(Visitor *v, const char *name,
                 VirtIOGPUOutput **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(VirtIOGPUOutput), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_VirtIOGPUOutput_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_VirtIOGPUOutput(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_IOThreadVirtQueueMappingList(Visitor *v, const char *name,
                 IOThreadVirtQueueMappingList **obj, Error **errp)
{
    bool ok = false;
    IOThreadVirtQueueMappingList *tail;
    size_t size = sizeof(**obj);
    ...
    for (tail = *obj; tail;
         tail = (IOThreadVirtQueueMappingList *)visit_next_list(v, (GenericList *)tail, size)) {
        if (!visit_type_IOThreadVirtQueueMapping(v, NULL, &tail->value, errp)) {
            goto out_obj;
        }
    }
...
out_obj:
    visit_end_list(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_IOThreadVirtQueueMappingList(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_VirtIOGPUOutputList(Visitor *v, const char *name,
                 VirtIOGPUOutputList **obj, Error **errp)
{
    bool ok = false;
    VirtIOGPUOutputList *tail;
    size_t size = sizeof(**obj);
    ...
    for (tail = *obj; tail;
         tail = (VirtIOGPUOutputList *)visit_next_list(v, (GenericList *)tail, size)) {
        if (!visit_type_VirtIOGPUOutput(v, NULL, &tail->value, errp)) {
            goto out_obj;
        }
    }
...
out_obj:
    visit_end_list(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_VirtIOGPUOutputList(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_DummyVirtioForceArrays_members(Visitor *v, DummyVirtioForceArrays *obj, Error **errp)
{
    if (!visit_type_IOThreadVirtQueueMappingList(v, "unused-iothread-vq-mapping", &obj->unused_iothread_vq_mapping, errp)) {
        return false;
    }
    if (!visit_type_VirtIOGPUOutputList(v, "unused-virtio-gpu-output", &obj->unused_virtio_gpu_output, errp)) {
        return false;
    }
    return true;
}

bool visit_type_DummyVirtioForceArrays(Visitor *v, const char *name,
                 DummyVirtioForceArrays **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(DummyVirtioForceArrays), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_DummyVirtioForceArrays_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_DummyVirtioForceArrays(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_GranuleMode(Visitor *v, const char *name,
                 GranuleMode *obj, Error **errp)
{
    int value = *obj;
    bool ok = visit_type_enum(v, name, &value, &GranuleMode_lookup, errp);
    *obj = value;
    return ok;
}

bool visit_type_VMAppleVirtioBlkVariant(Visitor *v, const char *name,
                 VMAppleVirtioBlkVariant *obj, Error **errp)
{
    int value = *obj;
    bool ok = visit_type_enum(v, name, &value, &VMAppleVirtioBlkVariant_lookup, errp);
    *obj = value;
    return ok;
}
