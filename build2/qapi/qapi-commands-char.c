...
void qmp_marshal_query_chardev(QDict *args, QObject **ret, Error **errp)
{
    ...
    if (visit_type_ChardevInfoList(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_ChardevInfoList(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_query_chardev_backends(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_ChardevBackendInfoList(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_ChardevBackendInfoList(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_chardev_add(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_ChardevReturn(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_ChardevReturn(ov, "unused", &retval, NULL);
    visit_free(ov);
