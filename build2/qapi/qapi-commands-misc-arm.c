...
#include "qapi-commands-misc-arm.h"
#include "qobject/qjson.h"
#include "trace/trace-qapi_commands_misc_arm_trace_events.h"
...
void qmp_marshal_query_gic_capabilities(QDict *args, QObject **ret, Error **errp)
{
    ...
    if (visit_type_GICCapabilityList(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_GICCapabilityList(ov, "unused", &retval, NULL);
    visit_free(ov);
...
char qapi_dummy_qapi_commands_misc_arm_c;
