...
const QEnumLookup DumpGuestMemoryFormat_lookup = {
    .array = (const char *const[]) {
        ...
        [DUMP_GUEST_MEMORY_FORMAT_KDUMP_RAW_ZLIB] = "kdump-raw-zlib",
        [DUMP_GUEST_MEMORY_FORMAT_KDUMP_RAW_LZO] = "kdump-raw-lzo",
        [DUMP_GUEST_MEMORY_FORMAT_KDUMP_RAW_SNAPPY] = "kdump-raw-snappy",
