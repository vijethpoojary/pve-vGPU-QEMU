...
#define CONFIG_NITRO_HEARTBEAT 1

#define CONFIG_NITRO_MACHINE 1

#define CONFIG_NITRO_SERIAL_VSOCK 1

#define CONFIG_NITRO_VSOCK_BUS 1
...
#define CONFIG_REMOTE_PCIHOST 1
