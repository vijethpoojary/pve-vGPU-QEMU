...
const QEnumLookup TestUnionEnumA_lookup = {
    .array = (const char *const[]) {
        [TEST_UNION_ENUM_A_VALUE_A1] = "value-a1",
        [TEST_UNION_ENUM_A_VALUE_A2] = "value-a2",
    },
    .size = TEST_UNION_ENUM_A__MAX
};
...
const QEnumLookup FeatureEnum1_lookup = {
    ...
    .features = (const uint64_t[FEATURE_ENUM1__MAX]) {
        [FEATURE_ENUM1_DREI] = 1u << QAPI_FEATURE_DEPRECATED,
    },
