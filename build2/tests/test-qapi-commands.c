...
void qmp_marshal_user_def_cmd0(QDict *args, QObject **ret, Error **errp)
{
    ...
    if (visit_type_Empty2(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_Empty2(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_user_def_cmd2(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_UserDefTwo(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_UserDefTwo(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_test_if_cmd(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_UserDefThree(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_UserDefThree(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_test_features0(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_FeatureStruct1(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_FeatureStruct1(ov, "unused", &retval, NULL);
    visit_free(ov);
