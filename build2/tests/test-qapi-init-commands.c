...
void test_qmp_init_marshal(QmpCommandList *cmds)
{
    ...
    qmp_register_command(cmds, "test-command-features1",
                         qmp_marshal_test_command_features1, 0, 1u << QAPI_FEATURE_DEPRECATED);
    qmp_register_command(cmds, "test-command-features3",
                         qmp_marshal_test_command_features3, 0, 1u << QAPI_FEATURE_UNSTABLE | 1u << QAPI_FEATURE_FEATURE1 | 1u << QAPI_FEATURE_FEATURE2);
    qmp_register_command(cmds, "test-command-cond-features1",
                         qmp_marshal_test_command_cond_features1, 0, 1u << QAPI_FEATURE_FEATURE1);
    qmp_register_command(cmds, "test-command-cond-features2",
                         qmp_marshal_test_command_cond_features2, 0, 1u << QAPI_FEATURE_FEATURE1 | 1u << QAPI_FEATURE_FEATURE2);
    qmp_register_command(cmds, "test-command-cond-features3",
                         qmp_marshal_test_command_cond_features3, 0, 1u << QAPI_FEATURE_FEATURE1);
}
