...
const QEnumLookup GuestExecCaptureOutputMode_lookup = {
    .array = (const char *const[]) {
        [GUEST_EXEC_CAPTURE_OUTPUT_MODE_NONE] = "none",
        [GUEST_EXEC_CAPTURE_OUTPUT_MODE_STDOUT] = "stdout",
        [GUEST_EXEC_CAPTURE_OUTPUT_MODE_STDERR] = "stderr",
        [GUEST_EXEC_CAPTURE_OUTPUT_MODE_SEPARATED] = "separated",
#if !defined(CONFIG_WIN32)
        [GUEST_EXEC_CAPTURE_OUTPUT_MODE_MERGED] = "merged",
#endif /* !defined(CONFIG_WIN32) */
    },
    .size = GUEST_EXEC_CAPTURE_OUTPUT_MODE__MAX
};
...
void qapi_free_GuestExecCaptureOutput(GuestExecCaptureOutput *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_GuestExecCaptureOutput(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_GuestLoadAverage(GuestLoadAverage *obj)
{
    Visitor *v;
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_GuestLoadAverage(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_GuestNetworkRoute(GuestNetworkRoute *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_GuestNetworkRoute(v, NULL, &obj, NULL);
    visit_free(v);
}
#endif /* defined(CONFIG_LINUX) || defined(CONFIG_WIN32) */
...
void qapi_free_GuestNetworkRouteList(GuestNetworkRouteList *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_GuestNetworkRouteList(v, NULL, &obj, NULL);
    visit_free(v);
}
#endif /* defined(CONFIG_LINUX) || defined(CONFIG_WIN32) */
