...
const QLitObject qga_qmp_schema_qlit = QLIT_QLIST(((QLitObject[]) {
    ...
    QLIT_QDICT(((QLitDictEntry[]) {
        { "members", QLIT_QLIST(((QLitObject[]) {
            QLIT_QDICT(((QLitDictEntry[]) {
                { "name", QLIT_QSTR("load1m"), },
                { "type", QLIT_QSTR("number"), },
                {}
            })),
            QLIT_QDICT(((QLitDictEntry[]) {
                { "name", QLIT_QSTR("load5m"), },
                { "type", QLIT_QSTR("number"), },
                {}
            })),
            QLIT_QDICT(((QLitDictEntry[]) {
                { "name", QLIT_QSTR("load15m"), },
                { "type", QLIT_QSTR("number"), },
                {}
            })),
            {}
    ...
    QLIT_QDICT(((QLitDictEntry[]) {
        { "element-type", QLIT_QSTR("46"), },
        { "meta-type", QLIT_QSTR("array"), },
        { "name", QLIT_QSTR("[46]"), },
        {}
    })),
    /* "46" = GuestAgentCommandInfo */
    QLIT_QDICT(((QLitDictEntry[]) {
        { "members", QLIT_QLIST(((QLitObject[]) {
            QLIT_QDICT(((QLitDictEntry[]) {
                { "name", QLIT_QSTR("name"), },
...
#if defined(CONFIG_WIN32) || defined(CONFIG_LINUX)
    QLIT_QDICT(((QLitDictEntry[]) {
        { "element-type", QLIT_QSTR("51"), },
        { "meta-type", QLIT_QSTR("array"), },
        { "name", QLIT_QSTR("[51]"), },
        {}
    })),
#endif /* defined(CONFIG_WIN32) || defined(CONFIG_LINUX) */
    /* "53" = GuestMemoryBlockResponseType */
#if defined(CONFIG_LINUX)
    QLIT_QDICT(((QLitDictEntry[]) {
        { "members", QLIT_QLIST(((QLitObject[]) {
            QLIT_QDICT(((QLitDictEntry[]) {
