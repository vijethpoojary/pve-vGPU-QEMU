...
#define IOCTL_VIJGPU_GET_DEVICE_INFO \
    CTL_CODE(FILE_DEVICE_UNKNOWN, VIJGPU_IOCTL_BASE + 0, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_VIJGPU_TEST_NOP \
    CTL_CODE(FILE_DEVICE_UNKNOWN, VIJGPU_IOCTL_BASE + 1, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_VIJGPU_TEST_FILL_VRAM \
    CTL_CODE(FILE_DEVICE_UNKNOWN, VIJGPU_IOCTL_BASE + 2, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_VIJGPU_GET_COMPLETION \
    CTL_CODE(FILE_DEVICE_UNKNOWN, VIJGPU_IOCTL_BASE + 3, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_VIJGPU_RESET \
    CTL_CODE(FILE_DEVICE_UNKNOWN, VIJGPU_IOCTL_BASE + 4, METHOD_BUFFERED, FILE_ANY_ACCESS)

/* These structs must match public.h exactly - no pragma pack */
