...
#define CONFIG_AUDIO_DRIVERS "alsa", 
...
#undef CONFIG_GNUTLS_BUG1717_WORKAROUND
...
#define CONFIG_PTHREAD_GETNAME_NP

#undef CONFIG_PTHREAD_GET_NAME_NP
...
#define CONFIG_QEMU_CONFDIR "/usr/local/etc/kvm"

#define CONFIG_QEMU_DATADIR "/usr/local/share/kvm"
...
#define CONFIG_QEMU_MODDIR "/usr/local/lib/x86_64-linux-gnu/kvm"
...
#define HAVE_IO_URING_CQ_HAS_OVERFLOW

#define HAVE_IO_URING_PREP_WRITEV2
...
#define HAVE_RBD_NAMESPACE_EXISTS

#undef HAVE_SIGEV_NOTIFY_THREAD_ID

#undef HAVE_SPICE_QXL_GL_SCANOUT2
...
#define QEMU_VERSION "11.0.0"

#define QEMU_VERSION_MAJOR 11
