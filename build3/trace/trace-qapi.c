...
uint16_t _TRACE_VISIT_POLICY_REJECT_DSTATE;
uint16_t _TRACE_VISIT_POLICY_SKIP_DSTATE;
...
TraceEvent _TRACE_VISIT_POLICY_REJECT_EVENT = {
    .id = 0,
    .name = "visit_policy_reject",
    .sstate = TRACE_VISIT_POLICY_REJECT_ENABLED,
    .dstate = &_TRACE_VISIT_POLICY_REJECT_DSTATE
};
TraceEvent _TRACE_VISIT_POLICY_SKIP_EVENT = {
    .id = 0,
    .name = "visit_policy_skip",
    .sstate = TRACE_VISIT_POLICY_SKIP_ENABLED,
    .dstate = &_TRACE_VISIT_POLICY_SKIP_DSTATE
};
...
TraceEvent *qapi_trace_events[] = {
    ...
    &_TRACE_VISIT_POLICY_REJECT_EVENT,
    &_TRACE_VISIT_POLICY_SKIP_EVENT,
