...
uint16_t _TRACE_ASPEED_SBC_IGNORE_CMD_DSTATE;
uint16_t _TRACE_ASPEED_SBC_HANDLE_CMD_DSTATE;
uint16_t _TRACE_ASPEED_SBC_OTP_READ_DSTATE;
uint16_t _TRACE_ASPEED_SBC_OTP_PROG_DSTATE;
...
uint16_t _TRACE_NPCM_CLK_READ_DSTATE;
uint16_t _TRACE_NPCM_CLK_WRITE_DSTATE;
uint16_t _TRACE_NPCM_GCR_READ_DSTATE;
uint16_t _TRACE_NPCM_GCR_WRITE_DSTATE;
...
uint16_t _TRACE_IMX6_SRC_READ_DSTATE;
uint16_t _TRACE_IMX6_SRC_WRITE_DSTATE;
uint16_t _TRACE_IMX6_CLEAR_RESET_BIT_DSTATE;
uint16_t _TRACE_IMX6_SRC_RESET_DSTATE;
...
uint16_t _TRACE_ASPEED_PWM_READ_DSTATE;
uint16_t _TRACE_ASPEED_PWM_WRITE_DSTATE;
...
uint16_t _TRACE_ASPEED_HACE_READ_DSTATE;
uint16_t _TRACE_ASPEED_HACE_WRITE_DSTATE;
uint16_t _TRACE_ASPEED_HACE_HASH_SG_DSTATE;
uint16_t _TRACE_ASPEED_HACE_HASH_ADDR_DSTATE;
uint16_t _TRACE_ASPEED_HACE_HASH_EXECUTE_ACC_MODE_DSTATE;
uint16_t _TRACE_ASPEED_HACE_HEXDUMP_DSTATE;
...
uint16_t _TRACE_IVSHMEM_FLAT_IRQ_HANDLER_DSTATE;
uint16_t _TRACE_IVSHMEM_FLAT_NEW_PEER_DSTATE;
uint16_t _TRACE_IVSHMEM_FLAT_ADD_VECTOR_FAILURE_DSTATE;
uint16_t _TRACE_IVSHMEM_FLAT_ADD_VECTOR_SUCCESS_DSTATE;
uint16_t _TRACE_IVSHMEM_FLAT_IRQ_RESOLVED_DSTATE;
uint16_t _TRACE_IVSHMEM_FLAT_PROTO_VER_OWN_ID_DSTATE;
uint16_t _TRACE_IVSHMEM_FLAT_SHMEM_SIZE_DSTATE;
uint16_t _TRACE_IVSHMEM_FLAT_SHMEM_MAP_DSTATE;
uint16_t _TRACE_IVSHMEM_FLAT_MMIO_MAP_DSTATE;
uint16_t _TRACE_IVSHMEM_FLAT_READ_MMR_DSTATE;
uint16_t _TRACE_IVSHMEM_FLAT_READ_MMR_DOORBELL_DSTATE;
uint16_t _TRACE_IVSHMEM_FLAT_READ_WRITE_MMR_INVALID_DSTATE;
uint16_t _TRACE_IVSHMEM_FLAT_INTERRUPT_INVALID_PEER_DSTATE;
uint16_t _TRACE_IVSHMEM_FLAT_WRITE_MMR_DSTATE;
uint16_t _TRACE_IVSHMEM_FLAT_INTERRUPT_PEER_DSTATE;
uint16_t _TRACE_I2C_ECHO_EVENT_DSTATE;
uint16_t _TRACE_I2C_ECHO_RECV_DSTATE;
uint16_t _TRACE_I2C_ECHO_SEND_DSTATE;
uint16_t _TRACE_IOMMU_TESTDEV_MMIO_READ_DSTATE;
uint16_t _TRACE_IOMMU_TESTDEV_MMIO_WRITE_DSTATE;
uint16_t _TRACE_IOMMU_TESTDEV_DMA_START_DSTATE;
uint16_t _TRACE_IOMMU_TESTDEV_DMA_WRITE_DSTATE;
uint16_t _TRACE_IOMMU_TESTDEV_DMA_READ_DSTATE;
uint16_t _TRACE_IOMMU_TESTDEV_DMA_VERIFY_DSTATE;
uint16_t _TRACE_IOMMU_TESTDEV_DMA_RESULT_DSTATE;
uint16_t _TRACE_IOMMU_TESTDEV_DMA_ARMED_DSTATE;
...
TraceEvent _TRACE_ASPEED_SBC_IGNORE_CMD_EVENT = {
    .id = 0,
    .name = "aspeed_sbc_ignore_cmd",
    .sstate = TRACE_ASPEED_SBC_IGNORE_CMD_ENABLED,
    .dstate = &_TRACE_ASPEED_SBC_IGNORE_CMD_DSTATE
};
TraceEvent _TRACE_ASPEED_SBC_HANDLE_CMD_EVENT = {
    .id = 0,
    .name = "aspeed_sbc_handle_cmd",
    .sstate = TRACE_ASPEED_SBC_HANDLE_CMD_ENABLED,
    .dstate = &_TRACE_ASPEED_SBC_HANDLE_CMD_DSTATE
};
TraceEvent _TRACE_ASPEED_SBC_OTP_READ_EVENT = {
    .id = 0,
    .name = "aspeed_sbc_otp_read",
    .sstate = TRACE_ASPEED_SBC_OTP_READ_ENABLED,
    .dstate = &_TRACE_ASPEED_SBC_OTP_READ_DSTATE
};
TraceEvent _TRACE_ASPEED_SBC_OTP_PROG_EVENT = {
    .id = 0,
    .name = "aspeed_sbc_otp_prog",
    .sstate = TRACE_ASPEED_SBC_OTP_PROG_ENABLED,
    .dstate = &_TRACE_ASPEED_SBC_OTP_PROG_DSTATE
};
...
TraceEvent _TRACE_NPCM_CLK_READ_EVENT = {
    .id = 0,
    .name = "npcm_clk_read",
    .sstate = TRACE_NPCM_CLK_READ_ENABLED,
    .dstate = &_TRACE_NPCM_CLK_READ_DSTATE
};
TraceEvent _TRACE_NPCM_CLK_WRITE_EVENT = {
    .id = 0,
    .name = "npcm_clk_write",
    .sstate = TRACE_NPCM_CLK_WRITE_ENABLED,
    .dstate = &_TRACE_NPCM_CLK_WRITE_DSTATE
};
TraceEvent _TRACE_NPCM_GCR_READ_EVENT = {
    .id = 0,
    .name = "npcm_gcr_read",
    .sstate = TRACE_NPCM_GCR_READ_ENABLED,
    .dstate = &_TRACE_NPCM_GCR_READ_DSTATE
};
TraceEvent _TRACE_NPCM_GCR_WRITE_EVENT = {
    .id = 0,
    .name = "npcm_gcr_write",
    .sstate = TRACE_NPCM_GCR_WRITE_ENABLED,
    .dstate = &_TRACE_NPCM_GCR_WRITE_DSTATE
};
...
TraceEvent _TRACE_IMX6_SRC_READ_EVENT = {
    .id = 0,
    .name = "imx6_src_read",
    .sstate = TRACE_IMX6_SRC_READ_ENABLED,
    .dstate = &_TRACE_IMX6_SRC_READ_DSTATE
};
TraceEvent _TRACE_IMX6_SRC_WRITE_EVENT = {
    .id = 0,
    .name = "imx6_src_write",
    .sstate = TRACE_IMX6_SRC_WRITE_ENABLED,
    .dstate = &_TRACE_IMX6_SRC_WRITE_DSTATE
};
TraceEvent _TRACE_IMX6_CLEAR_RESET_BIT_EVENT = {
    .id = 0,
    .name = "imx6_clear_reset_bit",
    .sstate = TRACE_IMX6_CLEAR_RESET_BIT_ENABLED,
    .dstate = &_TRACE_IMX6_CLEAR_RESET_BIT_DSTATE
};
TraceEvent _TRACE_IMX6_SRC_RESET_EVENT = {
    .id = 0,
    .name = "imx6_src_reset",
    .sstate = TRACE_IMX6_SRC_RESET_ENABLED,
    .dstate = &_TRACE_IMX6_SRC_RESET_DSTATE
};
...
TraceEvent _TRACE_ASPEED_PWM_READ_EVENT = {
    .id = 0,
    .name = "aspeed_pwm_read",
    .sstate = TRACE_ASPEED_PWM_READ_ENABLED,
    .dstate = &_TRACE_ASPEED_PWM_READ_DSTATE
};
TraceEvent _TRACE_ASPEED_PWM_WRITE_EVENT = {
    .id = 0,
    .name = "aspeed_pwm_write",
    .sstate = TRACE_ASPEED_PWM_WRITE_ENABLED,
    .dstate = &_TRACE_ASPEED_PWM_WRITE_DSTATE
};
...
TraceEvent _TRACE_ASPEED_HACE_READ_EVENT = {
    .id = 0,
    .name = "aspeed_hace_read",
    .sstate = TRACE_ASPEED_HACE_READ_ENABLED,
    .dstate = &_TRACE_ASPEED_HACE_READ_DSTATE
};
TraceEvent _TRACE_ASPEED_HACE_WRITE_EVENT = {
    .id = 0,
    .name = "aspeed_hace_write",
    .sstate = TRACE_ASPEED_HACE_WRITE_ENABLED,
    .dstate = &_TRACE_ASPEED_HACE_WRITE_DSTATE
};
TraceEvent _TRACE_ASPEED_HACE_HASH_SG_EVENT = {
    .id = 0,
    .name = "aspeed_hace_hash_sg",
    .sstate = TRACE_ASPEED_HACE_HASH_SG_ENABLED,
    .dstate = &_TRACE_ASPEED_HACE_HASH_SG_DSTATE
};
TraceEvent _TRACE_ASPEED_HACE_HASH_ADDR_EVENT = {
    .id = 0,
    .name = "aspeed_hace_hash_addr",
    .sstate = TRACE_ASPEED_HACE_HASH_ADDR_ENABLED,
    .dstate = &_TRACE_ASPEED_HACE_HASH_ADDR_DSTATE
};
TraceEvent _TRACE_ASPEED_HACE_HASH_EXECUTE_ACC_MODE_EVENT = {
    .id = 0,
    .name = "aspeed_hace_hash_execute_acc_mode",
    .sstate = TRACE_ASPEED_HACE_HASH_EXECUTE_ACC_MODE_ENABLED,
    .dstate = &_TRACE_ASPEED_HACE_HASH_EXECUTE_ACC_MODE_DSTATE
};
TraceEvent _TRACE_ASPEED_HACE_HEXDUMP_EVENT = {
    .id = 0,
    .name = "aspeed_hace_hexdump",
    .sstate = TRACE_ASPEED_HACE_HEXDUMP_ENABLED,
    .dstate = &_TRACE_ASPEED_HACE_HEXDUMP_DSTATE
};
...
TraceEvent _TRACE_IVSHMEM_FLAT_IRQ_HANDLER_EVENT = {
    .id = 0,
    .name = "ivshmem_flat_irq_handler",
    .sstate = TRACE_IVSHMEM_FLAT_IRQ_HANDLER_ENABLED,
    .dstate = &_TRACE_IVSHMEM_FLAT_IRQ_HANDLER_DSTATE
};
TraceEvent _TRACE_IVSHMEM_FLAT_NEW_PEER_EVENT = {
    .id = 0,
    .name = "ivshmem_flat_new_peer",
    .sstate = TRACE_IVSHMEM_FLAT_NEW_PEER_ENABLED,
    .dstate = &_TRACE_IVSHMEM_FLAT_NEW_PEER_DSTATE
};
TraceEvent _TRACE_IVSHMEM_FLAT_ADD_VECTOR_FAILURE_EVENT = {
    .id = 0,
    .name = "ivshmem_flat_add_vector_failure",
    .sstate = TRACE_IVSHMEM_FLAT_ADD_VECTOR_FAILURE_ENABLED,
    .dstate = &_TRACE_IVSHMEM_FLAT_ADD_VECTOR_FAILURE_DSTATE
};
TraceEvent _TRACE_IVSHMEM_FLAT_ADD_VECTOR_SUCCESS_EVENT = {
    .id = 0,
    .name = "ivshmem_flat_add_vector_success",
    .sstate = TRACE_IVSHMEM_FLAT_ADD_VECTOR_SUCCESS_ENABLED,
    .dstate = &_TRACE_IVSHMEM_FLAT_ADD_VECTOR_SUCCESS_DSTATE
};
TraceEvent _TRACE_IVSHMEM_FLAT_IRQ_RESOLVED_EVENT = {
    .id = 0,
    .name = "ivshmem_flat_irq_resolved",
    .sstate = TRACE_IVSHMEM_FLAT_IRQ_RESOLVED_ENABLED,
    .dstate = &_TRACE_IVSHMEM_FLAT_IRQ_RESOLVED_DSTATE
};
TraceEvent _TRACE_IVSHMEM_FLAT_PROTO_VER_OWN_ID_EVENT = {
    .id = 0,
    .name = "ivshmem_flat_proto_ver_own_id",
    .sstate = TRACE_IVSHMEM_FLAT_PROTO_VER_OWN_ID_ENABLED,
    .dstate = &_TRACE_IVSHMEM_FLAT_PROTO_VER_OWN_ID_DSTATE
};
TraceEvent _TRACE_IVSHMEM_FLAT_SHMEM_SIZE_EVENT = {
    .id = 0,
    .name = "ivshmem_flat_shmem_size",
    .sstate = TRACE_IVSHMEM_FLAT_SHMEM_SIZE_ENABLED,
    .dstate = &_TRACE_IVSHMEM_FLAT_SHMEM_SIZE_DSTATE
};
TraceEvent _TRACE_IVSHMEM_FLAT_SHMEM_MAP_EVENT = {
    .id = 0,
    .name = "ivshmem_flat_shmem_map",
    .sstate = TRACE_IVSHMEM_FLAT_SHMEM_MAP_ENABLED,
    .dstate = &_TRACE_IVSHMEM_FLAT_SHMEM_MAP_DSTATE
};
TraceEvent _TRACE_IVSHMEM_FLAT_MMIO_MAP_EVENT = {
    .id = 0,
    .name = "ivshmem_flat_mmio_map",
    .sstate = TRACE_IVSHMEM_FLAT_MMIO_MAP_ENABLED,
    .dstate = &_TRACE_IVSHMEM_FLAT_MMIO_MAP_DSTATE
};
TraceEvent _TRACE_IVSHMEM_FLAT_READ_MMR_EVENT = {
    .id = 0,
    .name = "ivshmem_flat_read_mmr",
    .sstate = TRACE_IVSHMEM_FLAT_READ_MMR_ENABLED,
    .dstate = &_TRACE_IVSHMEM_FLAT_READ_MMR_DSTATE
};
TraceEvent _TRACE_IVSHMEM_FLAT_READ_MMR_DOORBELL_EVENT = {
    .id = 0,
    .name = "ivshmem_flat_read_mmr_doorbell",
    .sstate = TRACE_IVSHMEM_FLAT_READ_MMR_DOORBELL_ENABLED,
    .dstate = &_TRACE_IVSHMEM_FLAT_READ_MMR_DOORBELL_DSTATE
};
TraceEvent _TRACE_IVSHMEM_FLAT_READ_WRITE_MMR_INVALID_EVENT = {
    .id = 0,
    .name = "ivshmem_flat_read_write_mmr_invalid",
    .sstate = TRACE_IVSHMEM_FLAT_READ_WRITE_MMR_INVALID_ENABLED,
    .dstate = &_TRACE_IVSHMEM_FLAT_READ_WRITE_MMR_INVALID_DSTATE
};
TraceEvent _TRACE_IVSHMEM_FLAT_INTERRUPT_INVALID_PEER_EVENT = {
    .id = 0,
    .name = "ivshmem_flat_interrupt_invalid_peer",
    .sstate = TRACE_IVSHMEM_FLAT_INTERRUPT_INVALID_PEER_ENABLED,
    .dstate = &_TRACE_IVSHMEM_FLAT_INTERRUPT_INVALID_PEER_DSTATE
};
TraceEvent _TRACE_IVSHMEM_FLAT_WRITE_MMR_EVENT = {
    .id = 0,
    .name = "ivshmem_flat_write_mmr",
    .sstate = TRACE_IVSHMEM_FLAT_WRITE_MMR_ENABLED,
    .dstate = &_TRACE_IVSHMEM_FLAT_WRITE_MMR_DSTATE
};
TraceEvent _TRACE_IVSHMEM_FLAT_INTERRUPT_PEER_EVENT = {
    .id = 0,
    .name = "ivshmem_flat_interrupt_peer",
    .sstate = TRACE_IVSHMEM_FLAT_INTERRUPT_PEER_ENABLED,
    .dstate = &_TRACE_IVSHMEM_FLAT_INTERRUPT_PEER_DSTATE
};
TraceEvent _TRACE_I2C_ECHO_EVENT_EVENT = {
    .id = 0,
    .name = "i2c_echo_event",
    .sstate = TRACE_I2C_ECHO_EVENT_ENABLED,
    .dstate = &_TRACE_I2C_ECHO_EVENT_DSTATE
};
TraceEvent _TRACE_I2C_ECHO_RECV_EVENT = {
    .id = 0,
    .name = "i2c_echo_recv",
    .sstate = TRACE_I2C_ECHO_RECV_ENABLED,
    .dstate = &_TRACE_I2C_ECHO_RECV_DSTATE
};
TraceEvent _TRACE_I2C_ECHO_SEND_EVENT = {
    .id = 0,
    .name = "i2c_echo_send",
    .sstate = TRACE_I2C_ECHO_SEND_ENABLED,
    .dstate = &_TRACE_I2C_ECHO_SEND_DSTATE
};
TraceEvent _TRACE_IOMMU_TESTDEV_MMIO_READ_EVENT = {
    .id = 0,
    .name = "iommu_testdev_mmio_read",
    .sstate = TRACE_IOMMU_TESTDEV_MMIO_READ_ENABLED,
    .dstate = &_TRACE_IOMMU_TESTDEV_MMIO_READ_DSTATE
};
TraceEvent _TRACE_IOMMU_TESTDEV_MMIO_WRITE_EVENT = {
    .id = 0,
    .name = "iommu_testdev_mmio_write",
    .sstate = TRACE_IOMMU_TESTDEV_MMIO_WRITE_ENABLED,
    .dstate = &_TRACE_IOMMU_TESTDEV_MMIO_WRITE_DSTATE
};
TraceEvent _TRACE_IOMMU_TESTDEV_DMA_START_EVENT = {
    .id = 0,
    .name = "iommu_testdev_dma_start",
    .sstate = TRACE_IOMMU_TESTDEV_DMA_START_ENABLED,
    .dstate = &_TRACE_IOMMU_TESTDEV_DMA_START_DSTATE
};
TraceEvent _TRACE_IOMMU_TESTDEV_DMA_WRITE_EVENT = {
    .id = 0,
    .name = "iommu_testdev_dma_write",
    .sstate = TRACE_IOMMU_TESTDEV_DMA_WRITE_ENABLED,
    .dstate = &_TRACE_IOMMU_TESTDEV_DMA_WRITE_DSTATE
};
TraceEvent _TRACE_IOMMU_TESTDEV_DMA_READ_EVENT = {
    .id = 0,
    .name = "iommu_testdev_dma_read",
    .sstate = TRACE_IOMMU_TESTDEV_DMA_READ_ENABLED,
    .dstate = &_TRACE_IOMMU_TESTDEV_DMA_READ_DSTATE
};
TraceEvent _TRACE_IOMMU_TESTDEV_DMA_VERIFY_EVENT = {
    .id = 0,
    .name = "iommu_testdev_dma_verify",
    .sstate = TRACE_IOMMU_TESTDEV_DMA_VERIFY_ENABLED,
    .dstate = &_TRACE_IOMMU_TESTDEV_DMA_VERIFY_DSTATE
};
TraceEvent _TRACE_IOMMU_TESTDEV_DMA_RESULT_EVENT = {
    .id = 0,
    .name = "iommu_testdev_dma_result",
    .sstate = TRACE_IOMMU_TESTDEV_DMA_RESULT_ENABLED,
    .dstate = &_TRACE_IOMMU_TESTDEV_DMA_RESULT_DSTATE
};
TraceEvent _TRACE_IOMMU_TESTDEV_DMA_ARMED_EVENT = {
    .id = 0,
    .name = "iommu_testdev_dma_armed",
    .sstate = TRACE_IOMMU_TESTDEV_DMA_ARMED_ENABLED,
    .dstate = &_TRACE_IOMMU_TESTDEV_DMA_ARMED_DSTATE
};
TraceEvent *hw_misc_trace_events[] = {
    ...
    &_TRACE_ASPEED_SBC_IGNORE_CMD_EVENT,
    &_TRACE_ASPEED_SBC_HANDLE_CMD_EVENT,
    &_TRACE_ASPEED_SBC_OTP_READ_EVENT,
    &_TRACE_ASPEED_SBC_OTP_PROG_EVENT,
    ...
    &_TRACE_NPCM_CLK_READ_EVENT,
    &_TRACE_NPCM_CLK_WRITE_EVENT,
    &_TRACE_NPCM_GCR_READ_EVENT,
    &_TRACE_NPCM_GCR_WRITE_EVENT,
    ...
    &_TRACE_IMX6_SRC_READ_EVENT,
    &_TRACE_IMX6_SRC_WRITE_EVENT,
    &_TRACE_IMX6_CLEAR_RESET_BIT_EVENT,
    &_TRACE_IMX6_SRC_RESET_EVENT,
    ...
    &_TRACE_ASPEED_PWM_READ_EVENT,
    &_TRACE_ASPEED_PWM_WRITE_EVENT,
    ...
    &_TRACE_ASPEED_HACE_READ_EVENT,
    &_TRACE_ASPEED_HACE_WRITE_EVENT,
    &_TRACE_ASPEED_HACE_HASH_SG_EVENT,
    &_TRACE_ASPEED_HACE_HASH_ADDR_EVENT,
    &_TRACE_ASPEED_HACE_HASH_EXECUTE_ACC_MODE_EVENT,
    &_TRACE_ASPEED_HACE_HEXDUMP_EVENT,
    ...
    &_TRACE_IVSHMEM_FLAT_IRQ_HANDLER_EVENT,
    &_TRACE_IVSHMEM_FLAT_NEW_PEER_EVENT,
    &_TRACE_IVSHMEM_FLAT_ADD_VECTOR_FAILURE_EVENT,
    &_TRACE_IVSHMEM_FLAT_ADD_VECTOR_SUCCESS_EVENT,
    &_TRACE_IVSHMEM_FLAT_IRQ_RESOLVED_EVENT,
    &_TRACE_IVSHMEM_FLAT_PROTO_VER_OWN_ID_EVENT,
    &_TRACE_IVSHMEM_FLAT_SHMEM_SIZE_EVENT,
    &_TRACE_IVSHMEM_FLAT_SHMEM_MAP_EVENT,
    &_TRACE_IVSHMEM_FLAT_MMIO_MAP_EVENT,
    &_TRACE_IVSHMEM_FLAT_READ_MMR_EVENT,
    &_TRACE_IVSHMEM_FLAT_READ_MMR_DOORBELL_EVENT,
    &_TRACE_IVSHMEM_FLAT_READ_WRITE_MMR_INVALID_EVENT,
    &_TRACE_IVSHMEM_FLAT_INTERRUPT_INVALID_PEER_EVENT,
    &_TRACE_IVSHMEM_FLAT_WRITE_MMR_EVENT,
    &_TRACE_IVSHMEM_FLAT_INTERRUPT_PEER_EVENT,
    &_TRACE_I2C_ECHO_EVENT_EVENT,
    &_TRACE_I2C_ECHO_RECV_EVENT,
    &_TRACE_I2C_ECHO_SEND_EVENT,
    &_TRACE_IOMMU_TESTDEV_MMIO_READ_EVENT,
    &_TRACE_IOMMU_TESTDEV_MMIO_WRITE_EVENT,
    &_TRACE_IOMMU_TESTDEV_DMA_START_EVENT,
    &_TRACE_IOMMU_TESTDEV_DMA_WRITE_EVENT,
    &_TRACE_IOMMU_TESTDEV_DMA_READ_EVENT,
    &_TRACE_IOMMU_TESTDEV_DMA_VERIFY_EVENT,
    &_TRACE_IOMMU_TESTDEV_DMA_RESULT_EVENT,
    &_TRACE_IOMMU_TESTDEV_DMA_ARMED_EVENT,
  NULL,
};
