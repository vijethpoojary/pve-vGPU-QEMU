...
uint16_t _TRACE_KVMPIT_POST_VMFD_CHANGE_DSTATE;
...
TraceEvent _TRACE_KVMPIT_POST_VMFD_CHANGE_EVENT = {
    .id = 0,
    .name = "kvmpit_post_vmfd_change",
    .sstate = TRACE_KVMPIT_POST_VMFD_CHANGE_ENABLED,
    .dstate = &_TRACE_KVMPIT_POST_VMFD_CHANGE_DSTATE
};
TraceEvent *hw_i386_kvm_trace_events[] = {
    ...
    &_TRACE_KVMPIT_POST_VMFD_CHANGE_EVENT,
  NULL,
};
