...
uint16_t _TRACE_PIT_IOPORT_READ_DSTATE;
uint16_t _TRACE_PIT_IOPORT_WRITE_DSTATE;
...
TraceEvent _TRACE_PIT_IOPORT_READ_EVENT = {
    .id = 0,
    .name = "pit_ioport_read",
    .sstate = TRACE_PIT_IOPORT_READ_ENABLED,
    .dstate = &_TRACE_PIT_IOPORT_READ_DSTATE
};
TraceEvent _TRACE_PIT_IOPORT_WRITE_EVENT = {
    .id = 0,
    .name = "pit_ioport_write",
    .sstate = TRACE_PIT_IOPORT_WRITE_ENABLED,
    .dstate = &_TRACE_PIT_IOPORT_WRITE_DSTATE
};
...
TraceEvent *hw_timer_trace_events[] = {
    ...
    &_TRACE_PIT_IOPORT_READ_EVENT,
    &_TRACE_PIT_IOPORT_WRITE_EVENT,
