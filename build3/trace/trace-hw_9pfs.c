...
uint16_t _TRACE_XEN_9PFS_ALLOC_DSTATE;
uint16_t _TRACE_XEN_9PFS_CONNECT_DSTATE;
uint16_t _TRACE_XEN_9PFS_DISCONNECT_DSTATE;
uint16_t _TRACE_XEN_9PFS_FREE_DSTATE;
...
TraceEvent _TRACE_XEN_9PFS_ALLOC_EVENT = {
    .id = 0,
    .name = "xen_9pfs_alloc",
    .sstate = TRACE_XEN_9PFS_ALLOC_ENABLED,
    .dstate = &_TRACE_XEN_9PFS_ALLOC_DSTATE
};
TraceEvent _TRACE_XEN_9PFS_CONNECT_EVENT = {
    .id = 0,
    .name = "xen_9pfs_connect",
    .sstate = TRACE_XEN_9PFS_CONNECT_ENABLED,
    .dstate = &_TRACE_XEN_9PFS_CONNECT_DSTATE
};
TraceEvent _TRACE_XEN_9PFS_DISCONNECT_EVENT = {
    .id = 0,
    .name = "xen_9pfs_disconnect",
    .sstate = TRACE_XEN_9PFS_DISCONNECT_ENABLED,
    .dstate = &_TRACE_XEN_9PFS_DISCONNECT_DSTATE
};
TraceEvent _TRACE_XEN_9PFS_FREE_EVENT = {
    .id = 0,
    .name = "xen_9pfs_free",
    .sstate = TRACE_XEN_9PFS_FREE_ENABLED,
    .dstate = &_TRACE_XEN_9PFS_FREE_DSTATE
};
TraceEvent *hw_9pfs_trace_events[] = {
    ...
    &_TRACE_XEN_9PFS_ALLOC_EVENT,
    &_TRACE_XEN_9PFS_CONNECT_EVENT,
    &_TRACE_XEN_9PFS_DISCONNECT_EVENT,
    &_TRACE_XEN_9PFS_FREE_EVENT,
  NULL,
};
