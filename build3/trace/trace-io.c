...
uint16_t _TRACE_QIO_CHANNEL_TLS_BYE_COMPLETE_DSTATE;
...
uint16_t _TRACE_QIO_NET_LISTENER_WATCH_DSTATE;
uint16_t _TRACE_QIO_NET_LISTENER_UNWATCH_DSTATE;
uint16_t _TRACE_QIO_NET_LISTENER_CALLBACK_DSTATE;
...
TraceEvent _TRACE_QIO_CHANNEL_TLS_HANDSHAKE_CANCEL_EVENT = {
    .id = 0,
    .name = "qio_channel_tls_handshake_cancel",
    .sstate = TRACE_QIO_CHANNEL_TLS_HANDSHAKE_CANCEL_ENABLED,
    .dstate = &_TRACE_QIO_CHANNEL_TLS_HANDSHAKE_CANCEL_DSTATE
};
TraceEvent _TRACE_QIO_CHANNEL_TLS_BYE_START_EVENT = {
    .id = 0,
    .name = "qio_channel_tls_bye_start",
    .sstate = TRACE_QIO_CHANNEL_TLS_BYE_START_ENABLED,
    .dstate = &_TRACE_QIO_CHANNEL_TLS_BYE_START_DSTATE
};
TraceEvent _TRACE_QIO_CHANNEL_TLS_BYE_PENDING_EVENT = {
    .id = 0,
    .name = "qio_channel_tls_bye_pending",
    .sstate = TRACE_QIO_CHANNEL_TLS_BYE_PENDING_ENABLED,
    .dstate = &_TRACE_QIO_CHANNEL_TLS_BYE_PENDING_DSTATE
};
TraceEvent _TRACE_QIO_CHANNEL_TLS_BYE_FAIL_EVENT = {
    .id = 0,
    .name = "qio_channel_tls_bye_fail",
    .sstate = TRACE_QIO_CHANNEL_TLS_BYE_FAIL_ENABLED,
    .dstate = &_TRACE_QIO_CHANNEL_TLS_BYE_FAIL_DSTATE
};
TraceEvent _TRACE_QIO_CHANNEL_TLS_BYE_COMPLETE_EVENT = {
    .id = 0,
    .name = "qio_channel_tls_bye_complete",
    .sstate = TRACE_QIO_CHANNEL_TLS_BYE_COMPLETE_ENABLED,
    .dstate = &_TRACE_QIO_CHANNEL_TLS_BYE_COMPLETE_DSTATE
};
TraceEvent _TRACE_QIO_CHANNEL_TLS_BYE_CANCEL_EVENT = {
    .id = 0,
    .name = "qio_channel_tls_bye_cancel",
    .sstate = TRACE_QIO_CHANNEL_TLS_BYE_CANCEL_ENABLED,
    .dstate = &_TRACE_QIO_CHANNEL_TLS_BYE_CANCEL_DSTATE
};
...
TraceEvent _TRACE_QIO_NET_LISTENER_WATCH_EVENT = {
    .id = 0,
    .name = "qio_net_listener_watch",
    .sstate = TRACE_QIO_NET_LISTENER_WATCH_ENABLED,
    .dstate = &_TRACE_QIO_NET_LISTENER_WATCH_DSTATE
};
TraceEvent _TRACE_QIO_NET_LISTENER_UNWATCH_EVENT = {
    .id = 0,
    .name = "qio_net_listener_unwatch",
    .sstate = TRACE_QIO_NET_LISTENER_UNWATCH_ENABLED,
    .dstate = &_TRACE_QIO_NET_LISTENER_UNWATCH_DSTATE
};
TraceEvent _TRACE_QIO_NET_LISTENER_CALLBACK_EVENT = {
    .id = 0,
    .name = "qio_net_listener_callback",
    .sstate = TRACE_QIO_NET_LISTENER_CALLBACK_ENABLED,
    .dstate = &_TRACE_QIO_NET_LISTENER_CALLBACK_DSTATE
};
TraceEvent *io_trace_events[] = {
    ...
    &_TRACE_QIO_CHANNEL_TLS_HANDSHAKE_CANCEL_EVENT,
    &_TRACE_QIO_CHANNEL_TLS_BYE_START_EVENT,
    &_TRACE_QIO_CHANNEL_TLS_BYE_PENDING_EVENT,
    &_TRACE_QIO_CHANNEL_TLS_BYE_FAIL_EVENT,
    &_TRACE_QIO_CHANNEL_TLS_BYE_COMPLETE_EVENT,
    &_TRACE_QIO_CHANNEL_TLS_BYE_CANCEL_EVENT,
    ...
    &_TRACE_QIO_NET_LISTENER_WATCH_EVENT,
    &_TRACE_QIO_NET_LISTENER_UNWATCH_EVENT,
    &_TRACE_QIO_NET_LISTENER_CALLBACK_EVENT,
  NULL,
};
