...
uint16_t _TRACE_XS_NODE_READ_DSTATE;
...
TraceEvent _TRACE_XS_NODE_READ_EVENT = {
    .id = 0,
    .name = "xs_node_read",
    .sstate = TRACE_XS_NODE_READ_ENABLED,
    .dstate = &_TRACE_XS_NODE_READ_DSTATE
};
