...
uint16_t _TRACE_MPC_I2C_READ_DSTATE;
uint16_t _TRACE_MPC_I2C_WRITE_DSTATE;
...
uint16_t _TRACE_IMX_I2C_READ_DSTATE;
uint16_t _TRACE_IMX_I2C_WRITE_DSTATE;
...
TraceEvent _TRACE_MPC_I2C_READ_EVENT = {
    .id = 0,
    .name = "mpc_i2c_read",
    .sstate = TRACE_MPC_I2C_READ_ENABLED,
    .dstate = &_TRACE_MPC_I2C_READ_DSTATE
};
TraceEvent _TRACE_MPC_I2C_WRITE_EVENT = {
    .id = 0,
    .name = "mpc_i2c_write",
    .sstate = TRACE_MPC_I2C_WRITE_ENABLED,
    .dstate = &_TRACE_MPC_I2C_WRITE_DSTATE
};
...
TraceEvent _TRACE_IMX_I2C_READ_EVENT = {
    .id = 0,
    .name = "imx_i2c_read",
    .sstate = TRACE_IMX_I2C_READ_ENABLED,
    .dstate = &_TRACE_IMX_I2C_READ_DSTATE
};
TraceEvent _TRACE_IMX_I2C_WRITE_EVENT = {
    .id = 0,
    .name = "imx_i2c_write",
    .sstate = TRACE_IMX_I2C_WRITE_ENABLED,
    .dstate = &_TRACE_IMX_I2C_WRITE_DSTATE
};
TraceEvent *hw_i2c_trace_events[] = {
    ...
    &_TRACE_MPC_I2C_READ_EVENT,
    &_TRACE_MPC_I2C_WRITE_EVENT,
    ...
    &_TRACE_IMX_I2C_READ_EVENT,
    &_TRACE_IMX_I2C_WRITE_EVENT,
  NULL,
};
