...
uint16_t _TRACE_TPM_UTIL_SHOW_BUFFER_HEADER_DSTATE;
uint16_t _TRACE_TPM_UTIL_SHOW_BUFFER_CONTENT_DSTATE;
...
TraceEvent _TRACE_TPM_UTIL_SHOW_BUFFER_HEADER_EVENT = {
    .id = 0,
    .name = "tpm_util_show_buffer_header",
    .sstate = TRACE_TPM_UTIL_SHOW_BUFFER_HEADER_ENABLED,
    .dstate = &_TRACE_TPM_UTIL_SHOW_BUFFER_HEADER_DSTATE
};
TraceEvent _TRACE_TPM_UTIL_SHOW_BUFFER_CONTENT_EVENT = {
    .id = 0,
    .name = "tpm_util_show_buffer_content",
    .sstate = TRACE_TPM_UTIL_SHOW_BUFFER_CONTENT_ENABLED,
    .dstate = &_TRACE_TPM_UTIL_SHOW_BUFFER_CONTENT_DSTATE
};
...
TraceEvent *backends_tpm_trace_events[] = {
    ...
    &_TRACE_TPM_UTIL_SHOW_BUFFER_HEADER_EVENT,
    &_TRACE_TPM_UTIL_SHOW_BUFFER_CONTENT_EVENT,
