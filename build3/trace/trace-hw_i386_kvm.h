...
extern TraceEvent _TRACE_KVMPIT_POST_VMFD_CHANGE_EVENT;
...
extern uint16_t _TRACE_KVMPIT_POST_VMFD_CHANGE_DSTATE;
...
#define TRACE_KVMPIT_POST_VMFD_CHANGE_ENABLED 1
...
{
    if (trace_event_get_state(TRACE_KVM_XEN_UNMAP_PIRQ)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_KVM_XEN_GET_FREE_PIRQ)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 3 "../hw/i386/kvm/trace-events"
            qemu_log("kvm_xen_get_free_pirq " "pirq %d type %d" "\n", pirq, type);
#line 122 "trace/trace-hw_i386_kvm.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_KVM_XEN_BIND_PIRQ)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 4 "../hw/i386/kvm/trace-events"
            qemu_log("kvm_xen_bind_pirq " "pirq %d port %d" "\n", pirq, port);
#line 137 "trace/trace-hw_i386_kvm.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_KVM_XEN_UNMASK_PIRQ)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 5 "../hw/i386/kvm/trace-events"
            qemu_log("kvm_xen_unmask_pirq " "pirq %d dev %s vector %d" "\n", pirq, dev, vector);
#line 152 "trace/trace-hw_i386_kvm.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_XENSTORE_ERROR)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_XENSTORE_READ)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 7 "../hw/i386/kvm/trace-events"
            qemu_log("xenstore_read " "tx %u path %s" "\n", tx_id, path);
#line 182 "trace/trace-hw_i386_kvm.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_XENSTORE_WRITE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 8 "../hw/i386/kvm/trace-events"
            qemu_log("xenstore_write " "tx %u path %s" "\n", tx_id, path);
#line 197 "trace/trace-hw_i386_kvm.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_XENSTORE_MKDIR)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 9 "../hw/i386/kvm/trace-events"
            qemu_log("xenstore_mkdir " "tx %u path %s" "\n", tx_id, path);
#line 212 "trace/trace-hw_i386_kvm.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_XENSTORE_DIRECTORY)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_XENSTORE_DIRECTORY_PART)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 11 "../hw/i386/kvm/trace-events"
            qemu_log("xenstore_directory_part " "tx %u path %s offset %u" "\n", tx_id, path, offset);
#line 242 "trace/trace-hw_i386_kvm.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_XENSTORE_TRANSACTION_START)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 12 "../hw/i386/kvm/trace-events"
            qemu_log("xenstore_transaction_start " "new_tx %u" "\n", new_tx);
#line 257 "trace/trace-hw_i386_kvm.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_XENSTORE_TRANSACTION_END)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 13 "../hw/i386/kvm/trace-events"
            qemu_log("xenstore_transaction_end " "tx %u commit %d" "\n", tx_id, commit);
#line 272 "trace/trace-hw_i386_kvm.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_XENSTORE_RM)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_XENSTORE_GET_PERMS)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 15 "../hw/i386/kvm/trace-events"
            qemu_log("xenstore_get_perms " "tx %u path %s" "\n", tx_id, path);
#line 302 "trace/trace-hw_i386_kvm.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_XENSTORE_SET_PERMS)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 16 "../hw/i386/kvm/trace-events"
            qemu_log("xenstore_set_perms " "tx %u path %s" "\n", tx_id, path);
#line 317 "trace/trace-hw_i386_kvm.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_XENSTORE_WATCH)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 17 "../hw/i386/kvm/trace-events"
            qemu_log("xenstore_watch " "path %s token %s" "\n", path, token);
#line 332 "trace/trace-hw_i386_kvm.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_XENSTORE_UNWATCH)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_XENSTORE_RESET_WATCHES)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 19 "../hw/i386/kvm/trace-events"
            qemu_log("xenstore_reset_watches " "" "\n");
#line 362 "trace/trace-hw_i386_kvm.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_XENSTORE_WATCH_EVENT)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
{
    if (trace_event_get_state(TRACE_XEN_PRIMARY_CONSOLE_CREATE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 21 "../hw/i386/kvm/trace-events"
            qemu_log("xen_primary_console_create " "" "\n");
#line 392 "trace/trace-hw_i386_kvm.h"
        }
    }
}
...
{
    if (trace_event_get_state(TRACE_XEN_PRIMARY_CONSOLE_RESET)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
...
#define TRACE_KVMPIT_POST_VMFD_CHANGE_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_KVMPIT_POST_VMFD_CHANGE) || \
    false)

static inline void trace_kvmpit_post_vmfd_change(void)
{
    if (trace_event_get_state(TRACE_KVMPIT_POST_VMFD_CHANGE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 23 "../hw/i386/kvm/trace-events"
            qemu_log("kvmpit_post_vmfd_change " "" "\n");
#line 422 "trace/trace-hw_i386_kvm.h"
        }
    }
}
