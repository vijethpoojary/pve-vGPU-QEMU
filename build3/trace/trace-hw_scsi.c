...
uint16_t _TRACE_ESP_INVALID_CMD_DSTATE;
...
uint16_t _TRACE_NCR710_RESET_DSTATE;
uint16_t _TRACE_NCR710_REG_READ_DSTATE;
uint16_t _TRACE_NCR710_REG_WRITE_DSTATE;
uint16_t _TRACE_NCR710_SCRIPT_SCSI_INTERRUPT_DSTATE;
uint16_t _TRACE_NCR710_SCRIPT_DMA_INTERRUPT_DSTATE;
uint16_t _TRACE_NCR710_COMMAND_COMPLETE_DSTATE;
uint16_t _TRACE_NCR710_DISCONNECT_DSTATE;
uint16_t _TRACE_NCR710_BAD_SELECTION_DSTATE;
uint16_t _TRACE_NCR710_PARITY_SENSE_CHANGED_DSTATE;
uint16_t _TRACE_NCR710_DEVICE_REALIZE_DSTATE;
uint16_t _TRACE_LASI_NCR710_DEVICE_REALIZE_DSTATE;
uint16_t _TRACE_LASI_NCR710_DEVICE_RESET_DSTATE;
uint16_t _TRACE_LASI_NCR710_REG_READ_DSTATE;
uint16_t _TRACE_LASI_NCR710_REG_WRITE_DSTATE;
uint16_t _TRACE_LASI_NCR710_REG_READ_ID_DSTATE;
uint16_t _TRACE_LASI_NCR710_REG_READ_HVERSION_DSTATE;
uint16_t _TRACE_LASI_NCR710_REG_FORWARD_READ_DSTATE;
uint16_t _TRACE_LASI_NCR710_REG_FORWARD_WRITE_DSTATE;
uint16_t _TRACE_LASI_NCR710_COMMAND_COMPLETE_DSTATE;
uint16_t _TRACE_LASI_NCR710_TRANSFER_DATA_DSTATE;
uint16_t _TRACE_LASI_NCR710_REQUEST_CANCELLED_DSTATE;
uint16_t _TRACE_LASI_NCR710_TIMERS_INITIALIZED_DSTATE;
uint16_t _TRACE_LASI_NCR710_HANDLE_LEGACY_CMDLINE_DSTATE;
uint16_t _TRACE_LASI_NCR710_LEGACY_DRIVE_FOUND_DSTATE;
uint16_t _TRACE_LASI_NCR710_SCSI_DEVICE_CREATED_DSTATE;
...
uint16_t _TRACE_SCSI_GENERIC_PERSISTENT_RESERVE_OUT_REPLY_DSTATE;
uint16_t _TRACE_SCSI_GENERIC_PR_STATE_PREEMPT_DSTATE;
...
TraceEvent _TRACE_ESP_INVALID_CMD_EVENT = {
    .id = 0,
    .name = "esp_invalid_cmd",
    .sstate = TRACE_ESP_INVALID_CMD_ENABLED,
    .dstate = &_TRACE_ESP_INVALID_CMD_DSTATE
};
...
TraceEvent _TRACE_NCR710_RESET_EVENT = {
    .id = 0,
    .name = "ncr710_reset",
    .sstate = TRACE_NCR710_RESET_ENABLED,
    .dstate = &_TRACE_NCR710_RESET_DSTATE
};
TraceEvent _TRACE_NCR710_REG_READ_EVENT = {
    .id = 0,
    .name = "ncr710_reg_read",
    .sstate = TRACE_NCR710_REG_READ_ENABLED,
    .dstate = &_TRACE_NCR710_REG_READ_DSTATE
};
TraceEvent _TRACE_NCR710_REG_WRITE_EVENT = {
    .id = 0,
    .name = "ncr710_reg_write",
    .sstate = TRACE_NCR710_REG_WRITE_ENABLED,
    .dstate = &_TRACE_NCR710_REG_WRITE_DSTATE
};
TraceEvent _TRACE_NCR710_SCRIPT_SCSI_INTERRUPT_EVENT = {
    .id = 0,
    .name = "ncr710_script_scsi_interrupt",
    .sstate = TRACE_NCR710_SCRIPT_SCSI_INTERRUPT_ENABLED,
    .dstate = &_TRACE_NCR710_SCRIPT_SCSI_INTERRUPT_DSTATE
};
TraceEvent _TRACE_NCR710_SCRIPT_DMA_INTERRUPT_EVENT = {
    .id = 0,
    .name = "ncr710_script_dma_interrupt",
    .sstate = TRACE_NCR710_SCRIPT_DMA_INTERRUPT_ENABLED,
    .dstate = &_TRACE_NCR710_SCRIPT_DMA_INTERRUPT_DSTATE
};
TraceEvent _TRACE_NCR710_COMMAND_COMPLETE_EVENT = {
    .id = 0,
    .name = "ncr710_command_complete",
    .sstate = TRACE_NCR710_COMMAND_COMPLETE_ENABLED,
    .dstate = &_TRACE_NCR710_COMMAND_COMPLETE_DSTATE
};
TraceEvent _TRACE_NCR710_DISCONNECT_EVENT = {
    .id = 0,
    .name = "ncr710_disconnect",
    .sstate = TRACE_NCR710_DISCONNECT_ENABLED,
    .dstate = &_TRACE_NCR710_DISCONNECT_DSTATE
};
TraceEvent _TRACE_NCR710_BAD_SELECTION_EVENT = {
    .id = 0,
    .name = "ncr710_bad_selection",
    .sstate = TRACE_NCR710_BAD_SELECTION_ENABLED,
    .dstate = &_TRACE_NCR710_BAD_SELECTION_DSTATE
};
TraceEvent _TRACE_NCR710_PARITY_SENSE_CHANGED_EVENT = {
    .id = 0,
    .name = "ncr710_parity_sense_changed",
    .sstate = TRACE_NCR710_PARITY_SENSE_CHANGED_ENABLED,
    .dstate = &_TRACE_NCR710_PARITY_SENSE_CHANGED_DSTATE
};
TraceEvent _TRACE_NCR710_DEVICE_REALIZE_EVENT = {
    .id = 0,
    .name = "ncr710_device_realize",
    .sstate = TRACE_NCR710_DEVICE_REALIZE_ENABLED,
    .dstate = &_TRACE_NCR710_DEVICE_REALIZE_DSTATE
};
TraceEvent _TRACE_LASI_NCR710_DEVICE_REALIZE_EVENT = {
    .id = 0,
    .name = "lasi_ncr710_device_realize",
    .sstate = TRACE_LASI_NCR710_DEVICE_REALIZE_ENABLED,
    .dstate = &_TRACE_LASI_NCR710_DEVICE_REALIZE_DSTATE
};
TraceEvent _TRACE_LASI_NCR710_DEVICE_RESET_EVENT = {
    .id = 0,
    .name = "lasi_ncr710_device_reset",
    .sstate = TRACE_LASI_NCR710_DEVICE_RESET_ENABLED,
    .dstate = &_TRACE_LASI_NCR710_DEVICE_RESET_DSTATE
};
TraceEvent _TRACE_LASI_NCR710_REG_READ_EVENT = {
    .id = 0,
    .name = "lasi_ncr710_reg_read",
    .sstate = TRACE_LASI_NCR710_REG_READ_ENABLED,
    .dstate = &_TRACE_LASI_NCR710_REG_READ_DSTATE
};
TraceEvent _TRACE_LASI_NCR710_REG_WRITE_EVENT = {
    .id = 0,
    .name = "lasi_ncr710_reg_write",
    .sstate = TRACE_LASI_NCR710_REG_WRITE_ENABLED,
    .dstate = &_TRACE_LASI_NCR710_REG_WRITE_DSTATE
};
TraceEvent _TRACE_LASI_NCR710_REG_READ_ID_EVENT = {
    .id = 0,
    .name = "lasi_ncr710_reg_read_id",
    .sstate = TRACE_LASI_NCR710_REG_READ_ID_ENABLED,
    .dstate = &_TRACE_LASI_NCR710_REG_READ_ID_DSTATE
};
TraceEvent _TRACE_LASI_NCR710_REG_READ_HVERSION_EVENT = {
    .id = 0,
    .name = "lasi_ncr710_reg_read_hversion",
    .sstate = TRACE_LASI_NCR710_REG_READ_HVERSION_ENABLED,
    .dstate = &_TRACE_LASI_NCR710_REG_READ_HVERSION_DSTATE
};
TraceEvent _TRACE_LASI_NCR710_REG_FORWARD_READ_EVENT = {
    .id = 0,
    .name = "lasi_ncr710_reg_forward_read",
    .sstate = TRACE_LASI_NCR710_REG_FORWARD_READ_ENABLED,
    .dstate = &_TRACE_LASI_NCR710_REG_FORWARD_READ_DSTATE
};
TraceEvent _TRACE_LASI_NCR710_REG_FORWARD_WRITE_EVENT = {
    .id = 0,
    .name = "lasi_ncr710_reg_forward_write",
    .sstate = TRACE_LASI_NCR710_REG_FORWARD_WRITE_ENABLED,
    .dstate = &_TRACE_LASI_NCR710_REG_FORWARD_WRITE_DSTATE
};
TraceEvent _TRACE_LASI_NCR710_COMMAND_COMPLETE_EVENT = {
    .id = 0,
    .name = "lasi_ncr710_command_complete",
    .sstate = TRACE_LASI_NCR710_COMMAND_COMPLETE_ENABLED,
    .dstate = &_TRACE_LASI_NCR710_COMMAND_COMPLETE_DSTATE
};
TraceEvent _TRACE_LASI_NCR710_TRANSFER_DATA_EVENT = {
    .id = 0,
    .name = "lasi_ncr710_transfer_data",
    .sstate = TRACE_LASI_NCR710_TRANSFER_DATA_ENABLED,
    .dstate = &_TRACE_LASI_NCR710_TRANSFER_DATA_DSTATE
};
TraceEvent _TRACE_LASI_NCR710_REQUEST_CANCELLED_EVENT = {
    .id = 0,
    .name = "lasi_ncr710_request_cancelled",
    .sstate = TRACE_LASI_NCR710_REQUEST_CANCELLED_ENABLED,
    .dstate = &_TRACE_LASI_NCR710_REQUEST_CANCELLED_DSTATE
};
TraceEvent _TRACE_LASI_NCR710_TIMERS_INITIALIZED_EVENT = {
    .id = 0,
    .name = "lasi_ncr710_timers_initialized",
    .sstate = TRACE_LASI_NCR710_TIMERS_INITIALIZED_ENABLED,
    .dstate = &_TRACE_LASI_NCR710_TIMERS_INITIALIZED_DSTATE
};
TraceEvent _TRACE_LASI_NCR710_HANDLE_LEGACY_CMDLINE_EVENT = {
    .id = 0,
    .name = "lasi_ncr710_handle_legacy_cmdline",
    .sstate = TRACE_LASI_NCR710_HANDLE_LEGACY_CMDLINE_ENABLED,
    .dstate = &_TRACE_LASI_NCR710_HANDLE_LEGACY_CMDLINE_DSTATE
};
TraceEvent _TRACE_LASI_NCR710_LEGACY_DRIVE_FOUND_EVENT = {
    .id = 0,
    .name = "lasi_ncr710_legacy_drive_found",
    .sstate = TRACE_LASI_NCR710_LEGACY_DRIVE_FOUND_ENABLED,
    .dstate = &_TRACE_LASI_NCR710_LEGACY_DRIVE_FOUND_DSTATE
};
TraceEvent _TRACE_LASI_NCR710_SCSI_DEVICE_CREATED_EVENT = {
    .id = 0,
    .name = "lasi_ncr710_scsi_device_created",
    .sstate = TRACE_LASI_NCR710_SCSI_DEVICE_CREATED_ENABLED,
    .dstate = &_TRACE_LASI_NCR710_SCSI_DEVICE_CREATED_DSTATE
};
...
TraceEvent _TRACE_SCSI_GENERIC_PERSISTENT_RESERVE_OUT_REPLY_EVENT = {
    .id = 0,
    .name = "scsi_generic_persistent_reserve_out_reply",
    .sstate = TRACE_SCSI_GENERIC_PERSISTENT_RESERVE_OUT_REPLY_ENABLED,
    .dstate = &_TRACE_SCSI_GENERIC_PERSISTENT_RESERVE_OUT_REPLY_DSTATE
};
TraceEvent _TRACE_SCSI_GENERIC_PR_STATE_PREEMPT_EVENT = {
    .id = 0,
    .name = "scsi_generic_pr_state_preempt",
    .sstate = TRACE_SCSI_GENERIC_PR_STATE_PREEMPT_ENABLED,
    .dstate = &_TRACE_SCSI_GENERIC_PR_STATE_PREEMPT_DSTATE
};
TraceEvent *hw_scsi_trace_events[] = {
    ...
    &_TRACE_NCR710_RESET_EVENT,
    &_TRACE_NCR710_REG_READ_EVENT,
    &_TRACE_NCR710_REG_WRITE_EVENT,
    &_TRACE_NCR710_SCRIPT_SCSI_INTERRUPT_EVENT,
    &_TRACE_NCR710_SCRIPT_DMA_INTERRUPT_EVENT,
    &_TRACE_NCR710_COMMAND_COMPLETE_EVENT,
    &_TRACE_NCR710_DISCONNECT_EVENT,
    &_TRACE_NCR710_BAD_SELECTION_EVENT,
    &_TRACE_NCR710_PARITY_SENSE_CHANGED_EVENT,
    &_TRACE_NCR710_DEVICE_REALIZE_EVENT,
    &_TRACE_LASI_NCR710_DEVICE_REALIZE_EVENT,
    &_TRACE_LASI_NCR710_DEVICE_RESET_EVENT,
    &_TRACE_LASI_NCR710_REG_READ_EVENT,
    &_TRACE_LASI_NCR710_REG_WRITE_EVENT,
    &_TRACE_LASI_NCR710_REG_READ_ID_EVENT,
    &_TRACE_LASI_NCR710_REG_READ_HVERSION_EVENT,
    &_TRACE_LASI_NCR710_REG_FORWARD_READ_EVENT,
    &_TRACE_LASI_NCR710_REG_FORWARD_WRITE_EVENT,
    &_TRACE_LASI_NCR710_COMMAND_COMPLETE_EVENT,
    &_TRACE_LASI_NCR710_TRANSFER_DATA_EVENT,
    &_TRACE_LASI_NCR710_REQUEST_CANCELLED_EVENT,
    &_TRACE_LASI_NCR710_TIMERS_INITIALIZED_EVENT,
    &_TRACE_LASI_NCR710_HANDLE_LEGACY_CMDLINE_EVENT,
    &_TRACE_LASI_NCR710_LEGACY_DRIVE_FOUND_EVENT,
    &_TRACE_LASI_NCR710_SCSI_DEVICE_CREATED_EVENT,
    ...
    &_TRACE_SCSI_GENERIC_PERSISTENT_RESERVE_OUT_REPLY_EVENT,
    &_TRACE_SCSI_GENERIC_PR_STATE_PREEMPT_EVENT,
  NULL,
};
