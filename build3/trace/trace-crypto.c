...
uint16_t _TRACE_QCRYPTO_TLS_SESSION_CHECK_X509_DN_DSTATE;
uint16_t _TRACE_QCRYPTO_TLS_SESSION_PARAMETERS_DSTATE;
uint16_t _TRACE_QCRYPTO_TLS_SESSION_BUG1717_WORKAROUND_DSTATE;
...
TraceEvent _TRACE_QCRYPTO_TLS_SESSION_CHECK_X509_DN_EVENT = {
    .id = 0,
    .name = "qcrypto_tls_session_check_x509_dn",
    .sstate = TRACE_QCRYPTO_TLS_SESSION_CHECK_X509_DN_ENABLED,
    .dstate = &_TRACE_QCRYPTO_TLS_SESSION_CHECK_X509_DN_DSTATE
};
TraceEvent _TRACE_QCRYPTO_TLS_SESSION_PARAMETERS_EVENT = {
    .id = 0,
    .name = "qcrypto_tls_session_parameters",
    .sstate = TRACE_QCRYPTO_TLS_SESSION_PARAMETERS_ENABLED,
    .dstate = &_TRACE_QCRYPTO_TLS_SESSION_PARAMETERS_DSTATE
};
TraceEvent _TRACE_QCRYPTO_TLS_SESSION_BUG1717_WORKAROUND_EVENT = {
    .id = 0,
    .name = "qcrypto_tls_session_bug1717_workaround",
    .sstate = TRACE_QCRYPTO_TLS_SESSION_BUG1717_WORKAROUND_ENABLED,
    .dstate = &_TRACE_QCRYPTO_TLS_SESSION_BUG1717_WORKAROUND_DSTATE
};
...
TraceEvent *crypto_trace_events[] = {
    ...
    &_TRACE_QCRYPTO_TLS_SESSION_CHECK_X509_DN_EVENT,
    &_TRACE_QCRYPTO_TLS_SESSION_PARAMETERS_EVENT,
    &_TRACE_QCRYPTO_TLS_SESSION_BUG1717_WORKAROUND_EVENT,
