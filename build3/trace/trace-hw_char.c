...
uint16_t _TRACE_IMX_SERIAL_READ_DSTATE;
uint16_t _TRACE_IMX_SERIAL_WRITE_DSTATE;
uint16_t _TRACE_IMX_SERIAL_PUT_DATA_DSTATE;
...
uint16_t _TRACE_PL011_FIFO_RX_PUT_DSTATE;
uint16_t _TRACE_PL011_FIFO_RX_FULL_DSTATE;
uint16_t _TRACE_PL011_BAUDRATE_CHANGE_DSTATE;
uint16_t _TRACE_PL011_RECEIVE_DSTATE;
...
uint16_t _TRACE_STM32L4X5_USART_READ_DSTATE;
uint16_t _TRACE_STM32L4X5_USART_WRITE_DSTATE;
uint16_t _TRACE_STM32L4X5_USART_RX_DSTATE;
uint16_t _TRACE_STM32L4X5_USART_TX_DSTATE;
uint16_t _TRACE_STM32L4X5_USART_TX_PENDING_DSTATE;
uint16_t _TRACE_STM32L4X5_USART_IRQ_RAISED_DSTATE;
uint16_t _TRACE_STM32L4X5_USART_IRQ_LOWERED_DSTATE;
uint16_t _TRACE_STM32L4X5_USART_OVERRUN_DETECTED_DSTATE;
uint16_t _TRACE_STM32L4X5_USART_RECEIVER_NOT_ENABLED_DSTATE;
uint16_t _TRACE_STM32L4X5_USART_UPDATE_PARAMS_DSTATE;
uint16_t _TRACE_XEN_CONSOLE_CONNECT_DSTATE;
uint16_t _TRACE_XEN_CONSOLE_DISCONNECT_DSTATE;
uint16_t _TRACE_XEN_CONSOLE_UNREALIZE_DSTATE;
uint16_t _TRACE_XEN_CONSOLE_REALIZE_DSTATE;
uint16_t _TRACE_XEN_CONSOLE_DEVICE_CREATE_DSTATE;
uint16_t _TRACE_XEN_CONSOLE_DEVICE_DESTROY_DSTATE;
uint16_t _TRACE_STM32F2XX_USART_READ_DSTATE;
uint16_t _TRACE_STM32F2XX_USART_WRITE_DSTATE;
uint16_t _TRACE_STM32F2XX_USART_DROP_DSTATE;
uint16_t _TRACE_STM32F2XX_USART_RECEIVE_DSTATE;
uint16_t _TRACE_HTIF_UART_WRITE_TO_HOST_DSTATE;
uint16_t _TRACE_HTIF_UART_UNKNOWN_DEVICE_COMMAND_DSTATE;
...
TraceEvent _TRACE_IMX_SERIAL_READ_EVENT = {
    .id = 0,
    .name = "imx_serial_read",
    .sstate = TRACE_IMX_SERIAL_READ_ENABLED,
    .dstate = &_TRACE_IMX_SERIAL_READ_DSTATE
};
TraceEvent _TRACE_IMX_SERIAL_WRITE_EVENT = {
    .id = 0,
    .name = "imx_serial_write",
    .sstate = TRACE_IMX_SERIAL_WRITE_ENABLED,
    .dstate = &_TRACE_IMX_SERIAL_WRITE_DSTATE
};
TraceEvent _TRACE_IMX_SERIAL_PUT_DATA_EVENT = {
    .id = 0,
    .name = "imx_serial_put_data",
    .sstate = TRACE_IMX_SERIAL_PUT_DATA_ENABLED,
    .dstate = &_TRACE_IMX_SERIAL_PUT_DATA_DSTATE
};
...
TraceEvent _TRACE_PL011_FIFO_RX_PUT_EVENT = {
    .id = 0,
    .name = "pl011_fifo_rx_put",
    .sstate = TRACE_PL011_FIFO_RX_PUT_ENABLED,
    .dstate = &_TRACE_PL011_FIFO_RX_PUT_DSTATE
};
TraceEvent _TRACE_PL011_FIFO_RX_FULL_EVENT = {
    .id = 0,
    .name = "pl011_fifo_rx_full",
    .sstate = TRACE_PL011_FIFO_RX_FULL_ENABLED,
    .dstate = &_TRACE_PL011_FIFO_RX_FULL_DSTATE
};
...
TraceEvent _TRACE_PL011_RECEIVE_EVENT = {
    .id = 0,
    .name = "pl011_receive",
    .sstate = TRACE_PL011_RECEIVE_ENABLED,
    .dstate = &_TRACE_PL011_RECEIVE_DSTATE
};
...
TraceEvent _TRACE_STM32L4X5_USART_READ_EVENT = {
    .id = 0,
    .name = "stm32l4x5_usart_read",
    .sstate = TRACE_STM32L4X5_USART_READ_ENABLED,
    .dstate = &_TRACE_STM32L4X5_USART_READ_DSTATE
};
TraceEvent _TRACE_STM32L4X5_USART_WRITE_EVENT = {
    .id = 0,
    .name = "stm32l4x5_usart_write",
    .sstate = TRACE_STM32L4X5_USART_WRITE_ENABLED,
    .dstate = &_TRACE_STM32L4X5_USART_WRITE_DSTATE
};
TraceEvent _TRACE_STM32L4X5_USART_RX_EVENT = {
    .id = 0,
    .name = "stm32l4x5_usart_rx",
    .sstate = TRACE_STM32L4X5_USART_RX_ENABLED,
    .dstate = &_TRACE_STM32L4X5_USART_RX_DSTATE
};
TraceEvent _TRACE_STM32L4X5_USART_TX_EVENT = {
    .id = 0,
    .name = "stm32l4x5_usart_tx",
    .sstate = TRACE_STM32L4X5_USART_TX_ENABLED,
    .dstate = &_TRACE_STM32L4X5_USART_TX_DSTATE
};
TraceEvent _TRACE_STM32L4X5_USART_TX_PENDING_EVENT = {
    .id = 0,
    .name = "stm32l4x5_usart_tx_pending",
    .sstate = TRACE_STM32L4X5_USART_TX_PENDING_ENABLED,
    .dstate = &_TRACE_STM32L4X5_USART_TX_PENDING_DSTATE
};
TraceEvent _TRACE_STM32L4X5_USART_IRQ_RAISED_EVENT = {
    .id = 0,
    .name = "stm32l4x5_usart_irq_raised",
    .sstate = TRACE_STM32L4X5_USART_IRQ_RAISED_ENABLED,
    .dstate = &_TRACE_STM32L4X5_USART_IRQ_RAISED_DSTATE
};
TraceEvent _TRACE_STM32L4X5_USART_IRQ_LOWERED_EVENT = {
    .id = 0,
    .name = "stm32l4x5_usart_irq_lowered",
    .sstate = TRACE_STM32L4X5_USART_IRQ_LOWERED_ENABLED,
    .dstate = &_TRACE_STM32L4X5_USART_IRQ_LOWERED_DSTATE
};
TraceEvent _TRACE_STM32L4X5_USART_OVERRUN_DETECTED_EVENT = {
    .id = 0,
    .name = "stm32l4x5_usart_overrun_detected",
    .sstate = TRACE_STM32L4X5_USART_OVERRUN_DETECTED_ENABLED,
    .dstate = &_TRACE_STM32L4X5_USART_OVERRUN_DETECTED_DSTATE
};
TraceEvent _TRACE_STM32L4X5_USART_RECEIVER_NOT_ENABLED_EVENT = {
    .id = 0,
    .name = "stm32l4x5_usart_receiver_not_enabled",
    .sstate = TRACE_STM32L4X5_USART_RECEIVER_NOT_ENABLED_ENABLED,
    .dstate = &_TRACE_STM32L4X5_USART_RECEIVER_NOT_ENABLED_DSTATE
};
TraceEvent _TRACE_STM32L4X5_USART_UPDATE_PARAMS_EVENT = {
    .id = 0,
    .name = "stm32l4x5_usart_update_params",
    .sstate = TRACE_STM32L4X5_USART_UPDATE_PARAMS_ENABLED,
    .dstate = &_TRACE_STM32L4X5_USART_UPDATE_PARAMS_DSTATE
};
TraceEvent _TRACE_XEN_CONSOLE_CONNECT_EVENT = {
    .id = 0,
    .name = "xen_console_connect",
    .sstate = TRACE_XEN_CONSOLE_CONNECT_ENABLED,
    .dstate = &_TRACE_XEN_CONSOLE_CONNECT_DSTATE
};
TraceEvent _TRACE_XEN_CONSOLE_DISCONNECT_EVENT = {
    .id = 0,
    .name = "xen_console_disconnect",
    .sstate = TRACE_XEN_CONSOLE_DISCONNECT_ENABLED,
    .dstate = &_TRACE_XEN_CONSOLE_DISCONNECT_DSTATE
};
TraceEvent _TRACE_XEN_CONSOLE_UNREALIZE_EVENT = {
    .id = 0,
    .name = "xen_console_unrealize",
    .sstate = TRACE_XEN_CONSOLE_UNREALIZE_ENABLED,
    .dstate = &_TRACE_XEN_CONSOLE_UNREALIZE_DSTATE
};
TraceEvent _TRACE_XEN_CONSOLE_REALIZE_EVENT = {
    .id = 0,
    .name = "xen_console_realize",
    .sstate = TRACE_XEN_CONSOLE_REALIZE_ENABLED,
    .dstate = &_TRACE_XEN_CONSOLE_REALIZE_DSTATE
};
TraceEvent _TRACE_XEN_CONSOLE_DEVICE_CREATE_EVENT = {
    .id = 0,
    .name = "xen_console_device_create",
    .sstate = TRACE_XEN_CONSOLE_DEVICE_CREATE_ENABLED,
    .dstate = &_TRACE_XEN_CONSOLE_DEVICE_CREATE_DSTATE
};
TraceEvent _TRACE_XEN_CONSOLE_DEVICE_DESTROY_EVENT = {
    .id = 0,
    .name = "xen_console_device_destroy",
    .sstate = TRACE_XEN_CONSOLE_DEVICE_DESTROY_ENABLED,
    .dstate = &_TRACE_XEN_CONSOLE_DEVICE_DESTROY_DSTATE
};
TraceEvent _TRACE_STM32F2XX_USART_READ_EVENT = {
    .id = 0,
    .name = "stm32f2xx_usart_read",
    .sstate = TRACE_STM32F2XX_USART_READ_ENABLED,
    .dstate = &_TRACE_STM32F2XX_USART_READ_DSTATE
};
TraceEvent _TRACE_STM32F2XX_USART_WRITE_EVENT = {
    .id = 0,
    .name = "stm32f2xx_usart_write",
    .sstate = TRACE_STM32F2XX_USART_WRITE_ENABLED,
    .dstate = &_TRACE_STM32F2XX_USART_WRITE_DSTATE
};
TraceEvent _TRACE_STM32F2XX_USART_DROP_EVENT = {
    .id = 0,
    .name = "stm32f2xx_usart_drop",
    .sstate = TRACE_STM32F2XX_USART_DROP_ENABLED,
    .dstate = &_TRACE_STM32F2XX_USART_DROP_DSTATE
};
TraceEvent _TRACE_STM32F2XX_USART_RECEIVE_EVENT = {
    .id = 0,
    .name = "stm32f2xx_usart_receive",
    .sstate = TRACE_STM32F2XX_USART_RECEIVE_ENABLED,
    .dstate = &_TRACE_STM32F2XX_USART_RECEIVE_DSTATE
};
TraceEvent _TRACE_HTIF_UART_WRITE_TO_HOST_EVENT = {
    .id = 0,
    .name = "htif_uart_write_to_host",
    .sstate = TRACE_HTIF_UART_WRITE_TO_HOST_ENABLED,
    .dstate = &_TRACE_HTIF_UART_WRITE_TO_HOST_DSTATE
};
TraceEvent _TRACE_HTIF_UART_UNKNOWN_DEVICE_COMMAND_EVENT = {
    .id = 0,
    .name = "htif_uart_unknown_device_command",
    .sstate = TRACE_HTIF_UART_UNKNOWN_DEVICE_COMMAND_ENABLED,
    .dstate = &_TRACE_HTIF_UART_UNKNOWN_DEVICE_COMMAND_DSTATE
};
TraceEvent *hw_char_trace_events[] = {
    ...
    &_TRACE_IMX_SERIAL_READ_EVENT,
    &_TRACE_IMX_SERIAL_WRITE_EVENT,
    &_TRACE_IMX_SERIAL_PUT_DATA_EVENT,
    ...
    &_TRACE_PL011_FIFO_RX_PUT_EVENT,
    &_TRACE_PL011_FIFO_RX_FULL_EVENT,
    &_TRACE_PL011_BAUDRATE_CHANGE_EVENT,
    &_TRACE_PL011_RECEIVE_EVENT,
    ...
    &_TRACE_STM32L4X5_USART_READ_EVENT,
    &_TRACE_STM32L4X5_USART_WRITE_EVENT,
    &_TRACE_STM32L4X5_USART_RX_EVENT,
    &_TRACE_STM32L4X5_USART_TX_EVENT,
    &_TRACE_STM32L4X5_USART_TX_PENDING_EVENT,
    &_TRACE_STM32L4X5_USART_IRQ_RAISED_EVENT,
    &_TRACE_STM32L4X5_USART_IRQ_LOWERED_EVENT,
    &_TRACE_STM32L4X5_USART_OVERRUN_DETECTED_EVENT,
    &_TRACE_STM32L4X5_USART_RECEIVER_NOT_ENABLED_EVENT,
    &_TRACE_STM32L4X5_USART_UPDATE_PARAMS_EVENT,
    &_TRACE_XEN_CONSOLE_CONNECT_EVENT,
    &_TRACE_XEN_CONSOLE_DISCONNECT_EVENT,
    &_TRACE_XEN_CONSOLE_UNREALIZE_EVENT,
    &_TRACE_XEN_CONSOLE_REALIZE_EVENT,
    &_TRACE_XEN_CONSOLE_DEVICE_CREATE_EVENT,
    &_TRACE_XEN_CONSOLE_DEVICE_DESTROY_EVENT,
    &_TRACE_STM32F2XX_USART_READ_EVENT,
    &_TRACE_STM32F2XX_USART_WRITE_EVENT,
    &_TRACE_STM32F2XX_USART_DROP_EVENT,
    &_TRACE_STM32F2XX_USART_RECEIVE_EVENT,
    &_TRACE_HTIF_UART_WRITE_TO_HOST_EVENT,
    &_TRACE_HTIF_UART_UNKNOWN_DEVICE_COMMAND_EVENT,
  NULL,
};
