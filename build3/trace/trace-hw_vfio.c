...
uint16_t _TRACE_VFIO_PCI_INTX_EOI_DSTATE;
...
uint16_t _TRACE_VFIO_PCI_POPULATE_DEVICE_CONFIG_DSTATE;
uint16_t _TRACE_VFIO_PCI_POPULATE_DEVICE_GET_IRQ_INFO_FAILURE_DSTATE;
uint16_t _TRACE_VFIO_MDEV_DSTATE;
uint16_t _TRACE_VFIO_PCI_SYNTHESIZE_PASID_CAP_DSTATE;
...
uint16_t _TRACE_VFIO_PCI_EMULATED_CLASS_CODE_DSTATE;
...
uint16_t _TRACE_VFIO_IOMMU_MAP_DIRTY_NOTIFY_SKIP_RO_DSTATE;
uint16_t _TRACE_VFIO_CONTAINER_QUERY_DIRTY_BITMAP_DSTATE;
uint16_t _TRACE_VFIO_CONTAINER_DISCONNECT_DSTATE;
uint16_t _TRACE_VFIO_GROUP_PUT_DSTATE;
uint16_t _TRACE_VFIO_DEVICE_GET_DSTATE;
uint16_t _TRACE_VFIO_DEVICE_PUT_DSTATE;
uint16_t _TRACE_VFIO_REGION_WRITE_DSTATE;
uint16_t _TRACE_VFIO_REGION_READ_DSTATE;
uint16_t _TRACE_VFIO_REGION_SETUP_DSTATE;
uint16_t _TRACE_VFIO_REGION_DMABUF_DSTATE;
...
uint16_t _TRACE_VFIO_LOAD_BUFS_THREAD_START_DSTATE;
uint16_t _TRACE_VFIO_LOAD_BUFS_THREAD_END_DSTATE;
uint16_t _TRACE_VFIO_LOAD_CLEANUP_DSTATE;
uint16_t _TRACE_VFIO_LOAD_DEVICE_CONFIG_STATE_START_DSTATE;
uint16_t _TRACE_VFIO_LOAD_DEVICE_CONFIG_STATE_END_DSTATE;
uint16_t _TRACE_VFIO_LOAD_STATE_DSTATE;
uint16_t _TRACE_VFIO_LOAD_STATE_DEVICE_DATA_DSTATE;
uint16_t _TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_INCOMING_DSTATE;
uint16_t _TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_START_DSTATE;
uint16_t _TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_STARVED_DSTATE;
uint16_t _TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_LOAD_START_DSTATE;
uint16_t _TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_LOAD_END_DSTATE;
uint16_t _TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_END_DSTATE;
...
uint16_t _TRACE_VFIO_SAVE_COMPLETE_PRECOPY_THREAD_START_DSTATE;
uint16_t _TRACE_VFIO_SAVE_COMPLETE_PRECOPY_THREAD_END_DSTATE;
...
uint16_t _TRACE_VFIO_CPR_FIND_DEVICE_DSTATE;
uint16_t _TRACE_VFIO_DEVICE_GET_REGION_INFO_TYPE_DSTATE;
uint16_t _TRACE_VFIO_DEVICE_RESET_HANDLER_DSTATE;
uint16_t _TRACE_VFIO_DEVICE_ATTACH_DSTATE;
uint16_t _TRACE_VFIO_DEVICE_DETACH_DSTATE;
...
TraceEvent _TRACE_VFIO_PCI_INTX_EOI_EVENT = {
    .id = 0,
    .name = "vfio_pci_intx_eoi",
    .sstate = TRACE_VFIO_PCI_INTX_EOI_ENABLED,
    .dstate = &_TRACE_VFIO_PCI_INTX_EOI_DSTATE
};
...
TraceEvent _TRACE_VFIO_PCI_POPULATE_DEVICE_CONFIG_EVENT = {
    .id = 0,
    .name = "vfio_pci_populate_device_config",
    .sstate = TRACE_VFIO_PCI_POPULATE_DEVICE_CONFIG_ENABLED,
    .dstate = &_TRACE_VFIO_PCI_POPULATE_DEVICE_CONFIG_DSTATE
};
TraceEvent _TRACE_VFIO_PCI_POPULATE_DEVICE_GET_IRQ_INFO_FAILURE_EVENT = {
    .id = 0,
    .name = "vfio_pci_populate_device_get_irq_info_failure",
    .sstate = TRACE_VFIO_PCI_POPULATE_DEVICE_GET_IRQ_INFO_FAILURE_ENABLED,
    .dstate = &_TRACE_VFIO_PCI_POPULATE_DEVICE_GET_IRQ_INFO_FAILURE_DSTATE
};
...
TraceEvent _TRACE_VFIO_PCI_SYNTHESIZE_PASID_CAP_EVENT = {
    .id = 0,
    .name = "vfio_pci_synthesize_pasid_cap",
    .sstate = TRACE_VFIO_PCI_SYNTHESIZE_PASID_CAP_ENABLED,
    .dstate = &_TRACE_VFIO_PCI_SYNTHESIZE_PASID_CAP_DSTATE
};
...
TraceEvent _TRACE_VFIO_PCI_EMULATED_CLASS_CODE_EVENT = {
    .id = 0,
    .name = "vfio_pci_emulated_class_code",
    .sstate = TRACE_VFIO_PCI_EMULATED_CLASS_CODE_ENABLED,
    .dstate = &_TRACE_VFIO_PCI_EMULATED_CLASS_CODE_DSTATE
};
...
TraceEvent _TRACE_VFIO_IOMMU_MAP_DIRTY_NOTIFY_SKIP_RO_EVENT = {
    .id = 0,
    .name = "vfio_iommu_map_dirty_notify_skip_ro",
    .sstate = TRACE_VFIO_IOMMU_MAP_DIRTY_NOTIFY_SKIP_RO_ENABLED,
    .dstate = &_TRACE_VFIO_IOMMU_MAP_DIRTY_NOTIFY_SKIP_RO_DSTATE
};
TraceEvent _TRACE_VFIO_CONTAINER_QUERY_DIRTY_BITMAP_EVENT = {
    .id = 0,
    .name = "vfio_container_query_dirty_bitmap",
    .sstate = TRACE_VFIO_CONTAINER_QUERY_DIRTY_BITMAP_ENABLED,
    .dstate = &_TRACE_VFIO_CONTAINER_QUERY_DIRTY_BITMAP_DSTATE
};
TraceEvent _TRACE_VFIO_CONTAINER_DISCONNECT_EVENT = {
    .id = 0,
    .name = "vfio_container_disconnect",
    .sstate = TRACE_VFIO_CONTAINER_DISCONNECT_ENABLED,
    .dstate = &_TRACE_VFIO_CONTAINER_DISCONNECT_DSTATE
};
TraceEvent _TRACE_VFIO_GROUP_PUT_EVENT = {
    .id = 0,
    .name = "vfio_group_put",
    .sstate = TRACE_VFIO_GROUP_PUT_ENABLED,
    .dstate = &_TRACE_VFIO_GROUP_PUT_DSTATE
};
TraceEvent _TRACE_VFIO_DEVICE_GET_EVENT = {
    .id = 0,
    .name = "vfio_device_get",
    .sstate = TRACE_VFIO_DEVICE_GET_ENABLED,
    .dstate = &_TRACE_VFIO_DEVICE_GET_DSTATE
};
TraceEvent _TRACE_VFIO_DEVICE_PUT_EVENT = {
    .id = 0,
    .name = "vfio_device_put",
    .sstate = TRACE_VFIO_DEVICE_PUT_ENABLED,
    .dstate = &_TRACE_VFIO_DEVICE_PUT_DSTATE
};
...
TraceEvent _TRACE_VFIO_REGION_DMABUF_EVENT = {
    .id = 0,
    .name = "vfio_region_dmabuf",
    .sstate = TRACE_VFIO_REGION_DMABUF_ENABLED,
    .dstate = &_TRACE_VFIO_REGION_DMABUF_DSTATE
};
...
TraceEvent _TRACE_VFIO_LOAD_BUFS_THREAD_START_EVENT = {
    .id = 0,
    .name = "vfio_load_bufs_thread_start",
    .sstate = TRACE_VFIO_LOAD_BUFS_THREAD_START_ENABLED,
    .dstate = &_TRACE_VFIO_LOAD_BUFS_THREAD_START_DSTATE
};
TraceEvent _TRACE_VFIO_LOAD_BUFS_THREAD_END_EVENT = {
    .id = 0,
    .name = "vfio_load_bufs_thread_end",
    .sstate = TRACE_VFIO_LOAD_BUFS_THREAD_END_ENABLED,
    .dstate = &_TRACE_VFIO_LOAD_BUFS_THREAD_END_DSTATE
};
...
TraceEvent _TRACE_VFIO_LOAD_DEVICE_CONFIG_STATE_START_EVENT = {
    .id = 0,
    .name = "vfio_load_device_config_state_start",
    .sstate = TRACE_VFIO_LOAD_DEVICE_CONFIG_STATE_START_ENABLED,
    .dstate = &_TRACE_VFIO_LOAD_DEVICE_CONFIG_STATE_START_DSTATE
};
TraceEvent _TRACE_VFIO_LOAD_DEVICE_CONFIG_STATE_END_EVENT = {
    .id = 0,
    .name = "vfio_load_device_config_state_end",
    .sstate = TRACE_VFIO_LOAD_DEVICE_CONFIG_STATE_END_ENABLED,
    .dstate = &_TRACE_VFIO_LOAD_DEVICE_CONFIG_STATE_END_DSTATE
};
...
TraceEvent _TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_INCOMING_EVENT = {
    .id = 0,
    .name = "vfio_load_state_device_buffer_incoming",
    .sstate = TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_INCOMING_ENABLED,
    .dstate = &_TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_INCOMING_DSTATE
};
TraceEvent _TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_START_EVENT = {
    .id = 0,
    .name = "vfio_load_state_device_buffer_start",
    .sstate = TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_START_ENABLED,
    .dstate = &_TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_START_DSTATE
};
TraceEvent _TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_STARVED_EVENT = {
    .id = 0,
    .name = "vfio_load_state_device_buffer_starved",
    .sstate = TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_STARVED_ENABLED,
    .dstate = &_TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_STARVED_DSTATE
};
TraceEvent _TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_LOAD_START_EVENT = {
    .id = 0,
    .name = "vfio_load_state_device_buffer_load_start",
    .sstate = TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_LOAD_START_ENABLED,
    .dstate = &_TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_LOAD_START_DSTATE
};
TraceEvent _TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_LOAD_END_EVENT = {
    .id = 0,
    .name = "vfio_load_state_device_buffer_load_end",
    .sstate = TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_LOAD_END_ENABLED,
    .dstate = &_TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_LOAD_END_DSTATE
};
TraceEvent _TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_END_EVENT = {
    .id = 0,
    .name = "vfio_load_state_device_buffer_end",
    .sstate = TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_END_ENABLED,
    .dstate = &_TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_END_DSTATE
};
...
TraceEvent _TRACE_VFIO_SAVE_COMPLETE_PRECOPY_THREAD_START_EVENT = {
    .id = 0,
    .name = "vfio_save_complete_precopy_thread_start",
    .sstate = TRACE_VFIO_SAVE_COMPLETE_PRECOPY_THREAD_START_ENABLED,
    .dstate = &_TRACE_VFIO_SAVE_COMPLETE_PRECOPY_THREAD_START_DSTATE
};
TraceEvent _TRACE_VFIO_SAVE_COMPLETE_PRECOPY_THREAD_END_EVENT = {
    .id = 0,
    .name = "vfio_save_complete_precopy_thread_end",
    .sstate = TRACE_VFIO_SAVE_COMPLETE_PRECOPY_THREAD_END_ENABLED,
    .dstate = &_TRACE_VFIO_SAVE_COMPLETE_PRECOPY_THREAD_END_DSTATE
};
...
TraceEvent _TRACE_VFIO_CPR_FIND_DEVICE_EVENT = {
    .id = 0,
    .name = "vfio_cpr_find_device",
    .sstate = TRACE_VFIO_CPR_FIND_DEVICE_ENABLED,
    .dstate = &_TRACE_VFIO_CPR_FIND_DEVICE_DSTATE
};
TraceEvent _TRACE_VFIO_DEVICE_GET_REGION_INFO_TYPE_EVENT = {
    .id = 0,
    .name = "vfio_device_get_region_info_type",
    .sstate = TRACE_VFIO_DEVICE_GET_REGION_INFO_TYPE_ENABLED,
    .dstate = &_TRACE_VFIO_DEVICE_GET_REGION_INFO_TYPE_DSTATE
};
TraceEvent _TRACE_VFIO_DEVICE_RESET_HANDLER_EVENT = {
    .id = 0,
    .name = "vfio_device_reset_handler",
    .sstate = TRACE_VFIO_DEVICE_RESET_HANDLER_ENABLED,
    .dstate = &_TRACE_VFIO_DEVICE_RESET_HANDLER_DSTATE
};
TraceEvent _TRACE_VFIO_DEVICE_ATTACH_EVENT = {
    .id = 0,
    .name = "vfio_device_attach",
    .sstate = TRACE_VFIO_DEVICE_ATTACH_ENABLED,
    .dstate = &_TRACE_VFIO_DEVICE_ATTACH_DSTATE
};
TraceEvent _TRACE_VFIO_DEVICE_DETACH_EVENT = {
    .id = 0,
    .name = "vfio_device_detach",
    .sstate = TRACE_VFIO_DEVICE_DETACH_ENABLED,
    .dstate = &_TRACE_VFIO_DEVICE_DETACH_DSTATE
};
TraceEvent *hw_vfio_trace_events[] = {
    &_TRACE_VFIO_INTX_INTERRUPT_EVENT,
    &_TRACE_VFIO_PCI_INTX_EOI_EVENT,
    ...
    &_TRACE_VFIO_PCI_POPULATE_DEVICE_CONFIG_EVENT,
    &_TRACE_VFIO_PCI_POPULATE_DEVICE_GET_IRQ_INFO_FAILURE_EVENT,
    &_TRACE_VFIO_MDEV_EVENT,
    &_TRACE_VFIO_PCI_SYNTHESIZE_PASID_CAP_EVENT,
    ...
    &_TRACE_VFIO_PCI_EMULATED_CLASS_CODE_EVENT,
    ...
    &_TRACE_VFIO_IOMMU_MAP_DIRTY_NOTIFY_SKIP_RO_EVENT,
    &_TRACE_VFIO_CONTAINER_QUERY_DIRTY_BITMAP_EVENT,
    &_TRACE_VFIO_CONTAINER_DISCONNECT_EVENT,
    &_TRACE_VFIO_GROUP_PUT_EVENT,
    &_TRACE_VFIO_DEVICE_GET_EVENT,
    &_TRACE_VFIO_DEVICE_PUT_EVENT,
    &_TRACE_VFIO_REGION_WRITE_EVENT,
    &_TRACE_VFIO_REGION_READ_EVENT,
    &_TRACE_VFIO_REGION_SETUP_EVENT,
    &_TRACE_VFIO_REGION_DMABUF_EVENT,
    ...
    &_TRACE_VFIO_LOAD_BUFS_THREAD_START_EVENT,
    &_TRACE_VFIO_LOAD_BUFS_THREAD_END_EVENT,
    &_TRACE_VFIO_LOAD_CLEANUP_EVENT,
    &_TRACE_VFIO_LOAD_DEVICE_CONFIG_STATE_START_EVENT,
    &_TRACE_VFIO_LOAD_DEVICE_CONFIG_STATE_END_EVENT,
    &_TRACE_VFIO_LOAD_STATE_EVENT,
    &_TRACE_VFIO_LOAD_STATE_DEVICE_DATA_EVENT,
    &_TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_INCOMING_EVENT,
    &_TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_START_EVENT,
    &_TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_STARVED_EVENT,
    &_TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_LOAD_START_EVENT,
    &_TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_LOAD_END_EVENT,
    &_TRACE_VFIO_LOAD_STATE_DEVICE_BUFFER_END_EVENT,
    ...
    &_TRACE_VFIO_SAVE_COMPLETE_PRECOPY_THREAD_START_EVENT,
    &_TRACE_VFIO_SAVE_COMPLETE_PRECOPY_THREAD_END_EVENT,
    ...
    &_TRACE_VFIO_CPR_FIND_DEVICE_EVENT,
    &_TRACE_VFIO_DEVICE_GET_REGION_INFO_TYPE_EVENT,
    &_TRACE_VFIO_DEVICE_RESET_HANDLER_EVENT,
    &_TRACE_VFIO_DEVICE_ATTACH_EVENT,
    &_TRACE_VFIO_DEVICE_DETACH_EVENT,
  NULL,
};
