...
uint16_t _TRACE_PCSPK_IO_READ_DSTATE;
uint16_t _TRACE_PCSPK_IO_WRITE_DSTATE;
...
TraceEvent _TRACE_PCSPK_IO_READ_EVENT = {
    .id = 0,
    .name = "pcspk_io_read",
    .sstate = TRACE_PCSPK_IO_READ_ENABLED,
    .dstate = &_TRACE_PCSPK_IO_READ_DSTATE
};
TraceEvent _TRACE_PCSPK_IO_WRITE_EVENT = {
    .id = 0,
    .name = "pcspk_io_write",
    .sstate = TRACE_PCSPK_IO_WRITE_ENABLED,
    .dstate = &_TRACE_PCSPK_IO_WRITE_DSTATE
};
...
TraceEvent *hw_audio_trace_events[] = {
    ...
    &_TRACE_PCSPK_IO_READ_EVENT,
    &_TRACE_PCSPK_IO_WRITE_EVENT,
