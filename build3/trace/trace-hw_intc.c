...
uint16_t _TRACE_ASPEED_INTC_ALL_ISR_DONE_BIT_DSTATE;
...
uint16_t _TRACE_XIVE_SOURCE_NOTIFY_DSTATE;
uint16_t _TRACE_XIVE_SOURCE_BLOCKED_DSTATE;
...
uint16_t _TRACE_XIVE_NVP_BACKLOG_OP_DSTATE;
uint16_t _TRACE_XIVE_NVGC_BACKLOG_OP_DSTATE;
uint16_t _TRACE_XIVE_REDISTRIBUTE_DSTATE;
uint16_t _TRACE_XIVE_END_ENQUEUE_DSTATE;
uint16_t _TRACE_XIVE_ESCALATE_END_DSTATE;
uint16_t _TRACE_XIVE_ESCALATE_ESB_DSTATE;
...
uint16_t _TRACE_LOONGARCH_PCH_PIC_READ_DSTATE;
uint16_t _TRACE_LOONGARCH_PCH_PIC_WRITE_DSTATE;
...
TraceEvent _TRACE_ASPEED_INTC_ALL_ISR_DONE_BIT_EVENT = {
    .id = 0,
    .name = "aspeed_intc_all_isr_done_bit",
    .sstate = TRACE_ASPEED_INTC_ALL_ISR_DONE_BIT_ENABLED,
    .dstate = &_TRACE_ASPEED_INTC_ALL_ISR_DONE_BIT_DSTATE
};
...
TraceEvent _TRACE_XIVE_SOURCE_NOTIFY_EVENT = {
    .id = 0,
    .name = "xive_source_notify",
    .sstate = TRACE_XIVE_SOURCE_NOTIFY_ENABLED,
    .dstate = &_TRACE_XIVE_SOURCE_NOTIFY_DSTATE
};
TraceEvent _TRACE_XIVE_SOURCE_BLOCKED_EVENT = {
    .id = 0,
    .name = "xive_source_blocked",
    .sstate = TRACE_XIVE_SOURCE_BLOCKED_ENABLED,
    .dstate = &_TRACE_XIVE_SOURCE_BLOCKED_DSTATE
};
...
TraceEvent _TRACE_XIVE_NVP_BACKLOG_OP_EVENT = {
    .id = 0,
    .name = "xive_nvp_backlog_op",
    .sstate = TRACE_XIVE_NVP_BACKLOG_OP_ENABLED,
    .dstate = &_TRACE_XIVE_NVP_BACKLOG_OP_DSTATE
};
TraceEvent _TRACE_XIVE_NVGC_BACKLOG_OP_EVENT = {
    .id = 0,
    .name = "xive_nvgc_backlog_op",
    .sstate = TRACE_XIVE_NVGC_BACKLOG_OP_ENABLED,
    .dstate = &_TRACE_XIVE_NVGC_BACKLOG_OP_DSTATE
};
TraceEvent _TRACE_XIVE_REDISTRIBUTE_EVENT = {
    .id = 0,
    .name = "xive_redistribute",
    .sstate = TRACE_XIVE_REDISTRIBUTE_ENABLED,
    .dstate = &_TRACE_XIVE_REDISTRIBUTE_DSTATE
};
TraceEvent _TRACE_XIVE_END_ENQUEUE_EVENT = {
    .id = 0,
    .name = "xive_end_enqueue",
    .sstate = TRACE_XIVE_END_ENQUEUE_ENABLED,
    .dstate = &_TRACE_XIVE_END_ENQUEUE_DSTATE
};
TraceEvent _TRACE_XIVE_ESCALATE_END_EVENT = {
    .id = 0,
    .name = "xive_escalate_end",
    .sstate = TRACE_XIVE_ESCALATE_END_ENABLED,
    .dstate = &_TRACE_XIVE_ESCALATE_END_DSTATE
};
TraceEvent _TRACE_XIVE_ESCALATE_ESB_EVENT = {
    .id = 0,
    .name = "xive_escalate_esb",
    .sstate = TRACE_XIVE_ESCALATE_ESB_ENABLED,
    .dstate = &_TRACE_XIVE_ESCALATE_ESB_DSTATE
};
...
TraceEvent _TRACE_LOONGARCH_PCH_PIC_READ_EVENT = {
    .id = 0,
    .name = "loongarch_pch_pic_read",
    .sstate = TRACE_LOONGARCH_PCH_PIC_READ_ENABLED,
    .dstate = &_TRACE_LOONGARCH_PCH_PIC_READ_DSTATE
};
TraceEvent _TRACE_LOONGARCH_PCH_PIC_WRITE_EVENT = {
    .id = 0,
    .name = "loongarch_pch_pic_write",
    .sstate = TRACE_LOONGARCH_PCH_PIC_WRITE_ENABLED,
    .dstate = &_TRACE_LOONGARCH_PCH_PIC_WRITE_DSTATE
};
...
TraceEvent *hw_intc_trace_events[] = {
    ...
    &_TRACE_ASPEED_INTC_ALL_ISR_DONE_BIT_EVENT,
    ...
    &_TRACE_XIVE_SOURCE_NOTIFY_EVENT,
    &_TRACE_XIVE_SOURCE_BLOCKED_EVENT,
    ...
    &_TRACE_XIVE_NVP_BACKLOG_OP_EVENT,
    &_TRACE_XIVE_NVGC_BACKLOG_OP_EVENT,
    &_TRACE_XIVE_REDISTRIBUTE_EVENT,
    &_TRACE_XIVE_END_ENQUEUE_EVENT,
    &_TRACE_XIVE_ESCALATE_END_EVENT,
    &_TRACE_XIVE_ESCALATE_ESB_EVENT,
    ...
    &_TRACE_LOONGARCH_PCH_PIC_READ_EVENT,
    &_TRACE_LOONGARCH_PCH_PIC_WRITE_EVENT,
