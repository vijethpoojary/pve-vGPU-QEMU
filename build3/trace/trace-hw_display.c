...
uint16_t _TRACE_VIRTIO_GPU_CMD_RES_MAP_BLOB_DSTATE;
uint16_t _TRACE_VIRTIO_GPU_CMD_RES_UNMAP_BLOB_DSTATE;
...
uint16_t _TRACE_APPLE_GFX_READ_DSTATE;
uint16_t _TRACE_APPLE_GFX_WRITE_DSTATE;
uint16_t _TRACE_APPLE_GFX_CREATE_TASK_DSTATE;
uint16_t _TRACE_APPLE_GFX_DESTROY_TASK_DSTATE;
uint16_t _TRACE_APPLE_GFX_MAP_MEMORY_DSTATE;
uint16_t _TRACE_APPLE_GFX_MAP_MEMORY_RANGE_DSTATE;
uint16_t _TRACE_APPLE_GFX_REMAP_DSTATE;
uint16_t _TRACE_APPLE_GFX_UNMAP_MEMORY_DSTATE;
uint16_t _TRACE_APPLE_GFX_READ_MEMORY_DSTATE;
uint16_t _TRACE_APPLE_GFX_RAISE_IRQ_DSTATE;
uint16_t _TRACE_APPLE_GFX_NEW_FRAME_DSTATE;
uint16_t _TRACE_APPLE_GFX_MODE_CHANGE_DSTATE;
uint16_t _TRACE_APPLE_GFX_CURSOR_SET_DSTATE;
uint16_t _TRACE_APPLE_GFX_CURSOR_SHOW_DSTATE;
uint16_t _TRACE_APPLE_GFX_CURSOR_MOVE_DSTATE;
uint16_t _TRACE_APPLE_GFX_COMMON_INIT_DSTATE;
uint16_t _TRACE_APPLE_GFX_COMMON_REALIZE_MODES_PROPERTY_DSTATE;
uint16_t _TRACE_APPLE_GFX_DISPLAY_MODE_DSTATE;
uint16_t _TRACE_APPLE_GFX_MMIO_IOSFC_READ_DSTATE;
uint16_t _TRACE_APPLE_GFX_MMIO_IOSFC_WRITE_DSTATE;
uint16_t _TRACE_APPLE_GFX_IOSFC_MAP_MEMORY_DSTATE;
uint16_t _TRACE_APPLE_GFX_IOSFC_MAP_MEMORY_NEW_REGION_DSTATE;
uint16_t _TRACE_APPLE_GFX_IOSFC_UNMAP_MEMORY_DSTATE;
uint16_t _TRACE_APPLE_GFX_IOSFC_UNMAP_MEMORY_REGION_DSTATE;
uint16_t _TRACE_APPLE_GFX_IOSFC_RAISE_IRQ_DSTATE;
...
TraceEvent _TRACE_VIRTIO_GPU_CMD_RES_MAP_BLOB_EVENT = {
    .id = 0,
    .name = "virtio_gpu_cmd_res_map_blob",
    .sstate = TRACE_VIRTIO_GPU_CMD_RES_MAP_BLOB_ENABLED,
    .dstate = &_TRACE_VIRTIO_GPU_CMD_RES_MAP_BLOB_DSTATE
};
TraceEvent _TRACE_VIRTIO_GPU_CMD_RES_UNMAP_BLOB_EVENT = {
    .id = 0,
    .name = "virtio_gpu_cmd_res_unmap_blob",
    .sstate = TRACE_VIRTIO_GPU_CMD_RES_UNMAP_BLOB_ENABLED,
    .dstate = &_TRACE_VIRTIO_GPU_CMD_RES_UNMAP_BLOB_DSTATE
};
...
TraceEvent _TRACE_APPLE_GFX_READ_EVENT = {
    .id = 0,
    .name = "apple_gfx_read",
    .sstate = TRACE_APPLE_GFX_READ_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_READ_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_WRITE_EVENT = {
    .id = 0,
    .name = "apple_gfx_write",
    .sstate = TRACE_APPLE_GFX_WRITE_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_WRITE_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_CREATE_TASK_EVENT = {
    .id = 0,
    .name = "apple_gfx_create_task",
    .sstate = TRACE_APPLE_GFX_CREATE_TASK_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_CREATE_TASK_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_DESTROY_TASK_EVENT = {
    .id = 0,
    .name = "apple_gfx_destroy_task",
    .sstate = TRACE_APPLE_GFX_DESTROY_TASK_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_DESTROY_TASK_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_MAP_MEMORY_EVENT = {
    .id = 0,
    .name = "apple_gfx_map_memory",
    .sstate = TRACE_APPLE_GFX_MAP_MEMORY_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_MAP_MEMORY_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_MAP_MEMORY_RANGE_EVENT = {
    .id = 0,
    .name = "apple_gfx_map_memory_range",
    .sstate = TRACE_APPLE_GFX_MAP_MEMORY_RANGE_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_MAP_MEMORY_RANGE_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_REMAP_EVENT = {
    .id = 0,
    .name = "apple_gfx_remap",
    .sstate = TRACE_APPLE_GFX_REMAP_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_REMAP_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_UNMAP_MEMORY_EVENT = {
    .id = 0,
    .name = "apple_gfx_unmap_memory",
    .sstate = TRACE_APPLE_GFX_UNMAP_MEMORY_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_UNMAP_MEMORY_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_READ_MEMORY_EVENT = {
    .id = 0,
    .name = "apple_gfx_read_memory",
    .sstate = TRACE_APPLE_GFX_READ_MEMORY_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_READ_MEMORY_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_RAISE_IRQ_EVENT = {
    .id = 0,
    .name = "apple_gfx_raise_irq",
    .sstate = TRACE_APPLE_GFX_RAISE_IRQ_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_RAISE_IRQ_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_NEW_FRAME_EVENT = {
    .id = 0,
    .name = "apple_gfx_new_frame",
    .sstate = TRACE_APPLE_GFX_NEW_FRAME_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_NEW_FRAME_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_MODE_CHANGE_EVENT = {
    .id = 0,
    .name = "apple_gfx_mode_change",
    .sstate = TRACE_APPLE_GFX_MODE_CHANGE_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_MODE_CHANGE_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_CURSOR_SET_EVENT = {
    .id = 0,
    .name = "apple_gfx_cursor_set",
    .sstate = TRACE_APPLE_GFX_CURSOR_SET_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_CURSOR_SET_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_CURSOR_SHOW_EVENT = {
    .id = 0,
    .name = "apple_gfx_cursor_show",
    .sstate = TRACE_APPLE_GFX_CURSOR_SHOW_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_CURSOR_SHOW_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_CURSOR_MOVE_EVENT = {
    .id = 0,
    .name = "apple_gfx_cursor_move",
    .sstate = TRACE_APPLE_GFX_CURSOR_MOVE_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_CURSOR_MOVE_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_COMMON_INIT_EVENT = {
    .id = 0,
    .name = "apple_gfx_common_init",
    .sstate = TRACE_APPLE_GFX_COMMON_INIT_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_COMMON_INIT_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_COMMON_REALIZE_MODES_PROPERTY_EVENT = {
    .id = 0,
    .name = "apple_gfx_common_realize_modes_property",
    .sstate = TRACE_APPLE_GFX_COMMON_REALIZE_MODES_PROPERTY_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_COMMON_REALIZE_MODES_PROPERTY_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_DISPLAY_MODE_EVENT = {
    .id = 0,
    .name = "apple_gfx_display_mode",
    .sstate = TRACE_APPLE_GFX_DISPLAY_MODE_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_DISPLAY_MODE_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_MMIO_IOSFC_READ_EVENT = {
    .id = 0,
    .name = "apple_gfx_mmio_iosfc_read",
    .sstate = TRACE_APPLE_GFX_MMIO_IOSFC_READ_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_MMIO_IOSFC_READ_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_MMIO_IOSFC_WRITE_EVENT = {
    .id = 0,
    .name = "apple_gfx_mmio_iosfc_write",
    .sstate = TRACE_APPLE_GFX_MMIO_IOSFC_WRITE_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_MMIO_IOSFC_WRITE_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_IOSFC_MAP_MEMORY_EVENT = {
    .id = 0,
    .name = "apple_gfx_iosfc_map_memory",
    .sstate = TRACE_APPLE_GFX_IOSFC_MAP_MEMORY_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_IOSFC_MAP_MEMORY_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_IOSFC_MAP_MEMORY_NEW_REGION_EVENT = {
    .id = 0,
    .name = "apple_gfx_iosfc_map_memory_new_region",
    .sstate = TRACE_APPLE_GFX_IOSFC_MAP_MEMORY_NEW_REGION_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_IOSFC_MAP_MEMORY_NEW_REGION_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_IOSFC_UNMAP_MEMORY_EVENT = {
    .id = 0,
    .name = "apple_gfx_iosfc_unmap_memory",
    .sstate = TRACE_APPLE_GFX_IOSFC_UNMAP_MEMORY_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_IOSFC_UNMAP_MEMORY_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_IOSFC_UNMAP_MEMORY_REGION_EVENT = {
    .id = 0,
    .name = "apple_gfx_iosfc_unmap_memory_region",
    .sstate = TRACE_APPLE_GFX_IOSFC_UNMAP_MEMORY_REGION_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_IOSFC_UNMAP_MEMORY_REGION_DSTATE
};
TraceEvent _TRACE_APPLE_GFX_IOSFC_RAISE_IRQ_EVENT = {
    .id = 0,
    .name = "apple_gfx_iosfc_raise_irq",
    .sstate = TRACE_APPLE_GFX_IOSFC_RAISE_IRQ_ENABLED,
    .dstate = &_TRACE_APPLE_GFX_IOSFC_RAISE_IRQ_DSTATE
};
TraceEvent *hw_display_trace_events[] = {
    ...
    &_TRACE_VIRTIO_GPU_CMD_RES_MAP_BLOB_EVENT,
    &_TRACE_VIRTIO_GPU_CMD_RES_UNMAP_BLOB_EVENT,
    ...
    &_TRACE_APPLE_GFX_READ_EVENT,
    &_TRACE_APPLE_GFX_WRITE_EVENT,
    &_TRACE_APPLE_GFX_CREATE_TASK_EVENT,
    &_TRACE_APPLE_GFX_DESTROY_TASK_EVENT,
    &_TRACE_APPLE_GFX_MAP_MEMORY_EVENT,
    &_TRACE_APPLE_GFX_MAP_MEMORY_RANGE_EVENT,
    &_TRACE_APPLE_GFX_REMAP_EVENT,
    &_TRACE_APPLE_GFX_UNMAP_MEMORY_EVENT,
    &_TRACE_APPLE_GFX_READ_MEMORY_EVENT,
    &_TRACE_APPLE_GFX_RAISE_IRQ_EVENT,
    &_TRACE_APPLE_GFX_NEW_FRAME_EVENT,
    &_TRACE_APPLE_GFX_MODE_CHANGE_EVENT,
    &_TRACE_APPLE_GFX_CURSOR_SET_EVENT,
    &_TRACE_APPLE_GFX_CURSOR_SHOW_EVENT,
    &_TRACE_APPLE_GFX_CURSOR_MOVE_EVENT,
    &_TRACE_APPLE_GFX_COMMON_INIT_EVENT,
    &_TRACE_APPLE_GFX_COMMON_REALIZE_MODES_PROPERTY_EVENT,
    &_TRACE_APPLE_GFX_DISPLAY_MODE_EVENT,
    &_TRACE_APPLE_GFX_MMIO_IOSFC_READ_EVENT,
    &_TRACE_APPLE_GFX_MMIO_IOSFC_WRITE_EVENT,
    &_TRACE_APPLE_GFX_IOSFC_MAP_MEMORY_EVENT,
    &_TRACE_APPLE_GFX_IOSFC_MAP_MEMORY_NEW_REGION_EVENT,
    &_TRACE_APPLE_GFX_IOSFC_UNMAP_MEMORY_EVENT,
    &_TRACE_APPLE_GFX_IOSFC_UNMAP_MEMORY_REGION_EVENT,
    &_TRACE_APPLE_GFX_IOSFC_RAISE_IRQ_EVENT,
  NULL,
};
