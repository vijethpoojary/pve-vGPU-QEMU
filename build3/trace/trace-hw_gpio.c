...
uint16_t _TRACE_IMX_GPIO_READ_DSTATE;
uint16_t _TRACE_IMX_GPIO_WRITE_DSTATE;
uint16_t _TRACE_IMX_GPIO_SET_DSTATE;
...
TraceEvent _TRACE_IMX_GPIO_READ_EVENT = {
    .id = 0,
    .name = "imx_gpio_read",
    .sstate = TRACE_IMX_GPIO_READ_ENABLED,
    .dstate = &_TRACE_IMX_GPIO_READ_DSTATE
};
TraceEvent _TRACE_IMX_GPIO_WRITE_EVENT = {
    .id = 0,
    .name = "imx_gpio_write",
    .sstate = TRACE_IMX_GPIO_WRITE_ENABLED,
    .dstate = &_TRACE_IMX_GPIO_WRITE_DSTATE
};
TraceEvent _TRACE_IMX_GPIO_SET_EVENT = {
    .id = 0,
    .name = "imx_gpio_set",
    .sstate = TRACE_IMX_GPIO_SET_ENABLED,
    .dstate = &_TRACE_IMX_GPIO_SET_DSTATE
};
...
TraceEvent *hw_gpio_trace_events[] = {
    &_TRACE_IMX_GPIO_READ_EVENT,
    &_TRACE_IMX_GPIO_WRITE_EVENT,
    &_TRACE_IMX_GPIO_SET_EVENT,
