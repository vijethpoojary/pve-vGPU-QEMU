...
uint16_t _TRACE_HVF_INSN_ABORT_DSTATE;
...
uint16_t _TRACE_HVF_EMU_REGINFO_WRITE_DSTATE;
uint16_t _TRACE_HVF_EMU_REGINFO_READ_DSTATE;
uint16_t _TRACE_HVF_ILLEGAL_GUEST_STATE_DSTATE;
uint16_t _TRACE_HVF_KICK_VCPU_THREAD_DSTATE;
...
TraceEvent _TRACE_HVF_INSN_ABORT_EVENT = {
    .id = 0,
    .name = "hvf_insn_abort",
    .sstate = TRACE_HVF_INSN_ABORT_ENABLED,
    .dstate = &_TRACE_HVF_INSN_ABORT_DSTATE
};
...
TraceEvent _TRACE_HVF_EMU_REGINFO_WRITE_EVENT = {
    .id = 0,
    .name = "hvf_emu_reginfo_write",
    .sstate = TRACE_HVF_EMU_REGINFO_WRITE_ENABLED,
    .dstate = &_TRACE_HVF_EMU_REGINFO_WRITE_DSTATE
};
TraceEvent _TRACE_HVF_EMU_REGINFO_READ_EVENT = {
    .id = 0,
    .name = "hvf_emu_reginfo_read",
    .sstate = TRACE_HVF_EMU_REGINFO_READ_ENABLED,
    .dstate = &_TRACE_HVF_EMU_REGINFO_READ_DSTATE
};
TraceEvent _TRACE_HVF_ILLEGAL_GUEST_STATE_EVENT = {
    .id = 0,
    .name = "hvf_illegal_guest_state",
    .sstate = TRACE_HVF_ILLEGAL_GUEST_STATE_ENABLED,
    .dstate = &_TRACE_HVF_ILLEGAL_GUEST_STATE_DSTATE
};
TraceEvent _TRACE_HVF_KICK_VCPU_THREAD_EVENT = {
    .id = 0,
    .name = "hvf_kick_vcpu_thread",
    .sstate = TRACE_HVF_KICK_VCPU_THREAD_ENABLED,
    .dstate = &_TRACE_HVF_KICK_VCPU_THREAD_DSTATE
};
TraceEvent *target_arm_hvf_trace_events[] = {
    ...
    &_TRACE_HVF_EMU_REGINFO_WRITE_EVENT,
    &_TRACE_HVF_EMU_REGINFO_READ_EVENT,
    &_TRACE_HVF_ILLEGAL_GUEST_STATE_EVENT,
    &_TRACE_HVF_KICK_VCPU_THREAD_EVENT,
  NULL,
};
