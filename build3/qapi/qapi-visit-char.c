...
bool visit_type_ChardevCommon_members(Visitor *v, ChardevCommon *obj, Error **errp)
{
    ...
    if (visit_optional(v, "logtimestamp", &obj->has_logtimestamp)) {
        if (!visit_type_bool(v, "logtimestamp", &obj->logtimestamp, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_ChardevHub_members(Visitor *v, ChardevHub *obj, Error **errp)
{
    if (!visit_type_ChardevCommon_members(v, (ChardevCommon *)obj, errp)) {
        return false;
    }
    if (!visit_type_strList(v, "chardevs", &obj->chardevs, errp)) {
        return false;
    }
    return true;
}

bool visit_type_ChardevHub(Visitor *v, const char *name,
                 ChardevHub **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(ChardevHub), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_ChardevHub_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
...
bool visit_type_ChardevPty_members(Visitor *v, ChardevPty *obj, Error **errp)
{
...
bool visit_type_ChardevPty(Visitor *v, const char *name,
                 ChardevPty **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(ChardevPty), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_ChardevPty_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
...
bool visit_type_ChardevHubWrapper_members(Visitor *v, ChardevHubWrapper *obj, Error **errp)
{
    if (!visit_type_ChardevHub(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_ChardevHubWrapper(Visitor *v, const char *name,
                 ChardevHubWrapper **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(ChardevHubWrapper), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_ChardevHubWrapper_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_ChardevHubWrapper(*obj);
        *obj = NULL;
    }
    return ok;
}
...
bool visit_type_ChardevPtyWrapper_members(Visitor *v, ChardevPtyWrapper *obj, Error **errp)
{
    if (!visit_type_ChardevPty(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_ChardevPtyWrapper(Visitor *v, const char *name,
                 ChardevPtyWrapper **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(ChardevPtyWrapper), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_ChardevPtyWrapper_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_ChardevPtyWrapper(*obj);
        *obj = NULL;
    }
    return ok;
}
...
bool visit_type_ChardevBackend_members(Visitor *v, ChardevBackend *obj, Error **errp)
{
    ...
    case CHARDEV_BACKEND_KIND_PTY:
        return visit_type_ChardevPtyWrapper_members(v, &obj->u.pty, errp);
    ...
    case CHARDEV_BACKEND_KIND_HUB:
        return visit_type_ChardevHubWrapper_members(v, &obj->u.hub, errp);
