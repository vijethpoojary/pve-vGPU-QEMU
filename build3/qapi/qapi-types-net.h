...
typedef struct NetDevPasstOptions NetDevPasstOptions;
...
typedef struct q_obj_NETDEV_VHOST_USER_CONNECTED_arg q_obj_NETDEV_VHOST_USER_CONNECTED_arg;

typedef struct q_obj_NETDEV_VHOST_USER_DISCONNECTED_arg q_obj_NETDEV_VHOST_USER_DISCONNECTED_arg;
...
struct NetDevPasstOptions {
    ...
    bool has_dhcp_dns;
    bool dhcp_dns;
    bool has_dhcp_search;
    bool dhcp_search;
    char *map_host_loopback;
    char *map_guest_addr;
    char *dns_forward;
    char *dns_host;
    bool has_tcp;
    ...
    bool ipv6;
    bool has_tcp_ports;
    StringList *tcp_ports;
    bool has_udp_ports;
    StringList *udp_ports;
    bool has_param;
    StringList *param;
};
#endif /* defined(CONFIG_PASST) */
...
#if defined(CONFIG_PASST)
void qapi_free_NetDevPasstOptions(NetDevPasstOptions *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(NetDevPasstOptions, qapi_free_NetDevPasstOptions)
#endif /* defined(CONFIG_PASST) */
...
struct q_obj_NETDEV_VHOST_USER_CONNECTED_arg {
    char *netdev_id;
    char *chardev_id;
};

struct q_obj_NETDEV_VHOST_USER_DISCONNECTED_arg {
    char *netdev_id;
};
