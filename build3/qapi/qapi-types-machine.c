...
const QEnumLookup SysEmuTarget_lookup = {
    .array = (const char *const[]) {
        ...
        [SYS_EMU_TARGET_HEXAGON] = "hexagon",
...
const QEnumLookup S390CpuState_lookup = {
    .array = (const char *const[]) {
...
void qapi_free_CompatProperty(CompatProperty *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_CompatProperty(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_CompatPropertyList(CompatPropertyList *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_CompatPropertyList(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_QemuTargetInfo(QemuTargetInfo *obj)
{
    Visitor *v;
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_QemuTargetInfo(v, NULL, &obj, NULL);
    visit_free(v);
}
...
const QEnumLookup HmatLBMemoryHierarchy_lookup = {
    .array = (const char *const[]) {
        [HMAT_LB_MEMORY_HIERARCHY_MEMORY] = "memory",
        [HMAT_LB_MEMORY_HIERARCHY_FIRST_LEVEL] = "first-level",
        [HMAT_LB_MEMORY_HIERARCHY_SECOND_LEVEL] = "second-level",
        [HMAT_LB_MEMORY_HIERARCHY_THIRD_LEVEL] = "third-level",
    },
    .size = HMAT_LB_MEMORY_HIERARCHY__MAX
};

const QEnumLookup HmatLBDataType_lookup = {
    .array = (const char *const[]) {
        [HMAT_LB_DATA_TYPE_ACCESS_LATENCY] = "access-latency",
        [HMAT_LB_DATA_TYPE_READ_LATENCY] = "read-latency",
        [HMAT_LB_DATA_TYPE_WRITE_LATENCY] = "write-latency",
        [HMAT_LB_DATA_TYPE_ACCESS_BANDWIDTH] = "access-bandwidth",
        [HMAT_LB_DATA_TYPE_READ_BANDWIDTH] = "read-bandwidth",
        [HMAT_LB_DATA_TYPE_WRITE_BANDWIDTH] = "write-bandwidth",
    },
    .size = HMAT_LB_DATA_TYPE__MAX
};
...
void qapi_free_HvBalloonInfo(HvBalloonInfo *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_HvBalloonInfo(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_HvBalloonDeviceInfo(HvBalloonDeviceInfo *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_HvBalloonDeviceInfo(v, NULL, &obj, NULL);
    visit_free(v);
}
...
const QEnumLookup MemoryDeviceInfoKind_lookup = {
    .array = (const char *const[]) {
        ...
        [MEMORY_DEVICE_INFO_KIND_HV_BALLOON] = "hv-balloon",
    },
...
void qapi_free_HvBalloonDeviceInfoWrapper(HvBalloonDeviceInfoWrapper *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_HvBalloonDeviceInfoWrapper(v, NULL, &obj, NULL);
    visit_free(v);
}
...
const QEnumLookup SmbiosEntryPointType_lookup = {
    .array = (const char *const[]) {
        ...
        [SMBIOS_ENTRY_POINT_TYPE_AUTO] = "auto",
    },
...
void qapi_free_FirmwareLog(FirmwareLog *obj)
{
    Visitor *v;
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_FirmwareLog(v, NULL, &obj, NULL);
    visit_free(v);
}
