...
void qmp_nbd_server_start(bool has_handshake_max_seconds, uint32_t handshake_max_seconds, const char *tls_creds, const char *tls_authz, bool has_max_connections, uint32_t max_connections, SocketAddressLegacy *addr, Error **errp);
