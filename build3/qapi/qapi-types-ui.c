...
const QEnumLookup InputMultiTouchType_lookup = {
    .array = (const char *const[]) {
        [INPUT_MULTI_TOUCH_TYPE_BEGIN] = "begin",
        [INPUT_MULTI_TOUCH_TYPE_UPDATE] = "update",
        [INPUT_MULTI_TOUCH_TYPE_END] = "end",
        [INPUT_MULTI_TOUCH_TYPE_CANCEL] = "cancel",
        [INPUT_MULTI_TOUCH_TYPE_DATA] = "data",
    },
    .size = INPUT_MULTI_TOUCH_TYPE__MAX
};
...
void qapi_free_InputMultiTouchEvent(InputMultiTouchEvent *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_InputMultiTouchEvent(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_InputMultiTouchEventWrapper(InputMultiTouchEventWrapper *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_InputMultiTouchEventWrapper(v, NULL, &obj, NULL);
    visit_free(v);
}
...
const QEnumLookup DisplayGLMode_lookup = {
    .array = (const char *const[]) {
        [DISPLAY_GL_MODE_OFF] = "off",
        [DISPLAY_GL_MODE_ON] = "on",
        [DISPLAY_GL_MODE_CORE] = "core",
        [DISPLAY_GL_MODE_ES] = "es",
    },
    .size = DISPLAY_GL_MODE__MAX
};
