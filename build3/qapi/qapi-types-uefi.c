...
void qapi_free_UefiVariable(UefiVariable *obj)
{
    ...
    visit_type_UefiVariable(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_UefiVariableList(UefiVariableList *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_UefiVariableList(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_UefiVarStore(UefiVarStore *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_UefiVarStore(v, NULL, &obj, NULL);
    visit_free(v);
}

/* Dummy declaration to prevent empty .o file */
char qapi_dummy_qapi_types_uefi_c;
