...
void qmp_marshal_query_rocker(QDict *args, QObject **ret, Error **errp)
{
    ...
    if (visit_type_RockerSwitch(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_RockerSwitch(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_query_rocker_ports(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_RockerPortList(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_RockerPortList(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_query_rocker_of_dpa_flows(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_RockerOfDpaFlowList(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_RockerOfDpaFlowList(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_query_rocker_of_dpa_groups(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_RockerOfDpaGroupList(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_RockerOfDpaGroupList(ov, "unused", &retval, NULL);
    visit_free(ov);
