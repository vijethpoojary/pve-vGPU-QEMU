...
void qmp_init_marshal(QmpCommandList *cmds)
{
    ...
    qmp_register_command(cmds, "x-accel-stats",
                         qmp_marshal_x_accel_stats, 0, 1u << QAPI_FEATURE_UNSTABLE);
    qmp_register_command(cmds, "query-accelerators",
                         qmp_marshal_query_accelerators, 0, 0);
    ...
    qmp_register_command(cmds, "backup",
                         qmp_marshal_backup, QCO_COROUTINE, 0);
    qmp_register_command(cmds, "query-backup",
                         qmp_marshal_query_backup, 0, 0);
    qmp_register_command(cmds, "backup-cancel",
                         qmp_marshal_backup_cancel, QCO_COROUTINE, 0);
    qmp_register_command(cmds, "query-proxmox-support",
                         qmp_marshal_query_proxmox_support, 0, 0);
    qmp_register_command(cmds, "query-pbs-bitmap-info",
                         qmp_marshal_query_pbs_bitmap_info, 0, 0);
    qmp_register_command(cmds, "backup-access-setup",
                         qmp_marshal_backup_access_setup, QCO_COROUTINE, 0);
    qmp_register_command(cmds, "backup-access-teardown",
                         qmp_marshal_backup_access_teardown, QCO_COROUTINE, 0);
    ...
    qmp_register_command(cmds, "blockdev-snapshot",
                         qmp_marshal_blockdev_snapshot, QCO_ALLOW_PRECONFIG, 1u << QAPI_FEATURE_ALLOW_WRITE_ONLY_OVERLAY);
    ...
    qmp_register_command(cmds, "drive-backup",
                         qmp_marshal_drive_backup, QCO_ALLOW_PRECONFIG, 1u << QAPI_FEATURE_DEPRECATED);
    ...
    qmp_register_command(cmds, "x-debug-query-block-graph",
                         qmp_marshal_x_debug_query_block_graph, QCO_ALLOW_PRECONFIG, 1u << QAPI_FEATURE_UNSTABLE);
    ...
    qmp_register_command(cmds, "x-debug-block-dirty-bitmap-sha256",
                         qmp_marshal_x_debug_block_dirty_bitmap_sha256, QCO_ALLOW_PRECONFIG, 1u << QAPI_FEATURE_UNSTABLE);
    ...
    qmp_register_command(cmds, "block-job-pause",
                         qmp_marshal_block_job_pause, QCO_ALLOW_PRECONFIG, 1u << QAPI_FEATURE_DEPRECATED);
    qmp_register_command(cmds, "block-job-resume",
                         qmp_marshal_block_job_resume, QCO_ALLOW_PRECONFIG, 1u << QAPI_FEATURE_DEPRECATED);
    qmp_register_command(cmds, "block-job-complete",
                         qmp_marshal_block_job_complete, QCO_ALLOW_PRECONFIG, 1u << QAPI_FEATURE_DEPRECATED);
    qmp_register_command(cmds, "block-job-dismiss",
                         qmp_marshal_block_job_dismiss, QCO_ALLOW_PRECONFIG, 1u << QAPI_FEATURE_DEPRECATED);
    qmp_register_command(cmds, "block-job-finalize",
                         qmp_marshal_block_job_finalize, QCO_ALLOW_PRECONFIG, 1u << QAPI_FEATURE_DEPRECATED);
    qmp_register_command(cmds, "block-job-change",
                         qmp_marshal_block_job_change, 0, 0);
    ...
    qmp_register_command(cmds, "blockdev-set-active",
                         qmp_marshal_blockdev_set_active, QCO_ALLOW_PRECONFIG, 0);
    ...
    qmp_register_command(cmds, "x-blockdev-amend",
                         qmp_marshal_x_blockdev_amend, QCO_ALLOW_PRECONFIG, 1u << QAPI_FEATURE_UNSTABLE);
    ...
    qmp_register_command(cmds, "x-blockdev-change",
                         qmp_marshal_x_blockdev_change, QCO_ALLOW_PRECONFIG, 1u << QAPI_FEATURE_UNSTABLE);
    qmp_register_command(cmds, "x-blockdev-set-iothread",
                         qmp_marshal_x_blockdev_set_iothread, QCO_ALLOW_PRECONFIG, 1u << QAPI_FEATURE_UNSTABLE);
    ...
    qmp_register_command(cmds, "nbd-server-add",
                         qmp_marshal_nbd_server_add, QCO_ALLOW_PRECONFIG, 1u << QAPI_FEATURE_DEPRECATED);
    qmp_register_command(cmds, "nbd-server-remove",
                         qmp_marshal_nbd_server_remove, QCO_ALLOW_PRECONFIG, 1u << QAPI_FEATURE_DEPRECATED);
    ...
    qmp_register_command(cmds, "request-ebpf",
                         qmp_marshal_request_ebpf, 0, 0);
    ...
    qmp_register_command(cmds, "query-savevm",
                         qmp_marshal_query_savevm, 0, 0);
    ...
    qmp_register_command(cmds, "x-colo-lost-heartbeat",
                         qmp_marshal_x_colo_lost_heartbeat, 0, 1u << QAPI_FEATURE_UNSTABLE);
    ...
    qmp_register_command(cmds, "qom-list-get",
                         qmp_marshal_qom_list_get, QCO_ALLOW_PRECONFIG, 0);
    ...
    qmp_register_command(cmds, "device-sync-config",
                         qmp_marshal_device_sync_config, 0, 1u << QAPI_FEATURE_UNSTABLE);
    ...
    qmp_register_command(cmds, "query-hv-balloon-status-report",
                         qmp_marshal_query_hv_balloon_status_report, 0, 0);
    ...
    qmp_register_command(cmds, "x-query-irq",
                         qmp_marshal_x_query_irq, 0, 1u << QAPI_FEATURE_UNSTABLE);
#if defined(CONFIG_TCG)
    qmp_register_command(cmds, "x-query-jit",
                         qmp_marshal_x_query_jit, 0, 1u << QAPI_FEATURE_UNSTABLE);
#endif /* defined(CONFIG_TCG) */
    qmp_register_command(cmds, "x-query-numa",
                         qmp_marshal_x_query_numa, 0, 1u << QAPI_FEATURE_UNSTABLE);
    qmp_register_command(cmds, "x-query-ramblock",
                         qmp_marshal_x_query_ramblock, 0, 1u << QAPI_FEATURE_UNSTABLE);
    qmp_register_command(cmds, "x-query-roms",
                         qmp_marshal_x_query_roms, 0, 1u << QAPI_FEATURE_UNSTABLE);
    qmp_register_command(cmds, "x-query-usb",
                         qmp_marshal_x_query_usb, 0, 1u << QAPI_FEATURE_UNSTABLE);
#if defined(CONFIG_FDT)
    qmp_register_command(cmds, "dumpdtb",
                         qmp_marshal_dumpdtb, 0, 0);
#endif /* defined(CONFIG_FDT) */
    qmp_register_command(cmds, "x-query-interrupt-controllers",
                         qmp_marshal_x_query_interrupt_controllers, 0, 1u << QAPI_FEATURE_UNSTABLE);
    qmp_register_command(cmds, "query-firmware-log",
                         qmp_marshal_query_firmware_log, 0, 0);
    ...
    qmp_register_command(cmds, "x-exit-preconfig",
                         qmp_marshal_x_exit_preconfig, QCO_ALLOW_PRECONFIG, 1u << QAPI_FEATURE_UNSTABLE);
    qmp_register_command(cmds, "human-monitor-command",
                         qmp_marshal_human_monitor_command, 0, 1u << QAPI_FEATURE_SAVEVM_MONITOR_NODES);
    ...
    qmp_register_command(cmds, "savevm-start",
                         qmp_marshal_savevm_start, 0, 0);
    qmp_register_command(cmds, "savevm-end",
                         qmp_marshal_savevm_end, 0, 0);
    ...
    qmp_register_command(cmds, "inject-ghes-v2-error",
                         qmp_marshal_inject_ghes_v2_error, 0, 1u << QAPI_FEATURE_UNSTABLE);
    ...
    qmp_register_command(cmds, "x-query-virtio",
                         qmp_marshal_x_query_virtio, 0, 1u << QAPI_FEATURE_UNSTABLE);
    qmp_register_command(cmds, "x-query-virtio-status",
                         qmp_marshal_x_query_virtio_status, 0, 1u << QAPI_FEATURE_UNSTABLE);
    qmp_register_command(cmds, "x-query-virtio-queue-status",
                         qmp_marshal_x_query_virtio_queue_status, 0, 1u << QAPI_FEATURE_UNSTABLE);
    qmp_register_command(cmds, "x-query-virtio-vhost-queue-status",
                         qmp_marshal_x_query_virtio_vhost_queue_status, 0, 1u << QAPI_FEATURE_UNSTABLE);
    qmp_register_command(cmds, "x-query-virtio-queue-element",
                         qmp_marshal_x_query_virtio_queue_element, 0, 1u << QAPI_FEATURE_UNSTABLE);
    qmp_register_command(cmds, "query-cryptodev",
                         qmp_marshal_query_cryptodev, 0, 0);
    qmp_register_command(cmds, "cxl-inject-general-media-event",
                         qmp_marshal_cxl_inject_general_media_event, 0, 0);
    qmp_register_command(cmds, "cxl-inject-dram-event",
                         qmp_marshal_cxl_inject_dram_event, 0, 0);
    qmp_register_command(cmds, "cxl-inject-memory-module-event",
                         qmp_marshal_cxl_inject_memory_module_event, 0, 0);
    qmp_register_command(cmds, "cxl-inject-poison",
                         qmp_marshal_cxl_inject_poison, 0, 0);
    ...
    qmp_register_command(cmds, "cxl-add-dynamic-capacity",
                         qmp_marshal_cxl_add_dynamic_capacity, 0, 1u << QAPI_FEATURE_UNSTABLE);
    qmp_register_command(cmds, "cxl-release-dynamic-capacity",
                         qmp_marshal_cxl_release_dynamic_capacity, 0, 1u << QAPI_FEATURE_UNSTABLE);
}
