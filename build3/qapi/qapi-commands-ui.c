...
void qmp_marshal_query_spice(QDict *args, QObject **ret, Error **errp)
{
    ...
    if (visit_type_SpiceInfo(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_SpiceInfo(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_query_vnc(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_VncInfo(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_VncInfo(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_query_vnc_servers(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_VncInfo2List(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_VncInfo2List(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_query_mice(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_MouseInfoList(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_MouseInfoList(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_query_display_options(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_DisplayOptions(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_DisplayOptions(ov, "unused", &retval, NULL);
    visit_free(ov);
