...
bool visit_type_BlockLimitsInfo_members(Visitor *v, BlockLimitsInfo *obj, Error **errp)
{
    if (!visit_type_uint32(v, "request-alignment", &obj->request_alignment, errp)) {
        return false;
    }
    if (visit_optional(v, "max-discard", &obj->has_max_discard)) {
        if (!visit_type_uint64(v, "max-discard", &obj->max_discard, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "discard-alignment", &obj->has_discard_alignment)) {
        if (!visit_type_uint32(v, "discard-alignment", &obj->discard_alignment, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "max-write-zeroes", &obj->has_max_write_zeroes)) {
        if (!visit_type_uint64(v, "max-write-zeroes", &obj->max_write_zeroes, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "write-zeroes-alignment", &obj->has_write_zeroes_alignment)) {
        if (!visit_type_uint32(v, "write-zeroes-alignment", &obj->write_zeroes_alignment, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "opt-transfer", &obj->has_opt_transfer)) {
        if (!visit_type_uint32(v, "opt-transfer", &obj->opt_transfer, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "max-transfer", &obj->has_max_transfer)) {
        if (!visit_type_uint32(v, "max-transfer", &obj->max_transfer, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "max-hw-transfer", &obj->has_max_hw_transfer)) {
        if (!visit_type_uint32(v, "max-hw-transfer", &obj->max_hw_transfer, errp)) {
            return false;
        }
    }
    if (!visit_type_int(v, "max-iov", &obj->max_iov, errp)) {
        return false;
    }
    if (visit_optional(v, "max-hw-iov", &obj->has_max_hw_iov)) {
        if (!visit_type_int(v, "max-hw-iov", &obj->max_hw_iov, errp)) {
            return false;
        }
    }
    if (!visit_type_size(v, "min-mem-alignment", &obj->min_mem_alignment, errp)) {
        return false;
    }
    if (!visit_type_size(v, "opt-mem-alignment", &obj->opt_mem_alignment, errp)) {
        return false;
    }
    return true;
}

bool visit_type_BlockLimitsInfo(Visitor *v, const char *name,
                 BlockLimitsInfo **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(BlockLimitsInfo), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_BlockLimitsInfo_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
...
bool visit_type_BlockNodeInfo_members(Visitor *v, BlockNodeInfo *obj, Error **errp)
{
    ...
    if (visit_optional(v, "limits", &has_limits)) {
        if (!visit_type_BlockLimitsInfo(v, "limits", &obj->limits, errp)) {
            return false;
        }
    }
...
bool visit_type_BlockdevChild_members(Visitor *v, BlockdevChild *obj, Error **errp)
{
...
bool visit_type_BlockdevChild(Visitor *v, const char *name,
                 BlockdevChild **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(BlockdevChild), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_BlockdevChild_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_BlockdevChild(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_BlockdevChildList(Visitor *v, const char *name,
                 BlockdevChildList **obj, Error **errp)
{
    bool ok = false;
    BlockdevChildList *tail;
    size_t size = sizeof(**obj);
    ...
    for (tail = *obj; tail;
         tail = (BlockdevChildList *)visit_next_list(v, (GenericList *)tail, size)) {
        if (!visit_type_BlockdevChild(v, NULL, &tail->value, errp)) {
            goto out_obj;
        }
    }
...
out_obj:
    visit_end_list(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_BlockdevChildList(*obj);
        *obj = NULL;
    }
    return ok;
}
...
bool visit_type_BlockDeviceInfo_members(Visitor *v, BlockDeviceInfo *obj, Error **errp)
{
    ...
    if (!visit_type_BlockdevChildList(v, "children", &obj->children, errp)) {
        return false;
    }
...
bool visit_type_q_obj_query_block_arg_members(Visitor *v, q_obj_query_block_arg *obj, Error **errp)
{
...
bool visit_type_BackupStatus_members(Visitor *v, BackupStatus *obj, Error **errp)
{
    bool has_status = !!obj->status;
    bool has_errmsg = !!obj->errmsg;
    bool has_backup_file = !!obj->backup_file;
    bool has_uuid = !!obj->uuid;

    if (visit_optional(v, "status", &has_status)) {
        if (!visit_type_str(v, "status", &obj->status, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "errmsg", &has_errmsg)) {
        if (!visit_type_str(v, "errmsg", &obj->errmsg, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "total", &obj->has_total)) {
        if (!visit_type_int(v, "total", &obj->total, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "dirty", &obj->has_dirty)) {
        if (!visit_type_int(v, "dirty", &obj->dirty, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "transferred", &obj->has_transferred)) {
        if (!visit_type_int(v, "transferred", &obj->transferred, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "zero-bytes", &obj->has_zero_bytes)) {
        if (!visit_type_int(v, "zero-bytes", &obj->zero_bytes, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "reused", &obj->has_reused)) {
        if (!visit_type_int(v, "reused", &obj->reused, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "start-time", &obj->has_start_time)) {
        if (!visit_type_int(v, "start-time", &obj->start_time, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "end-time", &obj->has_end_time)) {
        if (!visit_type_int(v, "end-time", &obj->end_time, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "backup-file", &has_backup_file)) {
        if (!visit_type_str(v, "backup-file", &obj->backup_file, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "uuid", &has_uuid)) {
        if (!visit_type_str(v, "uuid", &obj->uuid, errp)) {
            return false;
        }
    }
    if (!visit_type_bool(v, "finishing", &obj->finishing, errp)) {
        return false;
    }
    return true;
}

bool visit_type_BackupStatus(Visitor *v, const char *name,
                 BackupStatus **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(BackupStatus), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_BackupStatus_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_BackupStatus(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_BackupFormat(Visitor *v, const char *name,
                 BackupFormat *obj, Error **errp)
{
    int value = *obj;
    bool ok = visit_type_enum(v, name, &value, &BackupFormat_lookup, errp);
    *obj = value;
    return ok;
}

bool visit_type_q_obj_backup_arg_members(Visitor *v, q_obj_backup_arg *obj, Error **errp)
{
    bool has_password = !!obj->password;
    bool has_keyfile = !!obj->keyfile;
    bool has_key_password = !!obj->key_password;
    bool has_master_keyfile = !!obj->master_keyfile;
    bool has_fingerprint = !!obj->fingerprint;
    bool has_backup_ns = !!obj->backup_ns;
    bool has_backup_id = !!obj->backup_id;
    bool has_config_file = !!obj->config_file;
    bool has_firewall_file = !!obj->firewall_file;
    bool has_devlist = !!obj->devlist;

    if (!visit_type_str(v, "backup-file", &obj->backup_file, errp)) {
        return false;
    }
    if (visit_optional(v, "password", &has_password)) {
        if (!visit_type_str(v, "password", &obj->password, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "keyfile", &has_keyfile)) {
        if (!visit_type_str(v, "keyfile", &obj->keyfile, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "key-password", &has_key_password)) {
        if (!visit_type_str(v, "key-password", &obj->key_password, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "master-keyfile", &has_master_keyfile)) {
        if (!visit_type_str(v, "master-keyfile", &obj->master_keyfile, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "fingerprint", &has_fingerprint)) {
        if (!visit_type_str(v, "fingerprint", &obj->fingerprint, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "backup-ns", &has_backup_ns)) {
        if (!visit_type_str(v, "backup-ns", &obj->backup_ns, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "backup-id", &has_backup_id)) {
        if (!visit_type_str(v, "backup-id", &obj->backup_id, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "backup-time", &obj->has_backup_time)) {
        if (!visit_type_int(v, "backup-time", &obj->backup_time, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "use-dirty-bitmap", &obj->has_use_dirty_bitmap)) {
        if (!visit_type_bool(v, "use-dirty-bitmap", &obj->use_dirty_bitmap, errp)) {
            return false;
        }
    }
    ...
    if (visit_optional(v, "encrypt", &obj->has_encrypt)) {
        if (!visit_type_bool(v, "encrypt", &obj->encrypt, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "format", &obj->has_format)) {
        if (!visit_type_BackupFormat(v, "format", &obj->format, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "config-file", &has_config_file)) {
        if (!visit_type_str(v, "config-file", &obj->config_file, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "firewall-file", &has_firewall_file)) {
        if (!visit_type_str(v, "firewall-file", &obj->firewall_file, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "devlist", &has_devlist)) {
        if (!visit_type_str(v, "devlist", &obj->devlist, errp)) {
            return false;
        }
    }
    ...
    if (visit_optional(v, "fleecing", &obj->has_fleecing)) {
        if (!visit_type_bool(v, "fleecing", &obj->fleecing, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_ProxmoxSupportStatus_members(Visitor *v, ProxmoxSupportStatus *obj, Error **errp)
{
    if (!visit_type_bool(v, "pbs-dirty-bitmap", &obj->pbs_dirty_bitmap, errp)) {
        return false;
    }
    if (!visit_type_bool(v, "query-bitmap-info", &obj->query_bitmap_info, errp)) {
        return false;
    }
    if (!visit_type_bool(v, "pbs-dirty-bitmap-savevm", &obj->pbs_dirty_bitmap_savevm, errp)) {
        return false;
    }
    if (!visit_type_bool(v, "pbs-dirty-bitmap-migration", &obj->pbs_dirty_bitmap_migration, errp)) {
        return false;
    }
    if (!visit_type_bool(v, "pbs-masterkey", &obj->pbs_masterkey, errp)) {
        return false;
    }
    if (!visit_type_str(v, "pbs-library-version", &obj->pbs_library_version, errp)) {
        return false;
    }
    if (!visit_type_bool(v, "backup-access-api", &obj->backup_access_api, errp)) {
        return false;
    }
    if (!visit_type_bool(v, "backup-fleecing", &obj->backup_fleecing, errp)) {
        return false;
    }
    if (!visit_type_bool(v, "backup-max-workers", &obj->backup_max_workers, errp)) {
        return false;
    }
    return true;
}

bool visit_type_ProxmoxSupportStatus(Visitor *v, const char *name,
                 ProxmoxSupportStatus **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(ProxmoxSupportStatus), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_ProxmoxSupportStatus_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_ProxmoxSupportStatus(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_PBSBitmapAction(Visitor *v, const char *name,
                 PBSBitmapAction *obj, Error **errp)
{
    int value = *obj;
    bool ok = visit_type_enum(v, name, &value, &PBSBitmapAction_lookup, errp);
    *obj = value;
    return ok;
}

bool visit_type_PBSBitmapInfo_members(Visitor *v, PBSBitmapInfo *obj, Error **errp)
{
    if (!visit_type_str(v, "drive", &obj->drive, errp)) {
        return false;
    }
    if (!visit_type_PBSBitmapAction(v, "action", &obj->action, errp)) {
        return false;
    }
...
bool visit_type_PBSBitmapInfo(Visitor *v, const char *name,
                 PBSBitmapInfo **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(PBSBitmapInfo), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_PBSBitmapInfo_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_PBSBitmapInfo(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_PBSBitmapInfoList(Visitor *v, const char *name,
                 PBSBitmapInfoList **obj, Error **errp)
{
    bool ok = false;
    PBSBitmapInfoList *tail;
    size_t size = sizeof(**obj);
    ...
    for (tail = *obj; tail;
         tail = (PBSBitmapInfoList *)visit_next_list(v, (GenericList *)tail, size)) {
        if (!visit_type_PBSBitmapInfo(v, NULL, &tail->value, errp)) {
            goto out_obj;
        }
    }
...
out_obj:
    visit_end_list(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_PBSBitmapInfoList(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_BackupAccessInfo_members(Visitor *v, BackupAccessInfo *obj, Error **errp)
{
    bool has_bitmap_node_name = !!obj->bitmap_node_name;
    bool has_bitmap_name = !!obj->bitmap_name;
    ...
    if (visit_optional(v, "bitmap-node-name", &has_bitmap_node_name)) {
        if (!visit_type_str(v, "bitmap-node-name", &obj->bitmap_node_name, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "bitmap-name", &has_bitmap_name)) {
        if (!visit_type_str(v, "bitmap-name", &obj->bitmap_name, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "bitmap-action", &obj->has_bitmap_action)) {
        if (!visit_type_PBSBitmapAction(v, "bitmap-action", &obj->bitmap_action, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_BackupAccessInfo(Visitor *v, const char *name,
                 BackupAccessInfo **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(BackupAccessInfo), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_BackupAccessInfo_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_BackupAccessInfo(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_BackupAccessSourceDevice_members(Visitor *v, BackupAccessSourceDevice *obj, Error **errp)
{
    if (!visit_type_str(v, "device", &obj->device, errp)) {
        return false;
    }
    if (visit_optional(v, "bitmap-mode", &obj->has_bitmap_mode)) {
        if (!visit_type_BackupAccessSetupBitmapMode(v, "bitmap-mode", &obj->bitmap_mode, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_BackupAccessSourceDevice(Visitor *v, const char *name,
                 BackupAccessSourceDevice **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(BackupAccessSourceDevice), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_BackupAccessSourceDevice_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_BackupAccessSourceDevice(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_BackupAccessSetupBitmapMode(Visitor *v, const char *name,
                 BackupAccessSetupBitmapMode *obj, Error **errp)
{
    int value = *obj;
    bool ok = visit_type_enum(v, name, &value, &BackupAccessSetupBitmapMode_lookup, errp);
    *obj = value;
    return ok;
}

bool visit_type_BackupAccessSourceDeviceList(Visitor *v, const char *name,
                 BackupAccessSourceDeviceList **obj, Error **errp)
{
    bool ok = false;
    BackupAccessSourceDeviceList *tail;
    size_t size = sizeof(**obj);
    ...
    for (tail = *obj; tail;
         tail = (BackupAccessSourceDeviceList *)visit_next_list(v, (GenericList *)tail, size)) {
        if (!visit_type_BackupAccessSourceDevice(v, NULL, &tail->value, errp)) {
            goto out_obj;
        }
    }
...
out_obj:
    visit_end_list(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_BackupAccessSourceDeviceList(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_q_obj_backup_access_setup_arg_members(Visitor *v, q_obj_backup_access_setup_arg *obj, Error **errp)
{
    if (!visit_type_str(v, "target-id", &obj->target_id, errp)) {
        return false;
    }
    if (!visit_type_BackupAccessSourceDeviceList(v, "devices", &obj->devices, errp)) {
        return false;
    }
    return true;
}

bool visit_type_BackupAccessInfoList(Visitor *v, const char *name,
                 BackupAccessInfoList **obj, Error **errp)
{
    bool ok = false;
    BackupAccessInfoList *tail;
    size_t size = sizeof(**obj);
    ...
    for (tail = *obj; tail;
         tail = (BackupAccessInfoList *)visit_next_list(v, (GenericList *)tail, size)) {
        if (!visit_type_BackupAccessInfo(v, NULL, &tail->value, errp)) {
            goto out_obj;
        }
    }
...
out_obj:
    visit_end_list(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_BackupAccessInfoList(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_q_obj_backup_access_teardown_arg_members(Visitor *v, q_obj_backup_access_teardown_arg *obj, Error **errp)
{
    if (!visit_type_str(v, "target-id", &obj->target_id, errp)) {
        return false;
    }
    if (!visit_type_bool(v, "success", &obj->success, errp)) {
        return false;
    }
    return true;
}
...
bool visit_type_BlockStatsSpecific_members(Visitor *v, BlockStatsSpecific *obj, Error **errp)
{
    ...
    case BLOCKDEV_DRIVER_ALLOC_TRACK:
        break;
...
bool visit_type_BackupPerf_members(Visitor *v, BackupPerf *obj, Error **errp)
{
    ...
    if (visit_optional(v, "min-cluster-size", &obj->has_min_cluster_size)) {
        if (!visit_type_size(v, "min-cluster-size", &obj->min_cluster_size, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_BackupCommon_members(Visitor *v, BackupCommon *obj, Error **errp)
{
    ...
    if (visit_optional(v, "x-perf", &has_x_perf)) {
        if (visit_policy_reject(v, "x-perf", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-perf", 1u << QAPI_FEATURE_UNSTABLE)) {
...
bool visit_type_q_obj_block_commit_arg_members(Visitor *v, q_obj_block_commit_arg *obj, Error **errp)
{
    ...
    if (visit_optional(v, "base", &has_base)) {
        if (visit_policy_reject(v, "base", 1u << QAPI_FEATURE_DEPRECATED, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "base", 1u << QAPI_FEATURE_DEPRECATED)) {
    ...
    if (visit_optional(v, "top", &has_top)) {
        if (visit_policy_reject(v, "top", 1u << QAPI_FEATURE_DEPRECATED, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "top", 1u << QAPI_FEATURE_DEPRECATED)) {
...
bool visit_type_q_obj_blockdev_mirror_arg_members(Visitor *v, q_obj_blockdev_mirror_arg *obj, Error **errp)
{
    ...
    if (visit_optional(v, "target-is-zero", &obj->has_target_is_zero)) {
        if (!visit_type_bool(v, "target-is-zero", &obj->target_is_zero, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_BlockIOThrottle_members(Visitor *v, BlockIOThrottle *obj, Error **errp)
{
    ...
    if (visit_optional(v, "device", &has_device)) {
        if (visit_policy_reject(v, "device", 1u << QAPI_FEATURE_DEPRECATED, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "device", 1u << QAPI_FEATURE_DEPRECATED)) {
            if (!visit_type_str(v, "device", &obj->device, errp)) {
                return false;
            }
        }
...
bool visit_type_ThrottleGroupProperties_members(Visitor *v, ThrottleGroupProperties *obj, Error **errp)
{
    ...
    if (visit_optional(v, "x-iops-total", &obj->has_x_iops_total)) {
        if (visit_policy_reject(v, "x-iops-total", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-iops-total", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-iops-total-max", &obj->has_x_iops_total_max)) {
        if (visit_policy_reject(v, "x-iops-total-max", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-iops-total-max", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-iops-total-max-length", &obj->has_x_iops_total_max_length)) {
        if (visit_policy_reject(v, "x-iops-total-max-length", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-iops-total-max-length", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-iops-read", &obj->has_x_iops_read)) {
        if (visit_policy_reject(v, "x-iops-read", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-iops-read", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-iops-read-max", &obj->has_x_iops_read_max)) {
        if (visit_policy_reject(v, "x-iops-read-max", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-iops-read-max", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-iops-read-max-length", &obj->has_x_iops_read_max_length)) {
        if (visit_policy_reject(v, "x-iops-read-max-length", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-iops-read-max-length", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-iops-write", &obj->has_x_iops_write)) {
        if (visit_policy_reject(v, "x-iops-write", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-iops-write", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-iops-write-max", &obj->has_x_iops_write_max)) {
        if (visit_policy_reject(v, "x-iops-write-max", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-iops-write-max", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-iops-write-max-length", &obj->has_x_iops_write_max_length)) {
        if (visit_policy_reject(v, "x-iops-write-max-length", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-iops-write-max-length", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-bps-total", &obj->has_x_bps_total)) {
        if (visit_policy_reject(v, "x-bps-total", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-bps-total", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-bps-total-max", &obj->has_x_bps_total_max)) {
        if (visit_policy_reject(v, "x-bps-total-max", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-bps-total-max", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-bps-total-max-length", &obj->has_x_bps_total_max_length)) {
        if (visit_policy_reject(v, "x-bps-total-max-length", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-bps-total-max-length", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-bps-read", &obj->has_x_bps_read)) {
        if (visit_policy_reject(v, "x-bps-read", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-bps-read", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-bps-read-max", &obj->has_x_bps_read_max)) {
        if (visit_policy_reject(v, "x-bps-read-max", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-bps-read-max", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-bps-read-max-length", &obj->has_x_bps_read_max_length)) {
        if (visit_policy_reject(v, "x-bps-read-max-length", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-bps-read-max-length", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-bps-write", &obj->has_x_bps_write)) {
        if (visit_policy_reject(v, "x-bps-write", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-bps-write", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-bps-write-max", &obj->has_x_bps_write_max)) {
        if (visit_policy_reject(v, "x-bps-write-max", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-bps-write-max", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-bps-write-max-length", &obj->has_x_bps_write_max_length)) {
        if (visit_policy_reject(v, "x-bps-write-max-length", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-bps-write-max-length", 1u << QAPI_FEATURE_UNSTABLE)) {
    ...
    if (visit_optional(v, "x-iops-size", &obj->has_x_iops_size)) {
        if (visit_policy_reject(v, "x-iops-size", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-iops-size", 1u << QAPI_FEATURE_UNSTABLE)) {
...
bool visit_type_BlockdevOptionsFile_members(Visitor *v, BlockdevOptionsFile *obj, Error **errp)
{
    ...
    if (visit_optional(v, "x-check-cache-dropped", &obj->has_x_check_cache_dropped)) {
        if (visit_policy_reject(v, "x-check-cache-dropped", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-check-cache-dropped", 1u << QAPI_FEATURE_UNSTABLE)) {
...
bool visit_type_BlockdevOptionsAllocTrack_members(Visitor *v, BlockdevOptionsAllocTrack *obj, Error **errp)
{
    if (!visit_type_BlockdevOptionsGenericFormat_members(v, (BlockdevOptionsGenericFormat *)obj, errp)) {
        return false;
    }
    if (!visit_type_bool(v, "auto-remove", &obj->auto_remove, errp)) {
        return false;
    }
...
bool visit_type_BlockdevOptionsAllocTrack(Visitor *v, const char *name,
                 BlockdevOptionsAllocTrack **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(BlockdevOptionsAllocTrack), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_BlockdevOptionsAllocTrack_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_BlockdevOptionsAllocTrack(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_BlockdevOptionsPbs_members(Visitor *v, BlockdevOptionsPbs *obj, Error **errp)
{
    bool has_keyfile = !!obj->keyfile;
    bool has_password = !!obj->password;
    bool has_fingerprint = !!obj->fingerprint;
    ...
    if (!visit_type_str(v, "repository", &obj->repository, errp)) {
        return false;
    }
    if (!visit_type_str(v, "snapshot", &obj->snapshot, errp)) {
        return false;
    }
    if (!visit_type_str(v, "archive", &obj->archive, errp)) {
        return false;
    }
    if (visit_optional(v, "keyfile", &has_keyfile)) {
        if (!visit_type_str(v, "keyfile", &obj->keyfile, errp)) {
    ...
    if (visit_optional(v, "key_password", &has_key_password)) {
        if (!visit_type_str(v, "key_password", &obj->key_password, errp)) {
            return false;
        }
    }
...
bool visit_type_BlockdevOptionsPbs(Visitor *v, const char *name,
                 BlockdevOptionsPbs **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(BlockdevOptionsPbs), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_BlockdevOptionsPbs_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_BlockdevOptionsPbs(*obj);
        *obj = NULL;
    }
    return ok;
}
...
bool visit_type_RbdEncryptionCreateOptionsLUKSBase_members(Visitor *v, RbdEncryptionCreateOptionsLUKSBase *obj, Error **errp)
{
    ...
    if (visit_optional(v, "cipher-alg", &obj->has_cipher_alg)) {
        if (!visit_type_QCryptoCipherAlgo(v, "cipher-alg", &obj->cipher_alg, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_BlockdevOptionsCurlHttp_members(Visitor *v, BlockdevOptionsCurlHttp *obj, Error **errp)
{
    ...
    if (visit_optional(v, "force-range", &obj->has_force_range)) {
        if (!visit_type_bool(v, "force-range", &obj->force_range, errp)) {
            return false;
        }
    }
    return true;
...
{
    if (!visit_type_BlockdevOptionsCurlHttp_members(v, (BlockdevOptionsCurlHttp *)obj, errp)) {
        return false;
    }
...
bool visit_type_BlockdevOptionsNbd_members(Visitor *v, BlockdevOptionsNbd *obj, Error **errp)
{
    ...
    if (visit_optional(v, "x-dirty-bitmap", &has_x_dirty_bitmap)) {
        if (visit_policy_reject(v, "x-dirty-bitmap", 1u << QAPI_FEATURE_UNSTABLE, errp)) {
            return false;
        }
        if (!visit_policy_skip(v, "x-dirty-bitmap", 1u << QAPI_FEATURE_UNSTABLE)) {
...
bool visit_type_q_obj_BlockdevOptions_base_members(Visitor *v, q_obj_BlockdevOptions_base *obj, Error **errp)
{
    ...
    if (visit_optional(v, "active", &obj->has_active)) {
        if (!visit_type_bool(v, "active", &obj->active, errp)) {
            return false;
        }
    }
...
bool visit_type_BlockdevOptions_members(Visitor *v, BlockdevOptions *obj, Error **errp)
{
    ...
    switch (obj->driver) {
    case BLOCKDEV_DRIVER_ALLOC_TRACK:
        return visit_type_BlockdevOptionsAllocTrack_members(v, &obj->u.alloc_track, errp);
    case BLOCKDEV_DRIVER_BLKDEBUG:
    ...
    case BLOCKDEV_DRIVER_PBS:
        return visit_type_BlockdevOptionsPbs_members(v, &obj->u.pbs, errp);
    case BLOCKDEV_DRIVER_NVME:
    ...
    case BLOCKDEV_DRIVER_ZEROINIT:
        return visit_type_BlockdevOptionsGenericFormat_members(v, &obj->u.zeroinit, errp);
    default:
        abort();
    }
    return true;
...
bool visit_type_q_obj_blockdev_set_active_arg_members(Visitor *v, q_obj_blockdev_set_active_arg *obj, Error **errp)
{
    bool has_node_name = !!obj->node_name;
