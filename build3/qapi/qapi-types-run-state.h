...
typedef enum GuestPanicInformationType {
    ...
    GUEST_PANIC_INFORMATION_TYPE_TDX,
    GUEST_PANIC_INFORMATION_TYPE_SEV,
...
typedef struct GuestPanicInformationTdx GuestPanicInformationTdx;

typedef struct GuestPanicInformationSev GuestPanicInformationSev;
...
struct GuestPanicInformation {
    ...
    union { /* union tag is @type */
        ...
        GuestPanicInformationTdx tdx;
        GuestPanicInformationSev sev;
    } u;
};
...
void qapi_free_GuestPanicInformationTdx(GuestPanicInformationTdx *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(GuestPanicInformationTdx, qapi_free_GuestPanicInformationTdx)

void qapi_free_GuestPanicInformationSev(GuestPanicInformationSev *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(GuestPanicInformationSev, qapi_free_GuestPanicInformationSev)
