...
{
    bool has_in = !!obj->in;
    bool has_out = !!obj->out;

    if (visit_optional(v, "in", &has_in)) {
        if (!visit_type_AudiodevPerDirectionOptions(v, "in", &obj->in, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "out", &has_out)) {
...
bool visit_type_AudiodevDBusOptions_members(Visitor *v, AudiodevDBusOptions *obj, Error **errp)
{
    bool has_in = !!obj->in;
    bool has_out = !!obj->out;
    ...
    if (visit_optional(v, "nsamples", &obj->has_nsamples)) {
        if (!visit_type_uint32(v, "nsamples", &obj->nsamples, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_AudiodevDBusOptions(Visitor *v, const char *name,
                 AudiodevDBusOptions **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(AudiodevDBusOptions), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_AudiodevDBusOptions_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_AudiodevDBusOptions(*obj);
        *obj = NULL;
    }
    return ok;
}
...
{
    bool has_server_name = !!obj->server_name;
    bool has_client_name = !!obj->client_name;
    bool has_connect_ports = !!obj->connect_ports;

    if (!visit_type_AudiodevPerDirectionOptions_members(v, (AudiodevPerDirectionOptions *)obj, errp)) {
        return false;
    }
    if (visit_optional(v, "server-name", &has_server_name)) {
        if (!visit_type_str(v, "server-name", &obj->server_name, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "client-name", &has_client_name)) {
        if (!visit_type_str(v, "client-name", &obj->client_name, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "connect-ports", &has_connect_ports)) {
...
bool visit_type_AudiodevPaPerDirectionOptions_members(Visitor *v, AudiodevPaPerDirectionOptions *obj, Error **errp)
{
    ...
    bool has_stream_name = !!obj->stream_name;
    ...
    if (visit_optional(v, "stream-name", &has_stream_name)) {
...
bool visit_type_AudiodevPaOptions_members(Visitor *v, AudiodevPaOptions *obj, Error **errp)
{
    ...
    if (visit_optional(v, "server", &has_server)) {
...
bool visit_type_AudiodevPipewirePerDirectionOptions_members(Visitor *v, AudiodevPipewirePerDirectionOptions *obj, Error **errp)
{
    bool has_name = !!obj->name;
    bool has_stream_name = !!obj->stream_name;
...
bool visit_type_AudiodevPipewirePerDirectionOptions(Visitor *v, const char *name,
                 AudiodevPipewirePerDirectionOptions **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(AudiodevPipewirePerDirectionOptions), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_AudiodevPipewirePerDirectionOptions_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_AudiodevPipewirePerDirectionOptions(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_AudiodevPipewireOptions_members(Visitor *v, AudiodevPipewireOptions *obj, Error **errp)
{
    bool has_in = !!obj->in;
    bool has_out = !!obj->out;

    if (visit_optional(v, "in", &has_in)) {
        if (!visit_type_AudiodevPipewirePerDirectionOptions(v, "in", &obj->in, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "out", &has_out)) {
        if (!visit_type_AudiodevPipewirePerDirectionOptions(v, "out", &obj->out, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_AudiodevPipewireOptions(Visitor *v, const char *name,
                 AudiodevPipewireOptions **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(AudiodevPipewireOptions), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_AudiodevPipewireOptions_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_AudiodevPipewireOptions(*obj);
        *obj = NULL;
    }
    return ok;
}
...
bool visit_type_Audiodev_members(Visitor *v, Audiodev *obj, Error **errp)
{
    ...
    case AUDIODEV_DRIVER_DBUS:
        return visit_type_AudiodevDBusOptions_members(v, &obj->u.dbus, errp);
...
#if defined(CONFIG_AUDIO_PIPEWIRE)
    case AUDIODEV_DRIVER_PIPEWIRE:
        return visit_type_AudiodevPipewireOptions_members(v, &obj->u.pipewire, errp);
#endif /* defined(CONFIG_AUDIO_PIPEWIRE) */
