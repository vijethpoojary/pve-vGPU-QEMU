...
void qapi_free_VirtIOGPUOutput(VirtIOGPUOutput *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_VirtIOGPUOutput(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_VirtIOGPUOutputList(VirtIOGPUOutputList *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_VirtIOGPUOutputList(v, NULL, &obj, NULL);
    visit_free(v);
}
...
const QEnumLookup VMAppleVirtioBlkVariant_lookup = {
    .array = (const char *const[]) {
        [VM_APPLE_VIRTIO_BLK_VARIANT_UNSPECIFIED] = "unspecified",
        [VM_APPLE_VIRTIO_BLK_VARIANT_ROOT] = "root",
        [VM_APPLE_VIRTIO_BLK_VARIANT_AUX] = "aux",
    },
    .size = VM_APPLE_VIRTIO_BLK_VARIANT__MAX
};
