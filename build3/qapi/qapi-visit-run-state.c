...
bool visit_type_GuestPanicInformation_members(Visitor *v, GuestPanicInformation *obj, Error **errp)
{
    ...
    case GUEST_PANIC_INFORMATION_TYPE_TDX:
        return visit_type_GuestPanicInformationTdx_members(v, &obj->u.tdx, errp);
    case GUEST_PANIC_INFORMATION_TYPE_SEV:
        return visit_type_GuestPanicInformationSev_members(v, &obj->u.sev, errp);
    default:
        abort();
    }
    return true;
...
bool visit_type_GuestPanicInformationTdx_members(Visitor *v, GuestPanicInformationTdx *obj, Error **errp)
{
    if (!visit_type_uint32(v, "error-code", &obj->error_code, errp)) {
        return false;
    }
    if (!visit_type_str(v, "message", &obj->message, errp)) {
        return false;
    }
...
bool visit_type_GuestPanicInformationTdx(Visitor *v, const char *name,
                 GuestPanicInformationTdx **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(GuestPanicInformationTdx), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_GuestPanicInformationTdx_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_GuestPanicInformationTdx(*obj);
        *obj = NULL;
    }
    return ok;
}

bool visit_type_GuestPanicInformationSev_members(Visitor *v, GuestPanicInformationSev *obj, Error **errp)
{
    if (!visit_type_uint32(v, "set", &obj->set, errp)) {
        return false;
    }
    if (!visit_type_uint32(v, "code", &obj->code, errp)) {
        return false;
    }
    return true;
}

bool visit_type_GuestPanicInformationSev(Visitor *v, const char *name,
                 GuestPanicInformationSev **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(GuestPanicInformationSev), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_GuestPanicInformationSev_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
    visit_end_struct(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_GuestPanicInformationSev(*obj);
        *obj = NULL;
    }
    return ok;
}
