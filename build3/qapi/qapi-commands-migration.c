...
void qmp_marshal_query_savevm(QDict *args, QObject **ret, Error **errp)
{
    Error *err = NULL;
    bool ok = false;
    Visitor *v;
    ...
    if (trace_event_get_state_backends(TRACE_QMP_ENTER_QUERY_SAVEVM)) {
        g_autoptr(GString) req_json = qobject_to_json(QOBJECT(args));

        trace_qmp_enter_query_savevm(req_json->str);
    }

    retval = qmp_query_savevm(&err);
    if (err) {
        trace_qmp_exit_query_savevm(error_get_pretty(err), false);
        error_propagate(errp, err);
        goto out;
    }

    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_SaveVMInfo(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_SaveVMInfo(ov, "unused", &retval, NULL);
    visit_free(ov);

    if (trace_event_get_state_backends(TRACE_QMP_EXIT_QUERY_SAVEVM)) {
        g_autoptr(GString) ret_json = qobject_to_json(*ret);

        trace_qmp_exit_query_savevm(ret_json->str, true);
    }
...
void qmp_marshal_query_migrate(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_MigrationInfo(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_MigrationInfo(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_query_migrate_capabilities(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_MigrationCapabilityStatusList(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_MigrationCapabilityStatusList(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_migrate_set_parameters(QDict *args, QObject **ret, Error **errp)
{
    ...
    if (visit_type_MigrationParameters_members(v, &arg, errp)) {
        ok = visit_check_struct(v, errp);
    }
    visit_end_struct(v, NULL);
    if (!ok) {
...
void qmp_marshal_query_migrate_parameters(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_MigrationParameters(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_MigrationParameters(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_migrate(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_migrate(arg.uri, arg.has_channels, arg.channels, arg.has_resume, arg.resume, &err);
    if (err) {
...
void qmp_marshal_migrate_incoming(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_migrate_incoming(arg.uri, arg.has_channels, arg.channels, arg.has_exit_on_error, arg.exit_on_error, &err);
    if (err) {
...
void qmp_marshal_query_xen_replication_status(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_ReplicationStatus(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_ReplicationStatus(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_query_colo_status(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_COLOStatus(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_COLOStatus(ov, "unused", &retval, NULL);
    visit_free(ov);
...
void qmp_marshal_calc_dirty_rate(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_calc_dirty_rate(arg.calc_time, arg.has_calc_time_unit, arg.calc_time_unit, arg.has_sample_pages, arg.sample_pages, arg.has_mode, arg.mode, &err);
    if (err) {
...
void qmp_marshal_query_dirty_rate(QDict *args, QObject **ret, Error **errp)
{
    ...
    Visitor *ov;
    q_obj_query_dirty_rate_arg arg = {0};

    v = qobject_input_visitor_new_qmp(QOBJECT(args));
    if (!visit_start_struct(v, NULL, NULL, 0, errp)) {
        goto out;
    }
    if (visit_type_q_obj_query_dirty_rate_arg_members(v, &arg, errp)) {
        ok = visit_check_struct(v, errp);
    }
    visit_end_struct(v, NULL);
    if (!ok) {
    ...
    retval = qmp_query_dirty_rate(arg.has_calc_time_unit, arg.calc_time_unit, &err);
    if (err) {
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_DirtyRateInfo(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_DirtyRateInfo(ov, "unused", &retval, NULL);
    visit_free(ov);
...
out:
    ...
    v = qapi_dealloc_visitor_new();
    visit_start_struct(v, NULL, NULL, 0, NULL);
    visit_type_q_obj_query_dirty_rate_arg_members(v, &arg, NULL);
    visit_end_struct(v, NULL);
    visit_free(v);
}
...
void qmp_marshal_query_vcpu_dirty_limit(QDict *args, QObject **ret, Error **errp)
{
    ...
    ov = qobject_output_visitor_new_qmp(ret);
    if (visit_type_DirtyLimitInfoList(ov, "unused", &retval, errp)) {
        visit_complete(ov, ret);
    }
    visit_free(ov);
    ov = qapi_dealloc_visitor_new();
    visit_type_DirtyLimitInfoList(ov, "unused", &retval, NULL);
    visit_free(ov);
