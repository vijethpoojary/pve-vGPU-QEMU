...
typedef struct BlockLimitsInfo BlockLimitsInfo;
...
typedef struct BlockdevChild BlockdevChild;

typedef struct BlockdevChildList BlockdevChildList;
...
typedef struct q_obj_query_block_arg q_obj_query_block_arg;

typedef struct BlockInfoList BlockInfoList;

typedef struct BackupStatus BackupStatus;
...
#define BackupFormat_str(val) \
    qapi_enum_lookup(&BackupFormat_lookup, (val))

extern const QEnumLookup BackupFormat_lookup;

typedef struct q_obj_backup_arg q_obj_backup_arg;

typedef struct ProxmoxSupportStatus ProxmoxSupportStatus;

typedef enum PBSBitmapAction {
    PBS_BITMAP_ACTION_NOT_USED,
    PBS_BITMAP_ACTION_NOT_USED_REMOVED,
    PBS_BITMAP_ACTION_NEW,
    PBS_BITMAP_ACTION_USED,
    PBS_BITMAP_ACTION_INVALID,
    PBS_BITMAP_ACTION_MISSING_RECREATED,
    PBS_BITMAP_ACTION__MAX,
} PBSBitmapAction;

#define PBSBitmapAction_str(val) \
    qapi_enum_lookup(&PBSBitmapAction_lookup, (val))

extern const QEnumLookup PBSBitmapAction_lookup;

typedef struct PBSBitmapInfo PBSBitmapInfo;

typedef struct PBSBitmapInfoList PBSBitmapInfoList;

typedef struct BackupAccessInfo BackupAccessInfo;

typedef struct BackupAccessSourceDevice BackupAccessSourceDevice;

typedef enum BackupAccessSetupBitmapMode {
    BACKUP_ACCESS_SETUP_BITMAP_MODE_NONE,
    BACKUP_ACCESS_SETUP_BITMAP_MODE_NEW,
    BACKUP_ACCESS_SETUP_BITMAP_MODE_USE,
    BACKUP_ACCESS_SETUP_BITMAP_MODE__MAX,
} BackupAccessSetupBitmapMode;

#define BackupAccessSetupBitmapMode_str(val) \
    qapi_enum_lookup(&BackupAccessSetupBitmapMode_lookup, (val))

extern const QEnumLookup BackupAccessSetupBitmapMode_lookup;

typedef struct BackupAccessSourceDeviceList BackupAccessSourceDeviceList;

typedef struct q_obj_backup_access_setup_arg q_obj_backup_access_setup_arg;

typedef struct BackupAccessInfoList BackupAccessInfoList;

typedef struct q_obj_backup_access_teardown_arg q_obj_backup_access_teardown_arg;
...
typedef enum XDbgBlockGraphNodeType {
    ...
    XDBG_BLOCK_GRAPH_NODE_TYPE__MAX,
...
typedef struct BlockdevOptionsAllocTrack BlockdevOptionsAllocTrack;

typedef struct BlockdevOptionsPbs BlockdevOptionsPbs;
...
typedef struct q_obj_blockdev_set_active_arg q_obj_blockdev_set_active_arg;
...
struct BlockLimitsInfo {
    ...
    bool has_discard_alignment;
    uint32_t discard_alignment;
    bool has_max_write_zeroes;
    uint64_t max_write_zeroes;
    bool has_write_zeroes_alignment;
    uint32_t write_zeroes_alignment;
    bool has_opt_transfer;
    uint32_t opt_transfer;
    bool has_max_transfer;
    uint32_t max_transfer;
    bool has_max_hw_transfer;
    uint32_t max_hw_transfer;
    int64_t max_iov;
    bool has_max_hw_iov;
    int64_t max_hw_iov;
    uint64_t min_mem_alignment;
    uint64_t opt_mem_alignment;
};

void qapi_free_BlockLimitsInfo(BlockLimitsInfo *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(BlockLimitsInfo, qapi_free_BlockLimitsInfo)
...
void qapi_free_BlockdevChild(BlockdevChild *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(BlockdevChild, qapi_free_BlockdevChild)

struct BlockdevChildList {
    BlockdevChildList *next;
    BlockdevChild *value;
};

void qapi_free_BlockdevChildList(BlockdevChildList *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(BlockdevChildList, qapi_free_BlockdevChildList)
...
void qapi_free_BackupStatus(BackupStatus *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(BackupStatus, qapi_free_BackupStatus)

struct q_obj_backup_arg {
    char *backup_file;
    char *password;
    char *keyfile;
    char *key_password;
...
struct ProxmoxSupportStatus {
    bool pbs_dirty_bitmap;
    bool query_bitmap_info;
    bool pbs_dirty_bitmap_savevm;
    bool pbs_dirty_bitmap_migration;
    bool pbs_masterkey;
    char *pbs_library_version;
    bool backup_access_api;
    bool backup_fleecing;
    bool backup_max_workers;
};

void qapi_free_ProxmoxSupportStatus(ProxmoxSupportStatus *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(ProxmoxSupportStatus, qapi_free_ProxmoxSupportStatus)

struct PBSBitmapInfo {
    char *drive;
    PBSBitmapAction action;
    int64_t size;
    int64_t dirty;
};

void qapi_free_PBSBitmapInfo(PBSBitmapInfo *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(PBSBitmapInfo, qapi_free_PBSBitmapInfo)

struct PBSBitmapInfoList {
    PBSBitmapInfoList *next;
    PBSBitmapInfo *value;
};

void qapi_free_PBSBitmapInfoList(PBSBitmapInfoList *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(PBSBitmapInfoList, qapi_free_PBSBitmapInfoList)

struct BackupAccessInfo {
    char *node_name;
    char *device;
    uint64_t size;
    char *bitmap_node_name;
    char *bitmap_name;
    bool has_bitmap_action;
    PBSBitmapAction bitmap_action;
};

void qapi_free_BackupAccessInfo(BackupAccessInfo *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(BackupAccessInfo, qapi_free_BackupAccessInfo)

struct BackupAccessSourceDevice {
    char *device;
    bool has_bitmap_mode;
    BackupAccessSetupBitmapMode bitmap_mode;
};

void qapi_free_BackupAccessSourceDevice(BackupAccessSourceDevice *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(BackupAccessSourceDevice, qapi_free_BackupAccessSourceDevice)

struct BackupAccessSourceDeviceList {
    BackupAccessSourceDeviceList *next;
    BackupAccessSourceDevice *value;
};

void qapi_free_BackupAccessSourceDeviceList(BackupAccessSourceDeviceList *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(BackupAccessSourceDeviceList, qapi_free_BackupAccessSourceDeviceList)

struct q_obj_backup_access_setup_arg {
    char *target_id;
    BackupAccessSourceDeviceList *devices;
};

struct BackupAccessInfoList {
    BackupAccessInfoList *next;
    BackupAccessInfo *value;
};

void qapi_free_BackupAccessInfoList(BackupAccessInfoList *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(BackupAccessInfoList, qapi_free_BackupAccessInfoList)

struct q_obj_backup_access_teardown_arg {
    char *target_id;
    bool success;
};
...
static inline BlockdevOptionsGenericFormat *qapi_BlockdevOptionsAllocTrack_base(const BlockdevOptionsAllocTrack *obj)
{
    return (BlockdevOptionsGenericFormat *)obj;
}

void qapi_free_BlockdevOptionsAllocTrack(BlockdevOptionsAllocTrack *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(BlockdevOptionsAllocTrack, qapi_free_BlockdevOptionsAllocTrack)
...
void qapi_free_BlockdevOptionsPbs(BlockdevOptionsPbs *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(BlockdevOptionsPbs, qapi_free_BlockdevOptionsPbs)
...
struct BlockdevOptionsCurlHttps {
    /* Members inherited from BlockdevOptionsCurlHttp: */
    char *url;
    bool has_readahead;
    int64_t readahead;
    bool has_timeout;
...
static inline BlockdevOptionsCurlHttp *qapi_BlockdevOptionsCurlHttps_base(const BlockdevOptionsCurlHttps *obj)
{
    return (BlockdevOptionsCurlHttp *)obj;
}
...
struct BlockdevOptions {
    ...
    BlockdevDetectZeroesOptions detect_zeroes;
    union { /* union tag is @driver */
        BlockdevOptionsAllocTrack alloc_track;
        ...
        BlockdevOptionsGenericFormat zeroinit;
    } u;
};
...
struct q_obj_blockdev_set_active_arg {
    char *node_name;
    bool active;
};
