...
const QEnumLookup CxlEventLog_lookup = {
    .array = (const char *const[]) {
        [CXL_EVENT_LOG_INFORMATIONAL] = "informational",
        [CXL_EVENT_LOG_WARNING] = "warning",
        [CXL_EVENT_LOG_FAILURE] = "failure",
        [CXL_EVENT_LOG_FATAL] = "fatal",
    },
    .size = CXL_EVENT_LOG__MAX
};

void qapi_free_CXLCommonEventBase(CXLCommonEventBase *obj)
{
    Visitor *v;
    ...
    visit_type_CXLCommonEventBase(v, NULL, &obj, NULL);
    visit_free(v);
}

void qapi_free_CXLGeneralMediaEvent(CXLGeneralMediaEvent *obj)
{
    Visitor *v;
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_CXLGeneralMediaEvent(v, NULL, &obj, NULL);
    visit_free(v);
}

void qapi_free_CXLDRAMEvent(CXLDRAMEvent *obj)
{
    Visitor *v;
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_CXLDRAMEvent(v, NULL, &obj, NULL);
    visit_free(v);
}

void qapi_free_CXLMemModuleEvent(CXLMemModuleEvent *obj)
{
    Visitor *v;
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_CXLMemModuleEvent(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_CxlDynamicCapacityExtent(CxlDynamicCapacityExtent *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_CxlDynamicCapacityExtent(v, NULL, &obj, NULL);
    visit_free(v);
}

const QEnumLookup CxlExtentSelectionPolicy_lookup = {
    .array = (const char *const[]) {
        [CXL_EXTENT_SELECTION_POLICY_FREE] = "free",
        [CXL_EXTENT_SELECTION_POLICY_CONTIGUOUS] = "contiguous",
        [CXL_EXTENT_SELECTION_POLICY_PRESCRIPTIVE] = "prescriptive",
        [CXL_EXTENT_SELECTION_POLICY_ENABLE_SHARED_ACCESS] = "enable-shared-access",
    },
    .size = CXL_EXTENT_SELECTION_POLICY__MAX
};
...
void qapi_free_CxlDynamicCapacityExtentList(CxlDynamicCapacityExtentList *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_CxlDynamicCapacityExtentList(v, NULL, &obj, NULL);
    visit_free(v);
}

const QEnumLookup CxlExtentRemovalPolicy_lookup = {
    .array = (const char *const[]) {
        [CXL_EXTENT_REMOVAL_POLICY_TAG_BASED] = "tag-based",
        [CXL_EXTENT_REMOVAL_POLICY_PRESCRIPTIVE] = "prescriptive",
    },
    .size = CXL_EXTENT_REMOVAL_POLICY__MAX
};
