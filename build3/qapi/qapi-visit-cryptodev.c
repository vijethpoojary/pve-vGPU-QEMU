...
bool visit_type_QCryptodevBackendAlgoType(Visitor *v, const char *name,
                 QCryptodevBackendAlgoType *obj, Error **errp)
{
    int value = *obj;
    bool ok = visit_type_enum(v, name, &value, &QCryptodevBackendAlgoType_lookup, errp);
    *obj = value;
    return ok;
}
