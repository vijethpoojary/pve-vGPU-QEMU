...
const QEnumLookup QAPIEvent_lookup = {
    .array = (const char *const[]) {
        ...
        [QAPI_EVENT_GUEST_PVSHUTDOWN] = "GUEST_PVSHUTDOWN",
        ...
        [QAPI_EVENT_NETDEV_VHOST_USER_CONNECTED] = "NETDEV_VHOST_USER_CONNECTED",
        [QAPI_EVENT_NETDEV_VHOST_USER_DISCONNECTED] = "NETDEV_VHOST_USER_DISCONNECTED",
        ...
        [QAPI_EVENT_HV_BALLOON_STATUS_REPORT] = "HV_BALLOON_STATUS_REPORT",
        [QAPI_EVENT_MEMORY_DEVICE_SIZE_CHANGE] = "MEMORY_DEVICE_SIZE_CHANGE",
        [QAPI_EVENT_CPU_POLARIZATION_CHANGE] = "CPU_POLARIZATION_CHANGE",
        [QAPI_EVENT_SCLP_CPI_INFO_AVAILABLE] = "SCLP_CPI_INFO_AVAILABLE",
        [QAPI_EVENT_RTC_CHANGE] = "RTC_CHANGE",
        [QAPI_EVENT_VFU_CLIENT_HANGUP] = "VFU_CLIENT_HANGUP",
        [QAPI_EVENT_ACPI_DEVICE_OST] = "ACPI_DEVICE_OST",
        [QAPI_EVENT_VFIO_MIGRATION] = "VFIO_MIGRATION",
    },
