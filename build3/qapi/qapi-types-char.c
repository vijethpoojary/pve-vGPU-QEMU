...
void qapi_free_ChardevHub(ChardevHub *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_ChardevHub(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_ChardevPty(ChardevPty *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_ChardevPty(v, NULL, &obj, NULL);
    visit_free(v);
}
...
const QEnumLookup ChardevBackendKind_lookup = {
    ...
    .features = (const uint64_t[CHARDEV_BACKEND_KIND__MAX]) {
        [CHARDEV_BACKEND_KIND_MEMORY] = 1u << QAPI_FEATURE_DEPRECATED,
    },
...
void qapi_free_ChardevHubWrapper(ChardevHubWrapper *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_ChardevHubWrapper(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_ChardevPtyWrapper(ChardevPtyWrapper *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_ChardevPtyWrapper(v, NULL, &obj, NULL);
    visit_free(v);
}
