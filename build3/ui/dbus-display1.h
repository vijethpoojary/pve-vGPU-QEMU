...
/* ------------------------------------------------------------------------ */
/* Declarations for org.qemu.Display1.Listener.Unix.ScanoutDMABUF2 */

#define QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2 (qemu_dbus_display1_listener_unix_scanout_dmabuf2_get_type ())
#define QEMU_DBUS_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2, QemuDBusDisplay1ListenerUnixScanoutDMABUF2))
#define QEMU_DBUS_IS_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2))
#define QEMU_DBUS_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_GET_IFACE(o) (G_TYPE_INSTANCE_GET_INTERFACE ((o), QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2, QemuDBusDisplay1ListenerUnixScanoutDMABUF2Iface))

struct _QemuDBusDisplay1ListenerUnixScanoutDMABUF2;
typedef struct _QemuDBusDisplay1ListenerUnixScanoutDMABUF2 QemuDBusDisplay1ListenerUnixScanoutDMABUF2;
typedef struct _QemuDBusDisplay1ListenerUnixScanoutDMABUF2Iface QemuDBusDisplay1ListenerUnixScanoutDMABUF2Iface;

struct _QemuDBusDisplay1ListenerUnixScanoutDMABUF2Iface
{
  GTypeInterface parent_iface;

  gboolean (*handle_scanout_dmabuf2) (
    QemuDBusDisplay1ListenerUnixScanoutDMABUF2 *object,
    GDBusMethodInvocation *invocation,
    GUnixFDList *fd_list,
    GVariant *arg_dmabuf,
    guint arg_x,
    ...
    GVariant *arg_offset,
    GVariant *arg_stride,
    guint arg_num_planes,
    guint arg_fourcc,
    guint arg_backing_width,
    guint arg_backing_height,
    guint64 arg_modifier,
    gboolean arg_y0_top);

};

GType qemu_dbus_display1_listener_unix_scanout_dmabuf2_get_type (void) G_GNUC_CONST;

GDBusInterfaceInfo *qemu_dbus_display1_listener_unix_scanout_dmabuf2_interface_info (void);
guint qemu_dbus_display1_listener_unix_scanout_dmabuf2_override_properties (GObjectClass *klass, guint property_id_begin);


/* D-Bus method call completion functions: */
void qemu_dbus_display1_listener_unix_scanout_dmabuf2_complete_scanout_dmabuf2 (
    QemuDBusDisplay1ListenerUnixScanoutDMABUF2 *object,
    GDBusMethodInvocation *invocation,
    GUnixFDList *fd_list);
...
/* D-Bus method calls: */
void qemu_dbus_display1_listener_unix_scanout_dmabuf2_call_scanout_dmabuf2 (
    QemuDBusDisplay1ListenerUnixScanoutDMABUF2 *proxy,
    GVariant *arg_dmabuf,
    guint arg_x,
    guint arg_y,
    guint arg_width,
...
gboolean qemu_dbus_display1_listener_unix_scanout_dmabuf2_call_scanout_dmabuf2_finish (
    QemuDBusDisplay1ListenerUnixScanoutDMABUF2 *proxy,
    GUnixFDList **out_fd_list,
    GAsyncResult *res,
    GError **error);

gboolean qemu_dbus_display1_listener_unix_scanout_dmabuf2_call_scanout_dmabuf2_sync (
    QemuDBusDisplay1ListenerUnixScanoutDMABUF2 *proxy,
    GVariant *arg_dmabuf,
    guint arg_x,
    guint arg_y,
...
#define QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_PROXY (qemu_dbus_display1_listener_unix_scanout_dmabuf2_proxy_get_type ())
#define QEMU_DBUS_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_PROXY(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_PROXY, QemuDBusDisplay1ListenerUnixScanoutDMABUF2Proxy))
#define QEMU_DBUS_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_PROXY, QemuDBusDisplay1ListenerUnixScanoutDMABUF2ProxyClass))
#define QEMU_DBUS_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_PROXY_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_PROXY, QemuDBusDisplay1ListenerUnixScanoutDMABUF2ProxyClass))
#define QEMU_DBUS_IS_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_PROXY(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_PROXY))
#define QEMU_DBUS_IS_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_PROXY))

typedef struct _QemuDBusDisplay1ListenerUnixScanoutDMABUF2Proxy QemuDBusDisplay1ListenerUnixScanoutDMABUF2Proxy;
typedef struct _QemuDBusDisplay1ListenerUnixScanoutDMABUF2ProxyClass QemuDBusDisplay1ListenerUnixScanoutDMABUF2ProxyClass;
typedef struct _QemuDBusDisplay1ListenerUnixScanoutDMABUF2ProxyPrivate QemuDBusDisplay1ListenerUnixScanoutDMABUF2ProxyPrivate;

struct _QemuDBusDisplay1ListenerUnixScanoutDMABUF2Proxy
{
  /*< private >*/
  GDBusProxy parent_instance;
  QemuDBusDisplay1ListenerUnixScanoutDMABUF2ProxyPrivate *priv;
};

struct _QemuDBusDisplay1ListenerUnixScanoutDMABUF2ProxyClass
{
  GDBusProxyClass parent_class;
};

GType qemu_dbus_display1_listener_unix_scanout_dmabuf2_proxy_get_type (void) G_GNUC_CONST;

#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (QemuDBusDisplay1ListenerUnixScanoutDMABUF2Proxy, g_object_unref)
#endif

void qemu_dbus_display1_listener_unix_scanout_dmabuf2_proxy_new (
    GDBusConnection     *connection,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
    ...
    GAsyncReadyCallback  callback,
    gpointer             user_data);
QemuDBusDisplay1ListenerUnixScanoutDMABUF2 *qemu_dbus_display1_listener_unix_scanout_dmabuf2_proxy_new_finish (
    GAsyncResult        *res,
    GError             **error);
QemuDBusDisplay1ListenerUnixScanoutDMABUF2 *qemu_dbus_display1_listener_unix_scanout_dmabuf2_proxy_new_sync (
    GDBusConnection     *connection,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
...
void qemu_dbus_display1_listener_unix_scanout_dmabuf2_proxy_new_for_bus (
    GBusType             bus_type,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
    ...
    GAsyncReadyCallback  callback,
    gpointer             user_data);
QemuDBusDisplay1ListenerUnixScanoutDMABUF2 *qemu_dbus_display1_listener_unix_scanout_dmabuf2_proxy_new_for_bus_finish (
    GAsyncResult        *res,
    GError             **error);
QemuDBusDisplay1ListenerUnixScanoutDMABUF2 *qemu_dbus_display1_listener_unix_scanout_dmabuf2_proxy_new_for_bus_sync (
    GBusType             bus_type,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
...
#define QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_SKELETON (qemu_dbus_display1_listener_unix_scanout_dmabuf2_skeleton_get_type ())
#define QEMU_DBUS_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_SKELETON(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_SKELETON, QemuDBusDisplay1ListenerUnixScanoutDMABUF2Skeleton))
#define QEMU_DBUS_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_SKELETON, QemuDBusDisplay1ListenerUnixScanoutDMABUF2SkeletonClass))
#define QEMU_DBUS_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_SKELETON_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_SKELETON, QemuDBusDisplay1ListenerUnixScanoutDMABUF2SkeletonClass))
#define QEMU_DBUS_IS_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_SKELETON(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_SKELETON))
#define QEMU_DBUS_IS_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), QEMU_DBUS_TYPE_DISPLAY1_LISTENER_UNIX_SCANOUT_DMABUF2_SKELETON))

typedef struct _QemuDBusDisplay1ListenerUnixScanoutDMABUF2Skeleton QemuDBusDisplay1ListenerUnixScanoutDMABUF2Skeleton;
typedef struct _QemuDBusDisplay1ListenerUnixScanoutDMABUF2SkeletonClass QemuDBusDisplay1ListenerUnixScanoutDMABUF2SkeletonClass;
typedef struct _QemuDBusDisplay1ListenerUnixScanoutDMABUF2SkeletonPrivate QemuDBusDisplay1ListenerUnixScanoutDMABUF2SkeletonPrivate;

struct _QemuDBusDisplay1ListenerUnixScanoutDMABUF2Skeleton
{
  /*< private >*/
  GDBusInterfaceSkeleton parent_instance;
  QemuDBusDisplay1ListenerUnixScanoutDMABUF2SkeletonPrivate *priv;
};

struct _QemuDBusDisplay1ListenerUnixScanoutDMABUF2SkeletonClass
{
  GDBusInterfaceSkeletonClass parent_class;
};

GType qemu_dbus_display1_listener_unix_scanout_dmabuf2_skeleton_get_type (void) G_GNUC_CONST;

#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (QemuDBusDisplay1ListenerUnixScanoutDMABUF2Skeleton, g_object_unref)
#endif

QemuDBusDisplay1ListenerUnixScanoutDMABUF2 *qemu_dbus_display1_listener_unix_scanout_dmabuf2_skeleton_new (void);
...
struct _QemuDBusDisplay1AudioIface
{
  ...
  guint  (*get_nsamples) (QemuDBusDisplay1Audio *object);
...
/* D-Bus property accessors: */
guint qemu_dbus_display1_audio_get_nsamples (QemuDBusDisplay1Audio *object);
void qemu_dbus_display1_audio_set_nsamples (QemuDBusDisplay1Audio *object, guint value);
